...
4346: 31 A6          LEAY   A,Y
4348: 32 7D          LEAS   -$3,S		; alloc auto-memory   ; [alloc_locals]
...
4925: C1 00          CMPB   #$00
4927: 27 24          BEQ    $494D
4929: 32 71          LEAS   -$F,S		; alloc auto-memory   ; [alloc_locals]
492B: A7 E4          STA    ,S
492D: E7 61          STB    $1,S
492F: 86 08          LDA    #$08
4931: A7 62          STA    $2,S
...
4959: 27 3D          BEQ    $4998
495B: 32 71          LEAS   -$F,S		; alloc auto-memory   ; [alloc_locals]
495D: 6F 64          CLR    $4,S
495F: 6F 65          CLR    $5,S
4961: 6F 66          CLR    $6,S
4963: 6F 67          CLR    $7,S
...
5BB1: 97 00          STA    $00
5BB3: 10 AE 07       LDY    $7,X	; [bank_address]
5BB6: 96 00          LDA    $00
5BB8: 48             ASLA
5BB9: 31 A6          LEAY   A,Y
5BBB: 4F             CLRA
...
6B7E: E1 02          CMPB   $2,X	; [bank_address]
...
6B9A: 4F             CLRA
6B9B: E6 21          LDB    $1,Y	; [bank_address]
6B9D: E3 08          ADDD   $8,X
...
6BC9: 10 AE 26       LDY    $6,Y	; [bank_address]
...
78C0: A6 A4          LDA    ,Y	; [bank_address]
78C2: 81 FF          CMPA   #$FF
78C4: 27 63          BEQ    $7929
78C6: A6 84          LDA    ,X
78C8: 85 80          BITA   #$80
78CA: 26 55          BNE    $7921
78CC: A6 A4          LDA    ,Y	; [bank_address]
78CE: 97 00          STA    $00
...
78F7: 35 20          PULS   Y
78F9: 6F 02          CLR    $2,X
78FB: EC 21          LDD    $1,Y	; [bank_address]
78FD: ED 04          STD    $4,X
78FF: 6F 0A          CLR    $A,X
7901: EC 23          LDD    $3,Y	; [bank_address]
7903: ED 06          STD    $6,X
7905: 6F 0B          CLR    $B,X
7907: EC 25          LDD    $5,Y	; [bank_address]
7909: ED 08          STD    $8,X
790B: 6F 0C          CLR    $C,X
790D: 86 05          LDA    #$05
