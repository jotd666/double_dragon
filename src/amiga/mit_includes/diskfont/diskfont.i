	.ifndef	DISKFONT_DISKFONT_I
DISKFONT_DISKFONT_I	SET	1
**
**	0xVER: diskfont.i 38.0 (18.6.92)
...
FCH_ID		=	0x0f00	| FontContentsHeader, then FontContents
TFCH_ID		=	0x0f02	| FontContentsHeader, then TFontContents
OFCH_ID		=	0x0f03	| FontContentsHeader, then TFontContents,
