...
42D1: 34 76       PSHS   U,Y,X,D
42D3: 10 8E 43 0F LDY    #$430F
42D7: A6 88 1B    LDA    $1B,X
42DA: 2B 0E       BMI    $42EA
...
4381: E6 A6       LDB    A,Y		; [bank_address]
...
43A6: 84 0F       ANDA   #$0F
43A8: 48          ASLA
43A9: 10 8E 43 B0 LDY    #jump_table_43b0
43AD: AD B6       JSR    [A,Y]		; [indirect_jump] [nb_entries=16]
43AF: 39          RTS
...
43CA: 4A          DECA
43CB: 0E 4A       JMP    $4A   ; [bogus]
43CD: 0E 4A       JMP    $4A   ; [bogus]
...
4462: A6 A6       LDA    A,Y		; [bank_address]
4464: A7 0D       STA    $D,X
4466: 96 55       LDA    $55
4468: 48          ASLA
4469: 8B 0E       ADDA   #$0E
...
44D5: A6 A5       LDA    B,Y		; [bank_address]
44D7: A7 0D       STA    $D,X
...
468F: E6 A6       LDB    A,Y		; [bank_address]
4691: E7 0D       STB    $D,X
4693: C4 80       ANDB   #$80
4695: E7 03       STB    $3,X
...
46FF: 10 8E 47 08 LDY    #jump_table_4708
4703: 84 0F       ANDA   #$0F
4705: 48          ASLA
4706: 6E B6       JMP    [A,Y]		; [indirect_jump] [nb_entries=4]
...
4950: A7 0E       STA    $E,X
4952: 86 40       LDA    #$40
4954: A7 E4       STA    ,S	; [local]
4956: EC 04       LDD    $4,X
4958: 10 83 1A D0 CMPD   #$1AD0
495C: 25 04       BCS    $4962
495E: 86 C0       LDA    #$C0
4960: A7 E4       STA    ,S	; [local]
4962: A6 E4       LDA    ,S	; [local]
4964: A7 0D       STA    $D,X
4966: EC 04       LDD    $4,X
4968: 83 1A D0    SUBD   #$1AD0
496B: 2A 07       BPL    $4974
496D: ED E4       STD    ,S	; [local]
496F: CC 00 00    LDD    #$0000
4972: A3 E4       SUBD   ,S	; [local]
...
49DB: A6 A6       LDA    A,Y		; [bank_address]
49DD: 81 FF       CMPA   #$FF
49DF: 27 09       BEQ    $49EA
49E1: 10 8E 4A 04 LDY    #$4A04
49E5: 10 AE A6    LDY    A,Y		; [bank_address]
49E8: 6A A4       DEC    ,Y
...
4A3A: E6 A6       LDB    A,Y		; [bank_address]
...
4B57: 44          LSRA
4B58: 84 07       ANDA   #$07
4B5A: A6 A6       LDA    A,Y		; [bank_address]
...
4C0E: 34 7E       PSHS   U,Y,X,DP,D
4C10: 10 8E 4D 1D LDY    #$4D1D
4C14: A6 88 4E    LDA    $4E,X
4C17: 1F 89       TFR    A,B
4C19: 48          ASLA
4C1A: 10 AE A6    LDY    A,Y		; [bank_address]
...
4C2C: 1F 98       TFR    B,A
4C2E: 48          ASLA
4C2F: EE C6       LDU    A,U		; [bank_address]
4C31: C1 02       CMPB   #$02
4C33: 24 0D       BCC    $4C42
4C35: 34 04       PSHS   B
4C37: EC 06       LDD    $6,X
...
4C54: 58          ASLB
4C55: EC C5       LDD    B,U		; [bank_address]
4C57: E3 06       ADDD   $6,X
4C59: ED 06       STD    $6,X
4C5B: 35 44       PULS   B,U
4C5D: 20 1B       BRA    $4C7A
...
4C7C: 34 02       PSHS   A		; [manual_stack_push]
4C7E: A6 88 13    LDA    $13,X
4C81: 85 40       BITA   #$40
4C83: 27 04       BEQ    $4C89
4C85: 86 05       LDA    #$05
4C87: A7 E4       STA    ,S		; [handled]
4C89: 35 02       PULS   A		; [manual_stack_pull]
...
4DA3: 80 02       SUBA   #$02
4DA5: 48          ASLA
4DA6: 10 8E 4D AE LDY    #jump_table_4dae
4DAA: AD B6       JSR    [A,Y]		; [indirect_jump] [nb_entries=8]
...
4E50: E6 02       LDB    $2,X
4E52: ED E4       STD    ,S		; [local]
4E54: EC 04       LDD    $4,X
4E56: ED 62       STD    $2,S		; [local]
4E58: EC 06       LDD    $6,X
4E5A: ED 64       STD    $4,S		; [local]
4E5C: EC 08       LDD    $8,X
4E5E: ED 66       STD    $6,S		; [local]
4E60: BD FC 1E    JSR    $FC1E
4E63: A6 E4       LDA    ,S		; [local]
...
4E7A: EC 62       LDD    $2,S		; [local]
4E7C: ED C4       STD    ,U
4E7E: E3 A4       ADDD   ,Y		; [bank_address]
4E80: ED 46       STD    $6,U
4E82: ED 04       STD    $4,X
4E84: EC 64       LDD    $4,S		; [local]
4E86: ED 42       STD    $2,U
4E88: ED 48       STD    $8,U
...
4EC3: 84 0F       ANDA   #$0F         
4EC5: 27 09       BEQ    $4ED0        
4EC7: EC 66       LDD    $6,S  		; [local]       
4EC9: C3 00 0A    ADDD   #$000A       
4ECC: ED 08       STD    $8,X
4ECE: 20 15       BRA    $4EE5
4ED0: EC 66       LDD    $6,S		; [local]
...
4F10: 20 0D       BRA    $4F1F
4F12: EC 66       LDD    $6,S		; [local]
4F14: C3 FF F6    ADDD   #$FFF6
4F17: ED 08       STD    $8,X
4F19: EC 64       LDD    $4,S		; [local]
4F1B: ED 06       STD    $6,X
4F1D: 20 11       BRA    $4F30
4F1F: EC 66       LDD    $6,S		; [local]
...
4F6D: 31 A6       LEAY   A,Y
4F6F: A6 A0       LDA    ,Y+		; [bank_address]
4F71: A7 0D       STA    $D,X
4F73: A6 A4       LDA    ,Y		; [bank_address]
4F75: A7 03       STA    $3,X
4F77: 7E 4E A8    JMP    $4EA8

4F7E: 6A 88 19    DEC    $19,X
...
50B8: 10 8E 50 BF LDY    #jump_table_50bf
50BC: 48          ASLA
50BD: 6E B6       JMP    [A,Y]		; [indirect_jump] [nb_entries=2]
...
50D6: 48          ASLA
50D7: EC A6       LDD    A,Y		; [bank_address]
...
5134: 84 01       ANDA   #$01
5136: A6 A6       LDA    A,Y		; [bank_address]
5138: A7 0D       STA    $D,X
...
5153: 25 04       BCS    $5159
5155: 86 80       LDA    #$80
5157: A7 E4       STA    ,S				; [local]
5159: A6 E4       LDA    ,S		; [local]
515B: A7 0D       STA    $D,X
...
516A: A6 A6       LDA    A,Y		; [bank_address]
516C: A7 0D       STA    $D,X
516E: 39          RTS
516F: 00 80       NEG    $80
5171: 34 40       PSHS   U
...
5187: 48          ASLA
5188: E6 C6       LDB    A,U		; [bank_address]
518A: E7 03       STB    $3,X
518C: 4C          INCA
518D: E6 C6       LDB    A,U		; [bank_address]
518F: A6 23       LDA    $3,Y
5191: 88 80       EORA   #$80
5193: A7 03       STA    $3,X
...
5348: 80 17       SUBA   #$17
534A: 80 02       SUBA   #$02
534C: A6 C6       LDA    A,U		; [bank_address]
534E: 26 D6       BNE    $5326
...
5379: A3 C4       SUBD   ,U
537B: 2A 07       BPL    $5384
537D: ED 61       STD    $1,S		; [local]
537F: CC 00 00    LDD    #$0000
5382: A3 61       SUBD   $1,S		; [local]
...
5413: 6D E4       TST    ,S		; [handled] tests passed value of A
5415: 27 04       BEQ    $541B
...
5431: EC 06       LDD    $6,X
5433: ED 42       STD    $2,U
5435: E3 A1       ADDD   ,Y++		; [bank_address]
5437: ED 48       STD    $8,U
...
54B6: A6 A6       LDA    A,Y		; [bank_address]
54B8: 26 1C       BNE    $54D6
54BA: EC 48       LDD    $8,U
...
550D: 84 0F       ANDA   #$0F
550F: 48          ASLA
5510: 10 8E 55 17 LDY    #jump_table_5517
5514: 6E B6       JMP    [A,Y]		; [indirect_jump] [nb_entries=7]
5516: 39          RTS
...
554F: 4F          CLRA
5550: A6 A6       LDA    A,Y		; [bank_address]
5552: AA 03       ORA    $3,X
5554: A7 02       STA    $2,X
5556: BD FB 76    JSR    $FB76
5559: 84 07       ANDA   #$07
555B: 10 8E 55 73 LDY    #$5573
555F: A6 A6       LDA    A,Y		; [bank_address]
...
565E: 4F          CLRA
565F: A6 A6       LDA    A,Y		; [bank_address]
5661: A7 02       STA    $2,X
5663: 86 10       LDA    #$10
...
5707: 81 C0       CMPA   #$C0
5709: 26 0B       BNE    $5716
570B: 10 8E 57 24 LDY    #jump_table_5724
570F: 96 29       LDA    $29
5711: 84 03       ANDA   #$03
5713: 48          ASLA
5714: AD B6       JSR    [A,Y]		; [indirect_jump] [nb_entries=4]
5716: C6 55       LDB    #$55
5718: 3A          ABX
...
5757: EC 24       LDD    $4,Y
5759: ED E4       STD    ,S		; [local]
575B: EC 04       LDD    $4,X
575D: ED 62       STD    $2,S		; [local]
...
57EB: EC E4       LDD    ,S		; [local]
57ED: ED 24       STD    $4,Y
57EF: EC 62       LDD    $2,S		; [local]
57F1: ED 04       STD    $4,X
...
580F: 84 03       ANDA   #$03
5811: 48          ASLA
5812: 10 8E 58 1A LDY    #jump_table_581a
5816: AD B6       JSR    [A,Y]		; [indirect_jump] [nb_entries=4]
...
5A7D: A6 A5       LDA    B,Y		; [bank_address]
5A7F: 97 01       STA    $01
...
5A94: 31 A6       LEAY   A,Y
5A96: A6 A0       LDA    ,Y+		; [bank_address]
5A98: 2B 26       BMI    $5AC0
5A9A: B1 0E 48    CMPA   $0E48
5A9D: 24 0E       BCC    $5AAD
5A9F: A6 A0       LDA    ,Y+		; [bank_address]
...
5B6C: A6 A5       LDA    B,Y		; [bank_address]
5B6E: 97 01       STA    $01
...
5B90: 34 76       PSHS   U,Y,X,D
5B92: FE 0E 4B    LDU    $0E4B
...
5BAF: E6 A6       LDB    A,Y		; [bank_address]
5BB1: E1 0D       CMPB   $D,X
5BB3: 39          RTS

5BB6: 34 36       PSHS   Y,X,D                                       
5BB8: 4F          CLRA                                               
...
5D91: 84 7F       ANDA   #$7F
5D93: 97 00       STA    $00
5D95: A6 A5       LDA    B,Y		; [bank_address]
5D97: 81 FF       CMPA   #$FF
5D99: 27 21       BEQ    $5DBC
5D9B: 91 00       CMPA   $00
5D9D: 27 03       BEQ    $5DA2
...
5DA6: 58          ASLB
5DA7: EC A5       LDD    B,Y		; [bank_address]
5DA9: 6D 02       TST    $2,X
5DAB: 2A 09       BPL    $5DB6
5DAD: DD 00       STD    $00
...
5F5D: 48          ASLA
5F5E: EC A6       LDD    A,Y		; [bank_address]
...
5FCE: 48          ASLA
5FCF: 48          ASLA
5FD0: 34 02       PSHS   A		; [manual_stack_push]
...
60BC: A6 C6       LDA    A,U		; [bank_address]
60BE: 81 FF       CMPA   #$FF
60C0: 27 33       BEQ    $60F5
60C2: CE 4A 04    LDU    #$4A04
60C5: EE C6       LDU    A,U		; [bank_address]
60C7: 6D C4       TST    ,U
60C9: 27 2A       BEQ    $60F5
60CB: 6A C4       DEC    ,U
60CD: 20 26       BRA    $60F5
...
60E2: A6 E4       LDA    ,S		; [local]
60E4: A6 A6       LDA    A,Y		; [bank_address]
60E6: A7 0D       STA    $D,X
60E8: 86 00       LDA    #$00
...
6102: 84 0F       ANDA   #$0F
6104: A7 E4       STA    ,S		; [local]
6106: A6 88 1F    LDA    $1F,X
6109: 84 F0       ANDA   #$F0
610B: AA E4       ORA    ,S		; [local]
...
618A: A6 A6       LDA    A,Y		; [bank_address]
618C: 26 0E       BNE    $619C
...
621D: 0D 2A       TST    $2A
621F: 27 07       BEQ    $6228
6221: EC E4       LDD    ,S		; [local]
6223: C3 00 30    ADDD   #$0030
6226: ED E4       STD    ,S		; [local]
6228: EC E4       LDD    ,S		; [local]
622A: ED 04       STD    $4,X
622C: EC A1       LDD    ,Y++		; [bank_address]
622E: ED 06       STD    $6,X
...
6314: 81 07       CMPA   #$07
6316: 24 04       BCC    $631C
6318: A6 A6       LDA    A,Y		; [bank_address]
631A: 27 0D       BEQ    $6329
...
64E5: EC 06       LDD    $6,X
64E7: E3 08       ADDD   $8,X
64E9: ED E4       STD    ,S		; [local]
64EB: DC 3F       LDD    $3F
64ED: C3 00 04    ADDD   #$0004
64F0: 10 A3 E4    CMPD   ,S		; [local]
64F3: 25 09       BCS    $64FE
64F5: DC 3F       LDD    $3F
...
6539: 58          ASLB
653A: 49          ROLA
653B: 31 AB       LEAY   D,Y		; [bank_address]
...
65A7: 30 86       LEAX   A,X
65A9: 86 00       LDA    #$00
65AB: E6 80       LDB    ,X+		; [bank_address]
65AD: FD 19 22    STD    $1922
65B0: E6 80       LDB    ,X+		; [bank_address]
...
65BC: 30 86       LEAX   A,X
65BE: 86 00       LDA    #$00
65C0: E6 80       LDB    ,X+		; [bank_address]
65C2: FD 19 24    STD    $1924
65C5: E6 80       LDB    ,X+		; [bank_address]
...
65DA: E6 A6       LDB    A,Y		; [bank_address]
...
6619: 30 86       LEAX   A,X
661B: 86 00       LDA    #$00
661D: E6 80       LDB    ,X+		; [bank_address]
661F: FD 1F 08    STD    $1F08
6622: E6 80       LDB    ,X+		; [bank_address]
...
6634: 30 86       LEAX   A,X
6636: 86 00       LDA    #$00
6638: E6 80       LDB    ,X+		; [bank_address]
663A: FD 1F 30    STD    $1F30
663D: E6 80       LDB    ,X+		; [bank_address]
663F: FD 1F 70    STD    $1F70
6642: 35 90       PULS   X,PC

6666: B6 03 C1    LDA    $03C1
6669: 97 00       STA    $00
666B: 86 C0       LDA    #$C0
666D: 97 03       STA    $03
666F: CC 1F 4A    LDD    #$1F4A
6672: DD 01       STD    $01
...
6692: E7 E4       STB    ,S		; [local]
6694: DE 01       LDU    $01
6696: 86 05       LDA    #$05
6698: A7 61       STA    $1,S		; [local]
669A: 96 03       LDA    $03
669C: 6D E4       TST    ,S		; [local]
669E: 27 0E       BEQ    $66AE
66A0: C6 61       LDB    #$61
66A2: ED C1       STD    ,U++
66A4: 6A 61       DEC    $1,S		; [local]
66A6: 6A E4       DEC    ,S		; [local]
66A8: 26 F8       BNE    $66A2
66AA: 6D 61       TST    $1,S		; [local]
66AC: 27 08       BEQ    $66B6
66AE: C6 60       LDB    #$60
66B0: ED C1       STD    ,U++
66B2: 6A 61       DEC    $1,S		; [local]
66B4: 26 FA       BNE    $66B0
...
66CC: 34 02       PSHS   A		; [manual_stack_push]
66CE: 10 AE 88 2D LDY    $2D,X
66D2: A6 A8 1F    LDA    $1F,Y
66D5: 27 08       BEQ    $66DF
66D7: A0 E4       SUBA   ,S		; [handled]
66D9: 24 01       BCC    $66DC
66DB: 4F          CLRA
66DC: A7 A8 1F    STA    $1F,Y
66DF: BD 66 66    JSR    $6666
66E2: 35 82       PULS   A,PC	; [manual_stack_pull]
...
6754: C1 09       CMPB   #$09
6756: 26 03       BNE    $675B
6758: BD 75 5F    JSR    $755F		; [bogus] [breakpoint]
675B: 85 02       BITA   #$02
675D: 26 54       BNE    $67B3
...
6771: A6 A6       LDA    A,Y		; [bank_address]
6773: 81 16       CMPA   #$16
6775: 26 B9       BNE    $6730
6777: 86 07       LDA    #$07
...
6799: A6 A8 17    LDA    $17,Y		; [bank_address]
679C: CE 68 83    LDU    #$6883
679F: A6 C6       LDA    A,U		; [bank_address]
67A1: 81 FF       CMPA   #$FF
67A3: 27 8B       BEQ    $6730
...
6802: 2A 04       BPL    $6808
6804: 86 80       LDA    #$80
6806: A7 E4       STA    ,S		; [local]
6808: 6F 61       CLR    $1,S		; [local]
680A: A6 03       LDA    $3,X
680C: A8 E4       EORA   ,S		; [local]
680E: 27 02       BEQ    $6812
6810: 6C 61       INC    $1,S		; [local]
6812: A6 0F       LDA    $F,X
6814: A8 E4       EORA   ,S		; [local]
6816: 26 06       BNE    $681E
6818: A6 61       LDA    $1,S		; [local]
681A: 88 01       EORA   #$01
681C: A7 61       STA    $1,S		; [local]
681E: 86 01       LDA    #$01
6820: A7 88 1B    STA    $1B,X
6823: A6 61       LDA    $1,S		; [local]
...
683E: 81 02       CMPA   #$02
6840: 25 1A       BCS    $685C
6842: A6 C5       LDA    B,U		; [bank_address]
6844: 81 FF       CMPA   #$FF
6846: 27 14       BEQ    $685C
...
68E1: EC 06       LDD    $6,X
68E3: E3 08       ADDD   $8,X
68E5: ED E4       STD    ,S		; [local]
68E7: DC 3F       LDD    $3F
68E9: C3 01 80    ADDD   #$0180
68EC: 10 A3 E4    CMPD   ,S		; [local]
68EF: 25 16       BCS    $6907
68F1: EC E4       LDD    ,S		; [local]
...
69B8: 25 02       BCS    $69BC
69BA: 80 17       SUBA   #$17
69BC: A6 A6       LDA    A,Y		; [bank_address]
...
6AAB: A6 A6       LDA    A,Y		; [bank_address]
6AAD: 81 FF       CMPA   #$FF
6AAF: 27 0D       BEQ    $6ABE
6AB1: 10 8E 73 54 LDY    #$7354
6AB5: 10 AE A6    LDY    A,Y		; [bank_address]
6AB8: 6D A4       TST    ,Y
6ABA: 27 02       BEQ    $6ABE
6ABC: 6A A4       DEC    ,Y
6ABE: 39          RTS
...
6B0A: A6 A6       LDA    A,Y		; [bank_address]
6B0C: 2B 13       BMI    $6B21
6B0E: 86 07       LDA    #$07
...
6B60: C6 55       LDB    #$55
6B62: 3A          ABX
6B63: 6C E4       INC    ,S		; [local]
6B65: A6 E4       LDA    ,S		; [local]
6B67: 81 09       CMPA   #$09
6B69: 25 D3       BCS    $6B3E
...
6C26: 25 02       BCS    $6C2A
6C28: 80 17       SUBA   #$17
6C2A: A6 A6       LDA    A,Y		; [bank_address]
6C2C: 26 10       BNE    $6C3E
...
6CDD: C6 80       LDB    #$80
6CDF: E7 61       STB    $1,S		; [local]
6CE1: C4 0F       ANDB   #$0F
6CE3: 1F 98       TFR    B,A
6CE5: 4C          INCA
6CE6: A7 62       STA    $2,S		; [local]
6CE8: 10 8E 0E 0B LDY    #$0E0B
6CEC: A6 A5       LDA    B,Y
6CEE: A1 62       CMPA   $2,S		; [local]
6CF0: 24 23       BCC    $6D15
6CF2: 6C A5       INC    B,Y
6CF4: A6 61       LDA    $1,S		; [local]
6CF6: A7 88 38    STA    $38,X
6CF9: A6 E4       LDA    ,S		; [local]
...
6D10: EC 64       LDD    $4,S		; [breakpoint] (changes Y on return, to test)
...
6D45: 25 02       BCS    $6D49
6D47: 80 17       SUBA   #$17
6D49: A6 A6       LDA    A,Y		; [bank_address]
6D4B: 26 15       BNE    $6D62
...
6DBF: A6 C6       LDA    A,U		; [bank_address]
6DC1: 81 FF       CMPA   #$FF
6DC3: 27 0B       BEQ    $6DD0
6DC5: CE 73 54    LDU    #$7354
6DC8: EE C6       LDU    A,U		; [bank_address]
6DCA: 6D C4       TST    ,U
6DCC: 27 02       BEQ    $6DD0
6DCE: 6A C4       DEC    ,U
...
6EB7: A6 C6       LDA    A,U		; [bank_address]
6EB9: 81 FF       CMPA   #$FF
6EBB: 27 0B       BEQ    $6EC8
6EBD: CE 73 54    LDU    #$7354
6EC0: EE C6       LDU    A,U		; [bank_address]
6EC2: 6D C4       TST    ,U
6EC4: 27 02       BEQ    $6EC8
6EC6: 6A C4       DEC    ,U
...
6EDC: 1F 89       TFR    A,B
6EDE: 3D          MUL
6EDF: 34 06       PSHS   D		; [manual_stack_push]
6EE1: A6 88 3B    LDA    $3B,X
6EE4: 1F 89       TFR    A,B
6EE6: 3D          MUL
6EE7: E3 E4       ADDD   ,S		; [handled]
6EE9: 34 02       PSHS   A
...
6EFD: A7 A4       STA    ,Y
6EFF: 0C 80       INC    $80
6F01: 35 86       PULS   D,PC	; [manual_stack_pull]
6F03: 34 02       PSHS   A
...
6F23: 1F 89       TFR    A,B
6F25: 3D          MUL
6F26: 34 06       PSHS   D		; [manual_stack_push]
6F28: A6 88 3D    LDA    $3D,X
6F2B: 1F 89       TFR    A,B
6F2D: 3D          MUL
6F2E: E3 E4       ADDD   ,S		; [handled]
6F30: 34 02       PSHS   A
...
6F44: A7 A4       STA    ,Y
6F46: 0C A6       INC    $A6
6F48: 35 86       PULS   D,PC	; [manual_stack_pull]
6F4A: 34 02       PSHS   A
