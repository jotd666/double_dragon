...
8004: B7 38 08       STA    $3808
8007: 1A 50          ORCC   #$50
8009: B7 38 0D       STA    $380D
800C: B7 38 0B       STA    $380B
800F: B7 38 0C       STA    $380C
8012: 4F             CLRA
8013: 1F 8B          TFR    A,DP
...
8032: 84 E7          ANDA   #$E7
8034: 97 3A          STA    $3A
8036: B7 38 08       STA    $3808
8039: 8A 08          ORA    #$08
803B: 97 3A          STA    $3A
803D: B7 38 08       STA    $3808
...
8071: BD FF 24       JSR    $FF24
8074: BD FE A4       JSR    $FEA4
...
80A6: 84 DF          ANDA   #$DF
80A8: 97 22          STA    $22
80AA: B7 38 0C       STA    $380C
80AD: 35 7F          PULS   CC,D,DP,X,Y,U
80AF: 3B             RTI
80B0: 86 01          LDA    #$01
80B2: B7 0E 3E       STA    $0E3E
80B5: B7 38 0D       STA    $380D
80B8: 3B             RTI
80B9: 3B             RTI
80BA: 86 FF          LDA    #$FF
80BC: B7 38 0E       STA    $380E
80BF: C6 FF          LDB    #$FF
80C1: 5A             DECB
80C2: 26 FD          BNE    $80C1
80C4: 86 FE          LDA    #$FE
80C6: B7 38 0E       STA    $380E
80C9: 9E 23          LDX    $23
80CB: 96 25          LDA    $25
80CD: D6 3A          LDB    $3A
80CF: 34 16          PSHS   X,D
...
8158: 86 FF          LDA    #$FF
815A: B7 38 0E       STA    $380E
815D: C6 FF          LDB    #$FF
815F: 5A             DECB
8160: 26 FD          BNE    $815F
8162: 86 FE          LDA    #$FE
8164: B7 38 0E       STA    $380E
...
8374: 0A 0D          DEC    $0D
8376: 00 01          NEG    $01
8378: 02 03 00       AIM    #$03;$00
837B: 01 02 03       OIM    #$02;$03
...
8453: 86 FF          LDA    #$FF
8455: B7 38 0E       STA    $380E
8458: BD FE 98       JSR    $FE98
845B: BD FE 9B       JSR    $FE9B
845E: BD FE 9E       JSR    $FE9E
8461: 86 FE          LDA    #$FE
8463: B7 38 0E       STA    $380E
8466: 96 3A          LDA    $3A
8468: 8A 60          ORA    #$60
846A: B7 38 08       STA    $3808
846D: 97 3A          STA    $3A
846F: BD 6C 1E       JSR    $6C1E
8472: 96 3A          LDA    $3A
8474: 84 1F          ANDA   #$1F
8476: B7 38 08       STA    $3808
8479: 97 3A          STA    $3A
...
86E0: 15             FCB    $15
86E1: 16 17 FF       LBRA   $9EE3
86E4: 0E 0E          JMP    $0E
86E6: 0E FF          JMP    $FF
86E8: 15             FCB    $15
86E9: 17 1A 00       LBSR   $A0EC
86EC: 96 36          LDA    $36
86EE: 81 03          CMPA   #$03
86F0: 26 26          BNE    $8718
86F2: 96 29          LDA    $29
...
87CF: 8B 8C          ADDA   #$8C
87D1: FE FD 01       LDU    $FD01
87D4: 82 32          SBCA   #$32
87D6: 7D 7C 0E       TST    $7C0E
87D9: 34 B6          PSHS   PC,Y,X,D
87DB: 0E 34          JMP    $34
...
8998: B6 38 01       LDA    $3801
899B: 43             COMA
899C: F6 38 02       LDB    $3802
899F: 53             COMB
89A0: 54             LSRB
89A1: 46             RORA
89A2: 84 E0          ANDA   #$E0
...
89DC: B6 38 01       LDA    $3801
89DF: 43             COMA
89E0: F6 38 02       LDB    $3802
89E3: 53             COMB
89E4: 54             LSRB
89E5: 46             RORA
89E6: 84 E0          ANDA   #$E0
89E8: 26 F2          BNE    $89DC
89EA: 86 02          LDA    #$02
89EC: B7 38 0E       STA    $380E
89EF: 6F E4          CLR    ,S
89F1: 5F             CLRB
89F2: 96 20          LDA    $20
89F4: 2B 0F          BMI    $8A05
89F6: F6 38 03       LDB    $3803
89F9: 53             COMB
89FA: C4 3F          ANDB   #$3F
89FC: 48             ASLA
89FD: 48             ASLA
...
8A89: 26 F9          BNE    $8A84
8A8B: B6 38 01       LDA    $3801
8A8E: 43             COMA
8A8F: F6 38 02       LDB    $3802
8A92: 53             COMB
8A93: 54             LSRB
8A94: 46             RORA
8A95: 94 20          ANDA   $20
8A97: 39             RTS
8A98: 01 01 01       OIM    #$01;$01
8A9B: 01 01 02       OIM    #$01;$02
8A9E: 03 04          COM    $04
8AA0: 01 02 03       OIM    #$02;$03
8AA3: 04 05          LSR    $05
8AA5: 01 01 01       OIM    #$01;$01
8AA8: 96 26          LDA    $26
8AAA: 26 08          BNE    $8AB4
8AAC: 86 99          LDA    #$99
...
8AB7: 8A 10          ORA    #$10
8AB9: 97 3A          STA    $3A
8ABB: B7 38 08       STA    $3808
8ABE: B6 38 02       LDA    $3802
8AC1: 84 10          ANDA   #$10
8AC3: 26 F9          BNE    $8ABE
8AC5: 39             RTS
...
8C10: 48             ASLA
8C11: 10 8E 8C 21    LDY    #table_8C21
8C15: AD B6          JSR    [A,Y]		; [jump_table]
...
8CB3: 20 0C          BRA    $8CC1
8CB5: 40             NEGA
8CB6: 10 60          FCB    $10,$60
8CB8: 0C             FCB    $0C
8CB9: 80 10 A0       SUBW   #$10A0
8CBC: 0C C0          INC    $C0
8CBE: 10 E0          FCB    $10,$E0
8CC0: 0C             FCB    $0C
8CC1: FF FF 00       STS    $FF00
8CC4: 00 00          NEG    $00
8CC6: FF 80 80       STU    $8080
8CC9: 80 10          SUBA   #$10
8CCB: 8E 0B 31       LDX    #$0B31
8CCE: EC 04          LDD    $4,X
8CD0: ED A4          STD    ,Y
8CD2: EC 06          LDD    $6,X
8CD4: ED 22          STD    $2,Y
...
8CE4: BD 40 8A       JSR    $408A
8CE7: BD 40 A8       JSR    $40A8
8CEA: BD 40 AB       JSR    $40AB
...
8E5A: 39             RTS
8E5B: 00 01          NEG    $01
8E5D: 01 00 00       OIM    #$00;$00
8E60: 00 00          NEG    $00
8E62: 00 01          NEG    $01
8E64: 02 02 02       AIM    #$02;$02
8E67: 06 03          ROR    $03
8E69: 03 03          COM    $03
8E6B: 07 02          ASR    $02
...
8E79: 04 04          LSR    $04
8E7B: 00 BD          NEG    $BD
8E7D: FD A0 BD       STD    $A0BD
8E80: 40             NEGA
8E81: 90 34          SUBA   $34
8E83: 01 BD FD       OIM    #$BD;$FD
8E86: B2 35 81       SBCA   $3581
...
8F31: C4 8F          ANDB   #$8F
8F33: 94 01          ANDA   $01
8F35: 01 06 06       OIM    #$06;$06
8F38: 02 02 00       AIM    #$02;$00
8F3B: 00 06          NEG    $06
8F3D: 06 05          ROR    $05
8F3F: 05 00 00       EIM    #$00;$00
8F42: 00 00          NEG    $00
8F44: FF FF 00       STU    $FF00
8F47: 00 05          NEG    $05
8F49: 05 00 00       EIM    #$00;$00
8F4C: 08 08          ASL    $08
8F4E: 00 00          NEG    $00
8F50: 02 02 00       AIM    #$02;$00
8F53: 00 06          NEG    $06
8F55: 06 00          ROR    $00
8F57: 00 07          NEG    $07
8F59: 07 00          ASR    $00
8F5B: 00 FF          NEG    $FF
8F5D: FF 00 00       STU    >$0000
8F60: 05 05 00       EIM    #$05;$00
8F63: 00 01          NEG    $01
8F65: 01 00 00       OIM    #$00;$00
8F68: 02 02 00       AIM    #$02;$00
8F6B: 00 06          NEG    $06
8F6D: 06 00          ROR    $00
8F6F: 00 0C          NEG    $0C
8F71: 0C 00          INC    $00
8F73: 00 FF          NEG    $FF
8F75: FF 00 00       STU    >$0000
8F78: 0D 0D          TST    $0D
8F7A: 00 00          NEG    $00
8F7C: 08 08          ASL    $08
8F7E: 00 00          NEG    $00
8F80: 02 02 00       AIM    #$02;$00
8F83: 00 06          NEG    $06
8F85: 06 00          ROR    $00
8F87: 00 0C          NEG    $0C
8F89: 0C 00          INC    $00
8F8B: 00 FF          NEG    $FF
8F8D: FF 00 00       STU    >$0000
8F90: 0D 0D          TST    $0D
8F92: 00 00          NEG    $00
8F94: 01 01 00       OIM    #$01;$00
8F97: 00 02          NEG    $02
8F99: 02 00 00       AIM    #$00;$00
8F9C: 06 06          ROR    $06
8F9E: 00 00          NEG    $00
8FA0: 0E 0E          JMP    $0E
8FA2: 00 00          NEG    $00
8FA4: FF FF 00       STU    $FF00
8FA7: 00 0F          NEG    $0F
8FA9: 0F 00          CLR    $00
8FAB: 00 08          NEG    $08
8FAD: 08 00          ASL    $00
8FAF: 00 02          NEG    $02
8FB1: 02 00 00       AIM    #$00;$00
8FB4: 06 06          ROR    $06
8FB6: 00 00          NEG    $00
8FB8: 0E 0E          JMP    $0E
8FBA: 00 00          NEG    $00
8FBC: FF FF 00       STU    $FF00
8FBF: 00 0F          NEG    $0F
8FC1: 0F 00          CLR    $00
8FC3: 00 10          NEG    $10
8FC5: 10 00          FCB    $10,$00
8FC7: 00             FCB    $00
8FC8: FF FF 00       STS    $FF00
8FCB: 00 FF          NEG    $FF
8FCD: FF 00 00       STU    >$0000
8FD0: 10 10          FCB    $10,$10
8FD2: 00 00          NEG    $00
8FD4: FF FF 00       STU    $FF00
8FD7: 00 11          NEG    $11
8FD9: 11 00          FCB    $11,$00
8FDB: 00             FCB    $00
8FDC: 10             FCB    $10
8FDD: 10 00          FCB    $10,$00
8FDF: 00             FCB    $00
8FE0: FF FF 00       STS    $FF00
8FE3: 00 FF          NEG    $FF
8FE5: FF 00 00       STU    >$0000
8FE8: 10 10          FCB    $10,$10
8FEA: 00 00          NEG    $00
8FEC: FF FF 00       STU    $FF00
8FEF: 00 11          NEG    $11
8FF1: 11 00          FCB    $11,$00
8FF3: 00             FCB    $00
8FF4: A6 88 15       LDE    $15,X
8FF7: 85 40          BITA   #$40
8FF9: 27 34          BEQ    $902F
...
9172: 00 E4          NEG    $E4
9174: 00 00          NEG    $00
9176: F0 00 00       SUBB   >$0000
9179: E8 00          EORB   $0,X
917B: 00 00          NEG    $00
917D: 00 00          NEG    $00
917F: 10 00          FCB    $10,$00
9181: 00             FCB    $00
9182: 04             FCB    $04
9183: 00             FCB    $00
9184: 00             FCB    $00
...
91A1: 00 00          NEG    $00
91A3: 00 00          NEG    $00
91A5: 01 00 00       OIM    #$00;$00
91A8: 01 00 00       OIM    #$00;$00
91AB: 00 00          NEG    $00
91AD: 00 00          NEG    $00
...
9289: 00 00          NEG    $00
928B: 18             FCB    $18
928C: 10 08          FCB    $10,$08
928E: 03             FCB    $03
928F: 03             FCB    $03
9290: 03             FCB    $03
9291: 03             FCB    $03
9292: 03             FCB    $03
9293: A6 88 1B       LDW    $1B,X
9296: 2B 25          BMI    $92BD
...
941B: 7F 48 10       CLR    $4810
941E: 8E 94 23       LDX    #table_9423
9421: 6E B6          JMP    [A,Y]		; [jump_table]
table_9423:
	.word	$944F
	.word	$94F3
	.word	$9532
...
94E6: 03 11          COM    $11
94E8: 03 BD          COM    $BD
94EA: FC 82 BD       LDD    $82BD
94ED: 40             NEGA
94EE: 78 BD FC       ASL    $BDFC
94F1: 8F             FCB    $8F
94F2: 39             RTS
...
96E3: 39             RTS
96E4: 17 02 18       LBSR   $98FF
96E7: 02 36 06       AIM    #$36;$06
96EA: 37 06          PULU   D
96EC: 2A 06          BPL    $96F4
...
97E4: 20 21          BRA    $9807
97E6: 00 FF          NEG    $FF
97E8: FF 00 00       STU    >$0000
97EB: FF FF FF       STU    $FFFF
97EE: FF FF FF       STU    $FFFF
97F1: FF FF FF       STU    $FFFF
97F4: FF 10 8E       STU    $108E
97F7: 98 30          EORA   $30
...
99DE: 43             COMA
99DF: 02 44 02       AIM    #$44;$02
99E2: 45             FCB    $45
99E3: 02 46 04       AIM    #$46;$04
99E6: 34 40          PSHS   U
...
9B2E: 57             ASRB
9B2F: 58             ASLB
9B30: 34 57          PSHS   U,X,D,CC
9B32: 58             ASLB
9B33: 34 56          PSHS   U,X,D
9B35: 57             ASRB
9B36: 34 6B          PSHS   U,Y,DP,A,CC
9B38: 6C 34          INC    -$C,Y
9B3A: 7F 7F 7F       CLR    $7F7F
9B3D: 56             RORB
9B3E: 57             ASRB
9B3F: 34 34          PSHS   Y,X,B
9B41: 40             NEGA
...
9DE4: A7 02          STA    $2,X
9DE6: 39             RTS
9DE7: FF FF FF       STU    $FFFF
9DEA: 03 FF          COM    $FF
9DEC: FF FF FF       STU    $FFFF
9DEF: 01 05 FF       OIM    #$05;$FF
9DF2: 01 05 00       OIM    #$05;$00
9DF5: 00 00          NEG    $00
9DF7: 00 FF          NEG    $FF
9DF9: FF FF FF       STU    $FFFF
9DFC: 00 00          NEG    $00
9DFE: 00 FF          NEG    $FF
9E00: FF FF FF       STU    $FFFF
9E03: FF 00 00       STU    >$0000
9E06: FF FF FF       STU    $FFFF
9E09: FF FF FF       STU    $FFFF
9E0C: 00 FF          NEG    $FF
9E0E: FF FF FF       STU    $FFFF
9E11: FF FF FF       STU    $FFFF
...
9EA0: 03 00          COM    $00
9EA2: 00 06          NEG    $06
9EA4: 05 04 01       EIM    #$04;$01
9EA7: 02 00 00       AIM    #$00;$00
9EAA: 00 00          NEG    $00
9EAC: 00 00          NEG    $00
9EAE: 07 10          ASR    $10
9EB0: AE 88 2D       LDX    $2D,X
...
9F6F: 84 7F          ANDA   #$7F
9F71: 10 8E 9F 79    LDY    #table_9F79
9F75: 48             ASLA
9F76: 6E B6          JMP    [A,Y]		; [jump_table]
9F78: 39             RTS
table_9F79:
	.word 	$9FAA
	.word 	$A003
...
A2AB: 59             ROLB
A2AC: 60 61          NEG    $1,S
A2AE: 62 60 61       AIM    #$60;$1,S
A2B1: 62 5F 60       AIM    #$5F;$0,S
A2B4: 61 74 75       OIM    #$74;-$B,S
A2B7: 76 7F 7F       ROR    $7F7F
A2BA: 7F 5B 5C       CLR    $5B5C
A2BD: 5A             DECB
A2BE: 5B             FCB    $5B
A2BF: 5C             INCB
A2C0: 5A             DECB
A2C1: 62 63 5B       AIM    #$63;-$5,U
A2C4: 6F 70          CLR    -$10,S
A2C6: 6E 7F          JMP    -$1,S
A2C8: 7F 59 5E       CLR    $595E
A2CB: 5D             TSTB
A2CC: 5F             CLRB
A2CD: 5F             CLRB
A2CE: 5E             FCB    $5E
...
A2D0: 5F             CLRB
A2D1: 5F             CLRB
A2D2: 65 64 66       EIM    #$64;$6,S
A2D5: 66 72          ROR    -$E,S
A2D7: 71 73 73 5D    OIM    #$73,$735D
A2DB: 5C             INCB
A2DC: 5E             FCB    $5E
A2DD: 5E             FCB    $5E
A2DE: 59             ROLB
...
A521: 39             RTS
A522: 00 01          NEG    $01
A524: 02 00 7F       AIM    #$00;$7F
A527: 7F 7F 6F       CLR    $7F6F
A52A: 88 19          EORA   #$19
...
A584: 1C FE          ANDCC  #$FE
A586: 39             RTS
A587: 05 05 05       EIM    #$05;$05
A58A: 05 05 05       EIM    #$05;$05
A58D: 05 05 05       EIM    #$05;$05
A590: 05 05 05       EIM    #$05;$05
A593: 05 32 7F       EIM    #$32;$7F
...
A62A: 80 00          SUBA   #$00
A62C: 00 00          NEG    $00
A62E: 02 02 02       AIM    #$02;$02
A631: 01 01 00       OIM    #$01;$00
A634: 10 00          FCB    $10,$00
A636: 10             FCB    $10
A637: 00 00          NEG    $00
A639: FF F0 FF       STU    $F0FF
A63C: F0 FF F0       SUBB   $FFF0
A63F: 00 00          NEG    $00
A641: 00 10          NEG    $10
A643: 34 40          PSHS   U
...
A6E5: 17 04 18       LBSR   $AB00
A6E8: 0A 0C          DEC    $0C
A6EA: 04 0D          LSR    $0D
A6EC: 04 0D          LSR    $0D
A6EE: 04 00          LSR    $00
A6F0: FF FF 00       STU    $FF00
A6F3: 00 34          NEG    $34
A6F5: 76 6F 88       ROR    $6F88
A6F8: 25 A6          BCS    $A6A0
A6FA: 01 81 02       OIM    #$81;$02
A6FD: 25 15          BCS    $A714
A6FF: 81 08          CMPA   #$08
A701: 24 11          BCC    $A714
...
A882: 0D 10          TST    $10
A884: 00 04          NEG    $04
A886: 01 8A 0A       OIM    #$8A;$0A
A889: 00 00          NEG    $00
A88B: 8A 8B          ORA    #$8B
A88D: 8B 10          ADDA   #$10
A88F: 00 04          NEG    $04
A891: 02 8C 0C       AIM    #$8C;$0C
A894: 00 00          NEG    $00
A896: 8C 8D 8D       CMPX   #$8D8D
A899: 10 00          FCB    $10,$00
A89B: 04             FCB    $04
A89C: 03             FCB    $03
A89D: 0C             FCB    $0C
A89E: 0C             FCB    $0C
...
A8A4: 10             FCB    $10
A8A5: 00 04          NEG    $04
A8A7: 01 0A 0A       OIM    #$0A;$0A
A8AA: 00 00          NEG    $00
A8AC: 0A 0B          DEC    $0B
A8AE: 0B 10 00       TIM    #$10;$00
A8B1: 04 00          LSR    $00
A8B3: 35 06          PULS   D
A8B5: 00 00          NEG    $00
A8B7: 35 8B          PULS   CC,A,DP,PC
A8B9: 8B 20          ADDA   #$20
A8BB: 00 04          NEG    $04
A8BD: 06 35          ROR    $35
A8BF: 06 00          ROR    $00
...
A91A: 80 02          SUBA   #$02
A91C: 48             ASLA
A91D: 10 8E A9 2D    LDY    #table_A92D
A921: 10 AE A6       LDY    A,Y
A924: A6 88 1E       LDA    $1E,X
A927: 84 7F          ANDA   #$7F
A929: 48             ASLA
A92A: 6E B6          JMP    [A,Y]		; [jump_table] sound bogus!!
A92C: 39             RTS
table_A92D:
A92D: A9 43
A92F: A9 4D
...
A943: AA D4          ORA    [,U]
A945: AA DE          ORA    [W,U]
A947: AA E8 AB       ORA    -$55,S
A94A: A6 AE          LDA    W,Y
A94C: B4 A9 BB       ANDA   $A9BB
A94F: 94 F3          ANDA   $F3
A951: AC 37          CMPX   -$9,Y
A953: AC E4          CMPX   ,S
A955: 96 33          LDA    $33
...
A99F: 98 34          EORA   $34
A9A1: AE 38          LDX    -$8,Y
A9A3: AA F2          ORA    Illegal Postbyte
A9A5: A9 BB          ADCA   [D,Y]
A9A7: 99 71          ADCA   $71
A9A9: 98 34          EORA   $34
A9AB: 9A 26          ORA    $26
A9AD: AA F2          ORA    Illegal Postbyte
A9AF: AC E4          CMPX   ,S
A9B1: A9 BB          ADCA   [D,Y]
A9B3: AE 42          LDX    $2,U
A9B5: AE 42          LDX    $2,U
...
AA96: 14             SEXW
AA97: 15             FCB    $15
AA98: 16 11 AA       LBRA   $BC45
AA9B: A2 AA          SBCA   F,Y
AA9D: AD AA          JSR    F,Y
AA9F: B8 AA C3       EORA   $AAC3
AAA2: 02 02 02       AIM    #$02;$02
AAA5: 02 02 02       AIM    #$02;$02
AAA8: 04 03          LSR    $03
AAAA: 04 04          LSR    $04
AAAC: 03 02          COM    $02
AAAE: 02 02 02       AIM    #$02;$02
AAB1: 02 02 03       AIM    #$02;$03
AAB4: 03 03          COM    $03
AAB6: 03 03          COM    $03
AAB8: 02 02 02       AIM    #$02;$02
AABB: 02 02 02       AIM    #$02;$02
AABE: 03 03          COM    $03
AAC0: 03 03          COM    $03
AAC2: 03 02          COM    $02
AAC4: 02 02 02       AIM    #$02;$02
AAC7: 02 02 03       AIM    #$02;$03
AACA: 03 03          COM    $03
AACC: 03 03          COM    $03
AACE: 86 00          LDA    #$00
...
AB9B: 00 FF          NEG    $FF
AB9D: 00 00          NEG    $00
AB9F: FF FF FF       STU    $FFFF
ABA2: FF FF 00       STU    $FF00
ABA5: FF BD FC       STU    $BDFC
ABA8: 82 BD          SBCA   #$BD
ABAA: 40             NEGA
ABAB: D5 BD          BITB   $BD
...
AC33: 00 00          NEG    $00
AC35: FF 00 34       STU    >$0034
AC38: 7E 10 8E       JMP    $108E
AC3B: AC DC A6       CMPX   [$ABE4,PCR]
AC3E: 88 1B          EORA   #$1B
AC40: 2B 3F          BMI    $AC81
...
AD7F: 17 02 18       LBSR   $AF9A
AD82: 02 19 08       AIM    #$19;$08
AD85: 19             DAA
AD86: 08 A6          ASL    $A6
AD88: 88 3A          EORA   #$3A
...
AE98: 30 31          LEAX   -$F,Y
AE9A: 32 33          LEAS   -$D,Y
AE9C: 02 02 02       AIM    #$02;$02
AE9F: 03 BD          COM    $BD
AEA1: FC 82 BD       LDD    $82BD
AEA4: 40             NEGA
AEA5: E4 BD FC 8F    ANDB   [$AB38,PCR]
AEA9: 39             RTS
AEAA: BD FC 82       JSR    $FC82
AEAD: BD 40 E7       JSR    $40E7
AEB0: BD FC 8F       JSR    $FC8F
AEB3: 39             RTS
AEB4: BD FC 82       JSR    $FC82
AEB7: BD 40 D2       JSR    $40D2
AEBA: BD FC 8F       JSR    $FC8F
AEBD: 39             RTS
AEBE: BD FC 82       JSR    $FC82
AEC1: BD 40 B4       JSR    $40B4
AEC4: BD FC 8F       JSR    $FC8F
AEC7: 96 36          LDA    $36
AEC9: 10 8E AE D1    LDY    #table_aed1
AECD: 48             ASLA
AECE: 6E B6          JMP    [A,Y]		; [jump_table]
AED0: 39             RTS
table_aed1:
	.word	$AED9 
	.word	$AF6C
...
AEE0: 84 0F          ANDA   #$0F
AEE2: 48             ASLA
AEE3: 10 8E AE EA    LDY    #table_AEEA
AEE7: 6E B6          JMP    [A,Y]		; [jump_table]
AEE9: 39             RTS
table_AEEA:
AEEA: AE F0          LDX    [,--W]
AEEC: AE FC AF       LDX    [$AE9E,PCR]
AEEF: 26 BD          BNE    $AEAE
AEF1: B0 D0 BD       SUBA   $D0BD
AEF4: B0 FE 24       SUBA   $FE24
AEF7: 03 BD          COM    $BD
AEF9: B0 F1 39       SUBA   $F139
...
AF21: 39             RTS
AF22: 11 12          FCB    $11,$12
AF24: 13             FCB    $13
AF25: 1A             FCB    $1A
AF26: BD B0 D0       DIVD   $B0D0
...
AF6F: 84 0F          ANDA   #$0F
AF71: 48             ASLA
AF72: 10 8E AF 79    LDY    #table_AF79
AF76: 6E B6          JMP    [A,Y]		; [jump_table]
AF78: 39             RTS
table_AF79:
AF79: AE F0          LDX    [,--W]
AF7B: AF 85          STX    B,X
...
AFCE: 96 37          LDA    $37
AFD0: 48             ASLA
AFD1: 10 8E AF E1    LDY    #table_AFE1
AFD5: 10 AE A6       LDY    A,Y
AFD8: B6 0E 2D       LDA    $0E2D
AFDB: 84 0F          ANDA   #$0F
AFDD: 48             ASLA
AFDE: 6E B6          JMP    [A,Y]		; [jump_table]
AFE0: 39             RTS
table_AFE1:
AFE1: AF E5          STX    B,S
AFE3: AF ED AE F0    STX    $5ED7,PCR
AFE7: AE F0          LDX    [,--W]
AFE9: AE FC AF       LDX    [$AF9B,PCR]
AFEC: 26 AF          BNE    $AF9D
AFEE: F1 B0 13       CMPB   $B013
AFF1: 86 03          LDA    #$03
AFF3: 97 4B          STA    $4B
...
B052: 81 03          CMPA   #$03
B054: 26 4B          BNE    $B0A1
B056: 10 8E B0 63    LDY    #$B063
B05A: B6 0E 2D       LDA    $0E2D
B05D: 84 0F          ANDA   #$0F
B05F: 48             ASLA
B060: 6E B6          JMP    [A,Y]		; [jump_table]
B062: 39             RTS
B063: AE F0          LDX    [,--W]
B065: B0 67 86       SUBA   $6786
B068: 0F BD          CLR    $BD
B06A: FE B0 BD       LDU    $B0BD
B06D: B0 D0 BD       SUBA   $D0BD
B070: B0 FE 24       SUBA   $FE24
B073: 2C 7F          BGE    $B0F4
B075: 03 EE          COM    $EE
...
B0AF: 84 0F          ANDA   #$0F
B0B1: 48             ASLA
B0B2: 6E B6          JMP    [A,Y]		; [jump_table]
B0B4: 39             RTS
B0B5: AE F0          LDX    [,--W]
B0B7: B0 BB B0       SUBA   $BBB0
B0BA: CF             FCB    $CF
...
B27D: 00 00          NEG    $00
B27F: 00 00          NEG    $00
B281: B2 99 B2       SBCA   $99B2
B284: A5 B2          BITA   Illegal Postbyte
B286: B1 B2 C9       CMPA   $B2C9
B289: B2 E1 B2       SBCA   $E1B2
B28C: E9 B2          ADCB   Illegal Postbyte
B28E: F1 B2 F9       CMPB   $B2F9
B291: B3 01 B3       SUBD   $01B3
B294: 09 B3          ROL    $B3
B296: 11 B3 21 00    CMPU   $2100
B29A: 01 01 0D       OIM    #$01;$0D
B29D: 00 00          NEG    $00
B29F: 04 C0          LSR    $C0
B2A1: 00 00          NEG    $00
B2A3: 05 40 00       EIM    #$40;$00
B2A6: 01 01 0D       OIM    #$01;$0D
B2A9: 00 00          NEG    $00
B2AB: 04 D0          LSR    $D0
B2AD: 00 00          NEG    $00
B2AF: 05 60 00       EIM    #$60;$00
B2B2: 01 01 0B       OIM    #$01;$0B
B2B5: 00 00          NEG    $00
B2B7: 08 41          ASL    $41
B2B9: 00 01          NEG    $01
B2BB: 00 EE          NEG    $EE
...
B2DD: 00 00          NEG    $00
B2DF: 08 B0          ASL    $B0
B2E1: 01 00 13       OIM    #$00;$13
B2E4: B7 01 01       STA    $0101
B2E7: 01 30 01       OIM    #$30;$01
B2EA: 00 13          NEG    $13
B2EC: D7 01          STB    $01
B2EE: 01 01 30       OIM    #$01;$30
B2F1: 00 00          NEG    $00
B2F3: 1A B8          ORCC   #$B8
B2F5: 00 01          NEG    $01
B2F7: 00 65          NEG    $65
...
B30F: 00 77          NEG    $77
B311: 00 00          NEG    $00
B313: 10 BA 00 01    ORD    >$0001
B317: 00 D9          NEG    $D9
B319: 00 00          NEG    $00
B31B: 11 22          FCB    $11,$22
B31D: 00             FCB    $00
B31E: 00             FCB    $00
B31F: 11             FCB    $11
B320: 46             RORA
B321: 00 00          NEG    $00
B323: 10 A6 00       LDW    $0,X
B326: 01 00 C7       OIM    #$00;$C7
B329: 00 00          NEG    $00
B32B: 11 22          FCB    $11,$22
B32D: 00             FCB    $00
B32E: 00             FCB    $00
B32F: 11             FCB    $11
B330: 3A             ABX
...
B3DD: 39             RTS
B3DE: 10 13          FCB    $10,$13
B3E0: 01             FCB    $01
B3E1: 20             FCB    $20
B3E2: 00             FCB    $00
B3E3: 60             FCB    $60
B3E4: 00             FCB    $00
B3E5: 80 00 1F       SUBW   #$001F
B3E8: 15             FCB    $15
B3E9: 60 15          NEG    -$B,X
B3EB: 80 BD          SUBA   #$BD
B3ED: FD A0 BD       STD    $A0BD
B3F0: 40             NEGA
B3F1: 87             FCB    $87
B3F2: BD FD B2       JSR    $FDB2
B3F5: 39             RTS
B3F6: BD FD A0       JSR    $FDA0
B3F9: BD 40 8D       JSR    $408D
...
B59D: 84 7F          ANDA   #$7F
B59F: 48             ASLA
B5A0: 10 8E B5 AA    LDY    #$B5AA
B5A4: AD B6          JSR    [A,Y]
B5A6: BD FF 10       JSR    $FF10
B5A9: 39             RTS
B5AA: B5 B6 00       BITA   $B600
B5AD: 00 B5          NEG    $B5
B5AF: CA B6          ORB    #$B6
B5B1: 07 00          ASR    $00
B5B3: 00 00          NEG    $00
...
B695: 00 B8          NEG    $B8
B697: 01 24 03       OIM    #$24;$03
B69A: 00 C8          NEG    $C8
B69C: 01 18 09       OIM    #$18;$09
B69F: 00 E0          NEG    $E0
B6A1: 01 30 02       OIM    #$30;$02
...
B76D: F6 38 02       LDB    $3802
B770: C4 08          ANDB   #$08
B772: 26 F9          BNE    $B76D
B774: 39             RTS
B775: F6 38 02       LDB    $3802
B778: C4 08          ANDB   #$08
B77A: 27 F9          BEQ    $B775
B77C: 39             RTS
B77D: 0D 53          TST    $53
...
B7CC: 8A 60          ORA    #$60
B7CE: 97 3A          STA    $3A
B7D0: B7 38 08       STA    $3808
B7D3: BD 6C 1B       JSR    $6C1B
B7D6: 96 3A          LDA    $3A
B7D8: 84 1F          ANDA   #$1F
B7DA: 97 3A          STA    $3A
B7DC: B7 38 08       STA    $3808
B7DF: 39             RTS
...
B890: 8A 10          ORA    #$10
B892: 97 3A          STA    $3A
B894: B7 38 08       STA    $3808
B897: B6 38 02       LDA    $3802
B89A: 84 10          ANDA   #$10
B89C: 26 F9          BNE    $B897
B89E: 96 3A          LDA    $3A
B8A0: 84 EF          ANDA   #$EF
B8A2: 97 3A          STA    $3A
B8A4: B7 38 08       STA    $3808
B8A7: B6 38 02       LDA    $3802
B8AA: 84 10          ANDA   #$10
B8AC: 27 F9          BEQ    $B8A7
B8AE: B7 38 0F       STA    $380F
...
B8DB: 84 1F          ANDA   #$1F
B8DD: 97 3A          STA    $3A
B8DF: B7 38 08       STA    $3808
B8E2: 7E 80 43       JMP    $8043
B8E5: 00 44          NEG    $44
B8E7: 99 AA          ADCA   $AA
B8E9: BB D7 0E       ADDA   $D70E
B8EC: 97 0F          STA    $0F
...
B927: 20 F4          BRA    $B91D
B929: 39             RTS
B92A: B9 36 B9       ADCA   $36B9
B92D: 41             FCB    $41
B92E: B9 49 B9       ADCA   $49B9
B931: 51             FCB    $51
B932: B9 59 B9       ADCA   $59B9
B935: 61 1A 10       OIM    #$1A;-$10,X
B938: 57             ASRB
B939: 4F             CLRA
B93A: 52             FCB    $52
B93B: 4B             FCB    $4B
...
B974: 52             FCB    $52
B975: 00 76          NEG    $76
B977: 77 90 52       ASR    $9052
B97A: 4F             CLRA
B97B: 4D             TSTA
B97C: 20 33          BRA    $B9B1
B97E: 00 1C          NEG    $1C
B980: 10 52          FCB    $10,$52
B982: 4F             CLRD
B983: 4D             TSTA
B984: 20 34          BRA    $B9BA
B986: 00 1C          NEG    $1C
...
B99B: 00 9C          NEG    $9C
B99D: 9D FF          JSR    $FF
B99F: FF FF FF       STU    $FFFF
B9A2: FF FF FF       STU    $FFFF
B9A5: FF FF FF       STU    $FFFF
B9A8: FF FF FF       STU    $FFFF
B9AB: FF FF FF       STU    $FFFF
B9AE: FF FF 96       STU    $FF96
B9B1: 51             FCB    $51
B9B2: 84 01          ANDA   #$01
B9B4: 26 12          BNE    $B9C8
...
BA10: A6 03          LDA    $3,X
BA12: A7 23          STA    $3,Y
BA14: 10 8E BA 1D    LDY    #$BA1D
BA18: 96 36          LDA    $36
BA1A: 48             ASLA
BA1B: 6E B6          JMP    [A,Y]		; [jump_table]
BA1D: BA 25 BA       ORA    $25BA
BA20: 31 BA          LEAY   [F,Y]
BA22: 46             RORA
BA23: BA 5B BD       ORA    $5BBD
BA26: F9 92 BD       ADCB   $92BD
BA29: BA A7 BD       ORA    $A7BD
BA2C: F9 6A 7E       ADCB   $6A7E
BA2F: BA 73 BD       ORA    $73BD
BA32: FD 3A BD       STD    $3ABD
BA35: BA A7 BD       ORA    $A7BD
BA38: FB C0 BD       ADDB   $C0BD
BA3B: F9 92 BD       ADCB   $92BD
BA3E: FB CA BD       ADDB   $CABD
BA41: F9 6A 7E       ADCB   $6A7E
BA44: BA 73 BD       ORA    $73BD
BA47: FD 44 BD       STD    $44BD
BA4A: F9 92 BD       ADCB   $92BD
BA4D: BA A7 BD       ORA    $A7BD
BA50: FB CA BD       ADDB   $CABD
BA53: F9 6A BD       ADCB   $6ABD
BA56: FB DE 7E       ADDB   $DE7E
BA59: BA 73 BD       ORA    $73BD
BA5C: F9 92 BD       ADCB   $92BD
BA5F: BB 64 BD       ADDA   $64BD
BA62: BA A7 BD       ORA    $A7BD
BA65: F9 6A BD       ADCB   $6ABD
BA68: F9 74 BD       ADCB   $74BD
BA6B: FB E8 BD       ADDB   $E8BD
BA6E: FB F2 BD       ADDB   $F2BD
BA71: FB D4 A6       ADDB   $D4A6
BA74: 84 2A          ANDA   #$2A
BA76: 0B BD F9       TIM    #$BD;$F9
BA79: 60 BD FE FB    NEG    [$B978,PCR]
BA7D: 25 03          BCS    $BA82
...
BA9C: 39             RTS
BA9D: BD BB 40       JSR    $BB40
BAA0: BD 40 75       JSR    $4075
BAA3: BD BB 4D       JSR    $BB4D
BAA6: 39             RTS
BAA7: A6 84          LDA    ,X
BAA9: 2A 31          BPL    $BADC
BAAB: 85 40          BITA   #$40
...
BAD0: 84 3F          ANDA   #$3F
BAD2: 48             ASLA
BAD3: 10 8E BA DD    LDY    #$BADD
BAD7: AD B6          JSR    [A,Y]
BAD9: BD F9 88       JSR    $F988
BADC: 39             RTS
BADD: F9 C4 FE       ADCB   $C4FE
BAE0: 40             NEGA
BAE1: FE 43 FE       LDU    $43FE
BAE4: 46             RORA
BAE5: FE 49 FE       LDU    $49FE
BAE8: 4C             INCA
BAE9: F9 CE FE       ADCB   $CEFE
BAEC: 5E             FCB    $5E
BAED: FE 5B FE       LDU    $5BFE
BAF0: 55             FCB    $55
BAF1: FE 4F FE       LDU    $4FFE
BAF4: 52             FCB    $52
BAF5: FE 55 FE       LDU    $55FE
BAF8: 58             ASLB
BAF9: FE 55 FE       LDU    $55FE
BAFC: 55             FCB    $55
BAFD: F9 D8 F9       ADCB   $D8F9
BB00: E2 BB          SBCB   [D,Y]
BB02: 22 FD          BHI    $BB01
BB04: 4E             FCB    $4E
BB05: FD 58 FD       STD    $58FD
BB08: 62 FE 61       AIM    #$FE;$1,S
BB0B: BB 2C FE       ADDA   $2CFE
BB0E: 67 BB          ASR    [D,Y]
BB10: 36 BB          PSHU   PC,Y,X,DP,A,CC
BB12: 6E BB          JMP    [D,Y]
BB14: 78 BD BB       ASL    $BDBB
BB17: 40             NEGA
BB18: BD 40 36       JSR    $4036
BB1B: 34 01          PSHS   CC
BB1D: BD BB 4D       JSR    $BB4D
BB20: 35 81          PULS   CC,PC
BB22: BD BB 40       JSR    $BB40
BB25: BD 40 2A       JSR    $402A
BB28: BD BB 4D       JSR    $BB4D
BB2B: 39             RTS
BB2C: BD BB 40       JSR    $BB40
BB2F: BD 40 2D       JSR    $402D
BB32: BD BB 4D       JSR    $BB4D
BB35: 39             RTS
BB36: BD BB 40       JSR    $BB40
BB39: BD 40 33       JSR    $4033
BB3C: BD BB 4D       JSR    $BB4D
BB3F: 39             RTS
BB40: 34 02          PSHS   A
BB42: 96 3A          LDA    $3A
BB44: 8A 20          ORA    #$20
BB46: 97 3A          STA    $3A
BB48: B7 38 08       STA    $3808
BB4B: 35 82          PULS   A,PC
BB4D: 34 03          PSHS   A,CC
BB4F: 96 3A          LDA    $3A
BB51: 84 1F          ANDA   #$1F
BB53: 97 3A          STA    $3A
BB55: B7 38 08       STA    $3808
...
BB67: BD 40 7E       JSR    $407E
BB6A: BD BB 4D       JSR    $BB4D
BB6D: 39             RTS
BB6E: BD BB 40       JSR    $BB40
BB71: BD 40 81       JSR    $4081
BB74: BD BB 4D       JSR    $BB4D
BB77: 39             RTS
BB78: BD BB 40       JSR    $BB40
BB7B: BD 40 84       JSR    $4084
BB7E: BD BB 4D       JSR    $BB4D
BB81: 39             RTS
BB82: 32 7F          LEAS   -$1,S
BB84: 6F E4          CLR    ,S
...
BBE9: 32 61          LEAS   $1,S
BBEB: 39             RTS
BBEC: BC 63 BC       CMPX   $63BC
BBEF: 14             SEXW
BBF0: BC 14 C2       CMPX   $14C2
BBF3: 33 BF 7D C7    LEAU   [$7DC7]
BBF7: BF C4 C6       STX    $C4C6
BBFA: C6 9C          LDB    #$9C
BBFC: BC 14 BC       CMPX   $14BC
BBFF: 14             SEXW
BC00: BC 14 BC       CMPX   $14BC
BC03: 14             SEXW
BC04: BC 14 BC       CMPX   $14BC
BC07: 14             SEXW
BC08: C9 FB          ADCB   #$FB
BC0A: BC 14 BC       CMPX   $14BC
BC0D: 58             ASLB
BC0E: BC 58 BC       CMPX   $58BC
BC11: 58             ASLB
BC12: BC 58 BD       CMPX   $58BD
BC15: FC 82 A6       LDD    $82A6
BC18: 88 17          EORA   #$17
BC1A: 84 1F          ANDA   #$1F
BC1C: 48             ASLA
BC1D: 10 8E BC 27    LDY    #$BC27
BC21: AD B6          JSR    [A,Y]
...
BC7D: 84 7F          ANDA   #$7F
BC7F: 48             ASLA
BC80: 10 8E BC 8D    LDY    #$BC8D
BC84: AD B6          JSR    [A,Y]
BC86: 6F 88 19       CLR    $19,X
BC89: 6F 88 18       CLR    $18,X
BC8C: 39             RTS
BC8D: BC B6 BC       CMPX   $B6BC
BC90: C1 BC          CMPB   #$BC
BC92: C7             FCB    $C7
BC93: BC B5 BC       CMPX   $B5BC
BC96: B5 BC CD       BITA   $BCCD
BC99: BC D1 BC       CMPX   $D1BC
BC9C: E1 BD 12 BD    CMPB   [$CF5D,PCR]
BCA0: 16 BD 27       LBRA   $79CA
BCA3: BD 2D BC       JSR    $2DBC
BCA6: B6 BD 33       LDA    $BD33
BCA9: BD 48 BD       JSR    $48BD
BCAC: 58             ASLB
BCAD: BC B5 BC       CMPX   $B5BC
BCB0: B5 BD 68       BITA   $BD68
BCB3: BD 6E 39       JSR    $6E39
BCB6: A6 84          LDA    ,X
BCB8: 84 F0          ANDA   #$F0
BCBA: 8A 01          ORA    #$01
BCBC: A7 84          STA    ,X
...
BD8E: A7 02          STA    $2,X
BD90: 39             RTS
BD91: BD BA BD       JSR    $BABD
BD94: BE BD E9       LDX    $BDE9
BD97: BD B9 BD       JSR    $B9BD
BD9A: B9 BE 14       ADCA   $BE14
BD9D: BE 19 BE       LDX    $19BE
BDA0: 5A             DECB
BDA1: BE 89 BE       LDX    $89BE
BDA4: B6 BE B6       LDA    $BEB6
BDA7: BE BB BE       LDX    $BBBE
BDAA: C0 BE          SUBB   #$BE
BDAC: EF BF 18 BF    STU    [$18BF]
BDB0: 41             FCB    $41
BDB1: BD B9 BD       JSR    $B9BD
BDB4: B9 BF 6C       ADCA   $BF6C
BDB7: BE 19 39       LDX    $1939
...
BDE0: 39             RTS
BDE1: 01 03 0B       OIM    #$03;$0B
BDE4: 0B 04 04       TIM    #$04;$04
BDE7: FF FF 10       STU    $FF10
BDEA: 8E BE 0C       LDX    #$BE0C
...
BE0B: 39             RTS
BE0C: 01 03 0B       OIM    #$03;$0B
BE0F: 0B 04 04       TIM    #$04;$04
BE12: FF FF 86       STU    $FF86
BE15: 05 A7 02       EIM    #$A7;$02
BE18: 39             RTS
BE19: A6 0E          LDA    $E,X
BE1B: 26 07          BNE    $BE24
BE1D: 86 05          LDA    #$05
...
BE55: 39             RTS
BE56: 05 06 08       EIM    #$06;$08
BE59: 86 10          LDA    #$10
BE5B: 8E BE 7D       LDX    #$BE7D
...
BE7C: 39             RTS
BE7D: 0B 0F 0C       TIM    #$0F;$0C
BE80: 0D 09          TST    $09
BE82: 09 03          ROL    $03
BE84: 03 03          COM    $03
BE86: 03 FF          COM    $FF
BE88: FF 10 8E       STU    $108E
BE8B: BE B1 E6       LDX    $B1E6
BE8E: 88 18          EORA   #$18
BE90: A6 A5          LDA    B,Y
BE92: A7 02          STA    $2,X
...
BF12: 0A 05          DEC    $05
BF14: 09 04          ROL    $04
BF16: FF FF 10       STU    $FF10
BF19: 8E BF 3B       LDX    #$BF3B
...
BF3A: 39             RTS
BF3B: 07 05          ASR    $05
BF3D: 05 04 FF       EIM    #$04;$FF
BF40: FF 10 8E       STU    $108E
BF43: BF 64 E6       STX    $64E6
BF46: 88 18          EORA   #$18
BF48: A6 A5          LDA    B,Y
BF4A: A7 02          STA    $2,X
...
BF66: 07 07          ASR    $07
BF68: 04 04          LSR    $04
BF6A: FF FF 86       STU    $FF86
BF6D: 05 A7 02       EIM    #$A7;$02
...
BF97: 84 7F          ANDA   #$7F
BF99: 48             ASLA
BF9A: 10 8E BF A7    LDY    #$BFA7
BF9E: AD B6          JSR    [A,Y]
BFA0: 6F 88 19       CLR    $19,X
BFA3: 6F 88 18       CLR    $18,X
BFA6: 39             RTS
BFA7: BF D0 BF       STX    $D0BF
BFAA: DB BF          ADDB   $BF
BFAC: E1 BF CF BF    CMPB   [$CFBF]
BFB0: CF             FCB    $CF
BFB1: BF E7 BF       STX    $E7BF
BFB4: EB BF F8 C0    ADDB   [$F8C0]
BFB8: 29 C0          BVS    $BF7A
BFBA: 2D C0          BLT    $BF7C
BFBC: 3E             FCB    $3E
BFBD: C0 44          SUBB   #$44
BFBF: BF D0 C0       STX    $D0C0
BFC2: 4A             DECA
BFC3: C0 5F          SUBB   #$5F
BFC5: C0 6F          SUBB   #$6F
BFC7: BF CF BF       STX    $CFBF
BFCA: CF             FCB    $CF
BFCB: C0 7F          SUBB   #$7F
BFCD: C0 85          SUBB   #$85
BFCF: 39             RTS
...
C0BD: C1 A3          CMPB   #$A3
C0BF: C1 A8          CMPB   #$A8
C0C1: BE C0 C1       LDX    $C0C1
C0C4: AD C1          JSR    ,U++
C0C6: D4 C1          ANDB   $C1
C0C8: FB C0 D1       ADDB   $C0D1
C0CB: C0 D1          SUBB   #$D1
C0CD: C2 22          SBCB   #$22
C0CF: C1 29          CMPB   #$29
C0D1: 39             RTS
...
C0F8: 39             RTS
C0F9: 01 01 FF       OIM    #$01;$FF
C0FC: FF 10 8E       STU    $108E
C0FF: C1 20          CMPB   #$20
...
C11F: 39             RTS
C120: 01 01 FF       OIM    #$01;$FF
C123: FF 86 00       STU    $8600
C126: A7 02          STA    $2,X
C128: 39             RTS
C129: A6 0E          LDA    $E,X
C12B: 27 0C          BEQ    $C139
...
C16F: 39             RTS
C170: 02 03 04       AIM    #$03;$04
C173: 04 04          LSR    $04
C175: 04 FF          LSR    $FF
C177: FF 10 8E       STU    $108E
C17A: C1 A0          CMPB   #$A0
...
C1A2: 84 86          ANDA   #$86
C1A4: 00 A7          NEG    $A7
C1A6: 02 39 86       AIM    #$39;$86
C1A9: 00 A7          NEG    $A7
C1AB: 02 39 10       AIM    #$39;$10
C1AE: 8E C1 D0       LDX    #$C1D0
...
C1CF: 39             RTS
C1D0: 03 03          COM    $03
C1D2: FF FF 10       STU    $FF10
C1D5: 8E C1 F7       LDX    #$C1F7
...
C1F6: 39             RTS
C1F7: 02 02 FF       AIM    #$02;$FF
C1FA: FF 10 8E       STU    $108E
C1FD: C2 1E          SBCB   #$1E
...
C21D: 39             RTS
C21E: 00 00          NEG    $00
C220: FF FF 86       STU    $FF86
C223: 00 A7          NEG    $A7
C225: 02 6C 88       AIM    #$6C;$88
C228: 19             DAA
...
C275: C2 86          SBCB   #$86
C277: C2 F8          SBCB   #$F8
C279: C3 0D C3       ADDD   #$0DC3
C27C: 1D             SEX
C27D: 00 00          NEG    $00
C27F: 00 00          NEG    $00
C281: 00 00          NEG    $00
C283: C3 2D 39       ADDD   #$2D39
C286: A6 84          LDA    ,X
C288: 84 F0          ANDA   #$F0
C28A: 8A 01          ORA    #$01
C28C: A7 84          STA    ,X
...
C357: C3 79 C3       ADDD   #$79C3
C35A: 79 C3 CC       ROL    $C3CC
C35D: C3 D1 C4       ADDD   #$D1C4
C360: 0C C4          INC    $C4
C362: 33 C4          LEAU   ,U
C364: 39             RTS
C365: C4 39          ANDB   #$39
C367: C4 3E          ANDB   #$3E
C369: BE C0 C4       LDX    $C0C4
C36C: 4F             CLRA
C36D: C4 78          ANDB   #$78
C36F: C4 9F          ANDB   #$9F
C371: 00 00          NEG    $00
...
C3A0: 39             RTS
C3A1: 04 04          LSR    $04
C3A3: FF FF 10       STU    $FF10
C3A6: 8E C3 C8       LDX    #$C3C8
...
C3C7: 39             RTS
C3C8: 04 04          LSR    $04
C3CA: FF FF 86       STU    $FF86
C3CD: 04 A7          LSR    $A7
C3CF: 02 39 A6       AIM    #$39;$A6
C3D2: 0E 27          JMP    $27
C3D4: 0C 96          INC    $96
C3D6: 51             FCB    $51
C3D7: 84 04          ANDA   #$04
...
C471: 39             RTS
C472: 04 01          LSR    $01
C474: 01 04 FF       OIM    #$04;$FF
C477: FF 10 8E       STU    $108E
C47A: C4 9B          ANDB   #$9B
...
C49A: 39             RTS
C49B: 01 01 FF       OIM    #$01;$FF
C49E: FF 10 8E       STU    $108E
C4A1: C4 C2          ANDB   #$C2
...
C4C1: 39             RTS
C4C2: 01 01 FF       OIM    #$01;$FF
C4C5: FF 34 7E       STU    $347E
...
C5D6: 04 04          LSR    $04
C5D8: 04 04          LSR    $04
C5DA: FF FF 10       STU    $FF10
C5DD: 8E C6 02       LDX    #$C602
...
C604: 95 94          BITA   $94
C606: 14             SEXW
C607: 11 12          FCB    $11,$12
C609: 93 86          CMPU   $86
C60B: 11 E6 88 18    LDF    $18,X
C60F: C4 01          ANDB   #$01
C611: 27 02          BEQ    $C615
C613: 86 7F          LDA    #$7F
C615: A7 02          STA    $2,X
...
C662: 04 04          LSR    $04
C664: 04 04          LSR    $04
C666: FF FF 86       STU    $FF86
C669: 05 A7 88       EIM    #$A7;$88
C66C: 1B             FCB    $1B
C66D: 39             RTS
C66E: 86 91          LDA    #$91
C670: A7 02          STA    $2,X
...
C792: 0D 0E          TST    $0E
C794: 0F 0F          CLR    $0F
C796: 02 02 FF       AIM    #$02;$FF
C799: FF 86 8A       STU    $868A
C79C: A7 02          STA    $2,X
C79E: 39             RTS
...
C90F: 39             RTS
C910: 11 92          FCB    $11,$92
C912: 13             FCB    $13
C913: 12             FCB    $12
C914: 91 15          CMPE   $15
C916: 14             SEXW
C917: 95 95          BITA   $95
C919: 02 02 02       AIM    #$02;$02
C91C: 02 02 02       AIM    #$02;$02
C91F: 02 FF FF       AIM    #$FF;$FF
...
C9CC: 39             RTS
C9CD: 11 92          FCB    $11,$92
C9CF: 13             FCB    $13
C9D0: 12             FCB    $12
C9D1: 91 15          CMPE   $15
C9D3: 14             SEXW
C9D4: 95 95          BITA   $95
C9D6: 02 02 02       AIM    #$02;$02
C9D9: 02 02 02       AIM    #$02;$02
C9DC: 02 FF FF       AIM    #$FF;$FF
C9DF: 86 05          LDA    #$05
...
CAF9: 39             RTS
CAFA: 16 16 16       LBRA   $E113
CAFD: 04 FF          LSR    $FF
CAFF: FF 86 16       STU    $8616
CB02: A7 02          STA    $2,X
CB04: 39             RTS
...
CBB3: 00 00          NEG    $00
CBB5: E0 E0          SUBB   ,S+
CBB7: E8 E8 E8       EORB   -$18,S
CBBA: 00 00          NEG    $00
CBBC: 00 00          NEG    $00
CBBE: 00 00          NEG    $00
CBC0: E8 34          EORB   -$C,Y
CBC2: 7E A6 88       JMP    $A688
CBC5: 1B             FCB    $1B
CBC6: 84 7F          ANDA   #$7F
CBC8: 81 00          CMPA   #$00
CBCA: 27 16          BEQ    $CBE2
...
CDAD: 32 6F          LEAS   $F,S
CDAF: 39             RTS
CDB0: 02 00 06       AIM    #$00;$06
CDB3: 00 00          NEG    $00
CDB5: 80 03          SUBA   #$03
CDB7: 80 02          SUBA   #$02
CDB9: 40             NEGA
CDBA: 01 00 04       OIM    #$00;$04
CDBD: 00 06          NEG    $06
CDBF: 00 00          NEG    $00
CDC1: 80 02          SUBA   #$02
CDC3: 00 06          NEG    $06
...
CFD0: 00 00          NEG    $00
CFD2: 00 00          NEG    $00
CFD4: 7F 00 00       CLR    >$0000
CFD7: 7F 00 F0       CLR    >$00F0
CFDA: 7F 00 F0       CLR    >$00F0
CFDD: 05 08 29       EIM    #$08;$29
CFE0: 02 08 38       AIM    #$08;$38
CFE3: 05 08 29       EIM    #$08;$29
CFE6: 05 08 29       EIM    #$08;$29
CFE9: 7F 00 00       CLR    >$0000
CFEC: 7F 00 F0       CLR    >$00F0
CFEF: 7F 00 F0       CLR    >$00F0
CFF2: 06 08          ROR    $08
CFF4: 2E 03          BGT    $CFF9
CFF6: 08 38          ASL    $38
CFF8: 06 08          ROR    $08
CFFA: 2E 05          BGT    $D001
CFFC: 08 2E          ASL    $2E
CFFE: 7F 00 00       CLR    >$0000
D001: 7F 00 F0       CLR    >$00F0
D004: 7F 00 F0       CLR    >$00F0
D007: 06 08          ROR    $08
D009: 2E 03          BGT    $D00E
D00B: 08 38          ASL    $38
D00D: 06 08          ROR    $08
D00F: 2E 05          BGT    $D016
D011: 08 2E          ASL    $2E
D013: 7F 00 00       CLR    >$0000
D016: 7F 00 F0       CLR    >$00F0
D019: 7F 00 F0       CLR    >$00F0
D01C: 05 08 29       EIM    #$08;$29
D01F: 02 08 38       AIM    #$08;$38
D022: 05 08 29       EIM    #$08;$29
D025: 05 08 29       EIM    #$08;$29
D028: 7F 00 00       CLR    >$0000
D02B: 7F 00 F0       CLR    >$00F0
D02E: 7F 00 F0       CLR    >$00F0
D031: 00 08          NEG    $08
D033: 28 01          BVC    $D036
D035: F8 36 00       EORB   $3600
D038: 08 28          ASL    $28
D03A: 00 08          NEG    $08
D03C: 28 7F          BVC    $D0BD
D03E: 00 00          NEG    $00
D040: 7F 00 F0       CLR    >$00F0
D043: 7F 00 F0       CLR    >$00F0
D046: 00 08          NEG    $08
D048: 28 01          BVC    $D04B
D04A: F8 36 00       EORB   $3600
D04D: 08 28          ASL    $28
D04F: 00 08          NEG    $08
D051: 28 7F          BVC    $D0D2
D053: 00 00          NEG    $00
D055: 7F 00 F0       CLR    >$00F0
D058: 7F 00 F0       CLR    >$00F0
D05B: 01 08 28       OIM    #$08;$28
D05E: 01 FE 36       OIM    #$FE;$36
D061: 01 08 28       OIM    #$08;$28
D064: 01 08 28       OIM    #$08;$28
D067: 7F 00 00       CLR    >$0000
D06A: 7F 00 F0       CLR    >$00F0
D06D: 7F 00 F0       CLR    >$00F0
D070: 01 08 28       OIM    #$08;$28
D073: 01 FE 36       OIM    #$FE;$36
D076: 01 08 28       OIM    #$08;$28
D079: 01 08 28       OIM    #$08;$28
D07C: 7F 00 00       CLR    >$0000
D07F: 7F 00 F0       CLR    >$00F0
D082: 7F 00 F0       CLR    >$00F0
D085: 05 09 31       EIM    #$09;$31
D088: 01 FD 36       OIM    #$FD;$36
D08B: 05 09 31       EIM    #$09;$31
D08E: 05 09 31       EIM    #$09;$31
D091: 7F 00 00       CLR    >$0000
D094: 7F 00 F0       CLR    >$00F0
D097: 7F 00 F0       CLR    >$00F0
D09A: 05 09 2C       EIM    #$09;$2C
D09D: 01 00 38       OIM    #$00;$38
D0A0: 05 09 2C       EIM    #$09;$2C
D0A3: 05 09 2C       EIM    #$09;$2C
D0A6: 7F 00 00       CLR    >$0000
D0A9: 7F 00 F0       CLR    >$00F0
D0AC: 7F 00 F0       CLR    >$00F0
D0AF: 7F 00 00       CLR    >$0000
D0B2: 7F 00 00       CLR    >$0000
D0B5: 7F 00 00       CLR    >$0000
D0B8: 7F 00 00       CLR    >$0000
D0BB: 7F 00 00       CLR    >$0000
D0BE: 7F 00 F0       CLR    >$00F0
D0C1: 7F 00 F0       CLR    >$00F0
D0C4: 7F 00 00       CLR    >$0000
D0C7: 7F 00 00       CLR    >$0000
D0CA: 7F 00 00       CLR    >$0000
D0CD: 7F 00 00       CLR    >$0000
D0D0: 7F 00 00       CLR    >$0000
D0D3: 7F 00 F0       CLR    >$00F0
D0D6: 7F 00 F0       CLR    >$00F0
D0D9: 7F 00 00       CLR    >$0000
D0DC: 7F 00 00       CLR    >$0000
D0DF: 7F 00 00       CLR    >$0000
D0E2: 7F 00 00       CLR    >$0000
D0E5: 7F 00 00       CLR    >$0000
D0E8: 7F 00 F0       CLR    >$00F0
D0EB: 7F 00 F0       CLR    >$00F0
D0EE: 7F 00 00       CLR    >$0000
D0F1: 7F 00 00       CLR    >$0000
D0F4: 7F 00 00       CLR    >$0000
D0F7: 7F 00 00       CLR    >$0000
D0FA: 7F 00 00       CLR    >$0000
D0FD: 7F 00 F0       CLR    >$00F0
D100: 7F 00 F0       CLR    >$00F0
D103: 7F 00 00       CLR    >$0000
D106: 7F 00 00       CLR    >$0000
D109: 7F 00 00       CLR    >$0000
D10C: 7F 00 00       CLR    >$0000
D10F: 7F 00 00       CLR    >$0000
D112: 7F 00 F0       CLR    >$00F0
D115: 7F 00 F0       CLR    >$00F0
D118: 86 10          LDA    #$10
D11A: 15             FCB    $15
D11B: 0C 0E          INC    $0E
D11D: 1A 86          ORCC   #$86
D11F: 10 15          FCB    $10,$15
D121: 85 10 15       BITD   #$1015
D124: 7F 00 00       CLR    >$0000
D127: 7F 00 F0       CLR    >$00F0
D12A: 7F 00 F0       CLR    >$00F0
D12D: 02 08 08       AIM    #$08;$08
D130: 86 13          LDA    #$13
D132: 00 02          NEG    $02
D134: 08 08          ASL    $08
D136: 02 08 08       AIM    #$08;$08
D139: 7F 00 00       CLR    >$0000
D13C: 7F 00 F0       CLR    >$00F0
D13F: 7F 00 F0       CLR    >$00F0
D142: 7F 00 00       CLR    >$0000
D145: 7F 00 00       CLR    >$0000
D148: 7F 00 00       CLR    >$0000
D14B: 7F 00 00       CLR    >$0000
D14E: 7F 00 00       CLR    >$0000
D151: 7F 00 F0       CLR    >$00F0
D154: 7F 00 F0       CLR    >$00F0
D157: 7F 00 00       CLR    >$0000
D15A: 7F 00 00       CLR    >$0000
D15D: 7F 00 00       CLR    >$0000
D160: 7F 00 00       CLR    >$0000
D163: 7F 00 00       CLR    >$0000
D166: 7F 00 F0       CLR    >$00F0
D169: 7F 00 F0       CLR    >$00F0
D16C: 7F 00 00       CLR    >$0000
D16F: 7F 00 00       CLR    >$0000
D172: 7F 00 00       CLR    >$0000
D175: 7F 00 00       CLR    >$0000
D178: 7F 00 00       CLR    >$0000
D17B: 7F 00 F0       CLR    >$00F0
D17E: 7F 00 F0       CLR    >$00F0
D181: 7F 00 00       CLR    >$0000
D184: 7F 00 00       CLR    >$0000
D187: 7F 00 00       CLR    >$0000
D18A: 7F 00 00       CLR    >$0000
D18D: 7F 00 00       CLR    >$0000
D190: 7F 00 F0       CLR    >$00F0
D193: 7F 00 F0       CLR    >$00F0
D196: 7F 00 00       CLR    >$0000
D199: 7F 00 00       CLR    >$0000
D19C: 7F 00 00       CLR    >$0000
D19F: 7F 00 00       CLR    >$0000
D1A2: 7F 00 00       CLR    >$0000
D1A5: 7F 00 F0       CLR    >$00F0
D1A8: 7F 00 F0       CLR    >$00F0
D1AB: 7F 00 00       CLR    >$0000
D1AE: 7F 00 00       CLR    >$0000
D1B1: 7F 00 00       CLR    >$0000
D1B4: 7F 00 00       CLR    >$0000
D1B7: 7F 00 00       CLR    >$0000
D1BA: 7F 00 F0       CLR    >$00F0
D1BD: 7F 00 F0       CLR    >$00F0
D1C0: 7F 00 00       CLR    >$0000
D1C3: 04 FE          LSR    $FE
D1C5: 38             FCB    $38
D1C6: 7F 00 00       CLR    >$0000
D1C9: 7F 00 00       CLR    >$0000
D1CC: 7F 00 00       CLR    >$0000
D1CF: 7F 00 F0       CLR    >$00F0
D1D2: 7F 00 F0       CLR    >$00F0
D1D5: 07 18          ASR    $18
D1D7: 28 05          BVC    $D1DE
D1D9: 1E 28          EXG    Y,A
D1DB: 07 18          ASR    $18
D1DD: 28 07          BVC    $D1E6
D1DF: 1A 28          ORCC   #$28
D1E1: 7F 00 00       CLR    >$0000
D1E4: 7F 00 F0       CLR    >$00F0
D1E7: 7F 00 F0       CLR    >$00F0
D1EA: 08 F0          ASL    $F0
D1EC: 18             FCB    $18
D1ED: 06 F0          ROR    $F0
D1EF: 18             FCB    $18
...
D1F3: 08 F0          ASL    $F0
D1F5: 18             FCB    $18
D1F6: 7F 00 00       CLR    >$0000
D1F9: 7F 00 F0       CLR    >$00F0
D1FC: 7F 00 F0       CLR    >$00F0
D1FF: 89 F4          ADCA   #$F4
D201: 30 8C EE       LEAX   $D1F2,PCR
D204: 24 89          BCC    $D18F
D206: F4 30 89       ANDB   $3089
D209: F4 30 7F       ANDB   $307F
D20C: 00 00          NEG    $00
D20E: 7F 00 F0       CLR    >$00F0
D211: 7F 00 F0       CLR    >$00F0
D214: 09 1A          ROL    $1A
D216: 22 01          BHI    $D219
D218: FC 3C 09       LDD    $3C09
D21B: 1A 22          ORCC   #$22
D21D: 09 1A          ROL    $1A
D21F: 22 7F          BHI    $D2A0
D221: 00 00          NEG    $00
D223: 7F 00 F0       CLR    >$00F0
D226: 7F 00 F0       CLR    >$00F0
D229: 7F 00 00       CLR    >$0000
D22C: 7F 00 00       CLR    >$0000
D22F: 7F 00 00       CLR    >$0000
D232: 7F 00 00       CLR    >$0000
D235: 7F 00 00       CLR    >$0000
D238: 7F 00 F0       CLR    >$00F0
D23B: 7F 00 F0       CLR    >$00F0
D23E: 7F 00 00       CLR    >$0000
D241: 7F 00 00       CLR    >$0000
D244: 7F 00 00       CLR    >$0000
D247: 7F 00 00       CLR    >$0000
D24A: 7F 00 00       CLR    >$0000
D24D: 7F 00 F0       CLR    >$00F0
D250: 7F 00 F0       CLR    >$00F0
D253: 89 F8          ADCA   #$F8
D255: 32 8C EF       LEAS   $D247,PCR
D258: 27 89          BEQ    $D1E3
D25A: F8 32 89       EORB   $3289
D25D: F8 32 7F       EORB   $327F
D260: 00 00          NEG    $00
D262: 7F 00 F0       CLR    >$00F0
D265: 7F 00 F0       CLR    >$00F0
D268: 7F 00 00       CLR    >$0000
D26B: 01 F4 40       OIM    #$F4;$40
D26E: 7F 00 00       CLR    >$0000
D271: 7F 00 00       CLR    >$0000
D274: 7F 00 00       CLR    >$0000
D277: 7F 00 F0       CLR    >$00F0
D27A: 7F 00 F0       CLR    >$00F0
D27D: 0E 10          JMP    $10
D27F: 38             FCB    $38
D280: 8C 0A 3A       CMPX   #$0A3A
D283: 0E 10          JMP    $10
D285: 38             FCB    $38
D286: 0E 10          JMP    $10
D288: 38             FCB    $38
D289: 7F 00 00       CLR    >$0000
D28C: 7F 00 F0       CLR    >$00F0
D28F: 7F 00 F0       CLR    >$00F0
D292: 0D 08          TST    $08
D294: 27 0C          BEQ    $D2A2
D296: 08 28          ASL    $28
D298: 0D 08          TST    $08
D29A: 27 0D          BEQ    $D2A9
D29C: 08 27          ASL    $27
D29E: 7F 00 00       CLR    >$0000
D2A1: 7F 00 F0       CLR    >$00F0
D2A4: 7F 00 F0       CLR    >$00F0
D2A7: 7F 00 00       CLR    >$0000
D2AA: 0B FC 3C       TIM    #$FC;$3C
D2AD: 7F 00 00       CLR    >$0000
D2B0: 7F 00 00       CLR    >$0000
D2B3: 7F 00 00       CLR    >$0000
D2B6: 7F 00 F0       CLR    >$00F0
D2B9: 7F 00 F0       CLR    >$00F0
D2BC: 09 FE          ROL    $FE
D2BE: 3E             FCB    $3E
D2BF: 11 FC          FCB    $11,$FC
D2C1: 36 09 FE       LDBT   CC,1,1,$FE
D2C4: 3E             FCB    $3E
D2C5: 09 FE          ROL    $FE
D2C7: 3E             FCB    $3E
D2C8: 7F 00 00       CLR    >$0000
D2CB: 7F 00 F0       CLR    >$00F0
D2CE: 7F 00 F0       CLR    >$00F0
D2D1: 7F 00 00       CLR    >$0000
D2D4: 12             NOP
D2D5: F6 31 7F       LDB    $317F
D2D8: 00 00          NEG    $00
D2DA: 7F 00 00       CLR    >$0000
D2DD: 7F 00 00       CLR    >$0000
D2E0: 7F 00 F0       CLR    >$00F0
D2E3: 7F 00 F0       CLR    >$00F0
D2E6: 7F 00 00       CLR    >$0000
D2E9: 13             SYNC
D2EA: FC 38 7F       LDD    $387F
D2ED: 00 00          NEG    $00
D2EF: 7F 00 00       CLR    >$0000
D2F2: 7F 00 00       CLR    >$0000
D2F5: 7F 00 F0       CLR    >$00F0
D2F8: 7F 00 F0       CLR    >$00F0
D2FB: 7F 00 00       CLR    >$0000
D2FE: 0C 10          INC    $10
D300: 22 7F          BHI    $D381
D302: 00 00          NEG    $00
D304: 7F 00 00       CLR    >$0000
D307: 7F 00 00       CLR    >$0000
D30A: 7F 00 F0       CLR    >$00F0
D30D: 7F 00 F0       CLR    >$00F0
D310: 09 FE          ROL    $FE
D312: 32 8C 14       LEAS   $D329,PCR
D315: 38             FCB    $38
D316: 09 FE          ROL    $FE
D318: 32 09          LEAS   $9,X
D31A: FE 32 7F       LDU    $327F
D31D: 00 00          NEG    $00
D31F: 7F 00 F0       CLR    >$00F0
D322: 7F 00 F0       CLR    >$00F0
D325: 09 F4          ROL    $F4
D327: 30 14          LEAX   -$C,X
D329: 0C 35          INC    $35
D32B: 09 F4          ROL    $F4
D32D: 30 09          LEAX   $9,X
D32F: F4 30 7F       ANDB   $307F
D332: 00 00          NEG    $00
D334: 7F 00 F0       CLR    >$00F0
D337: 7F 00 F0       CLR    >$00F0
D33A: 09 FC          ROL    $FC
D33C: 32 14          LEAS   -$C,X
D33E: 0A 37          DEC    $37
D340: 09 FC          ROL    $FC
D342: 32 09          LEAS   $9,X
D344: FC 32 7F       LDD    $327F
D347: 00 00          NEG    $00
D349: 7F 00 F0       CLR    >$00F0
D34C: 7F 00 F0       CLR    >$00F0
D34F: 0D F9          TST    $F9
D351: 1A 0C          ORCC   #$0C
D353: FA 1B 0D       ORB    $1B0D
D356: F9 1A 0D       ADCB   $1A0D
D359: F9 1A 7F       ADCB   $1A7F
D35C: 00 00          NEG    $00
D35E: 7F 00 F0       CLR    >$00F0
D361: 7F 00 F0       CLR    >$00F0
D364: 0D 0D          TST    $0D
D366: 21 0C          BRN    $D374
D368: 0E 22          JMP    $22
D36A: 0D 0D          TST    $0D
D36C: 21 0D          BRN    $D37B
D36E: 0D 21          TST    $21
D370: 7F 00 00       CLR    >$0000
D373: 7F 00 F0       CLR    >$00F0
D376: 7F 00 F0       CLR    >$00F0
D379: 8F             FCB    $8F
D37A: 08 1E          ASL    $1E
D37C: 0C 0A          INC    $0A
D37E: 21 8F          BRN    $D30F
...
D382: 8F             FCB    $8F
D383: 08 1E          ASL    $1E
D385: 7F 00 00       CLR    >$0000
D388: 7F 00 F0       CLR    >$00F0
D38B: 7F 00 F0       CLR    >$00F0
D38E: 7F 00 00       CLR    >$0000
D391: 7F 0E 26       CLR    $0E26
D394: 7F 00 00       CLR    >$0000
D397: 7F 00 00       CLR    >$0000
D39A: 7F 00 00       CLR    >$0000
D39D: 7F 00 F0       CLR    >$00F0
D3A0: 7F 00 F0       CLR    >$00F0
D3A3: 90 F6          SUBA   $F6
D3A5: 38             FCB    $38
D3A6: 01 EF 44       OIM    #$EF;$44
D3A9: 90 F6          SUBA   $F6
D3AB: 38             FCB    $38
D3AC: 8F             FCB    $8F
D3AD: F6 38 7F       LDB    $387F
D3B0: 00 00          NEG    $00
D3B2: 7F 00 F0       CLR    >$00F0
D3B5: 7F 00 F0       CLR    >$00F0
D3B8: 00 05          NEG    $05
D3BA: 30 01          LEAX   $1,X
D3BC: 02 3F 00       AIM    #$3F;$00
D3BF: 05 30 00       EIM    #$30;$00
D3C2: 05 30 7F       EIM    #$30;$7F
D3C5: 00 00          NEG    $00
D3C7: 7F 00 F0       CLR    >$00F0
D3CA: 7F 00 F0       CLR    >$00F0
D3CD: 87             FCB    $87
D3CE: E4 33          ANDB   -$D,Y
D3D0: 10 00          FCB    $10,$00
D3D2: 00             FCB    $00
D3D3: 87             FCB    $87
D3D4: E4             FCB    $E4
D3D5: 33 91          SBCR   B,X
D3D7: E8 14          EORB   -$C,X
D3D9: 7F 00 00       CLR    >$0000
D3DC: 7F 00 F0       CLR    >$00F0
D3DF: 7F 00 F0       CLR    >$00F0
D3E2: 87             FCB    $87
D3E3: F6 40 10       LDB    $4010
D3E6: 00 00          NEG    $00
D3E8: 87             FCB    $87
D3E9: F6 40 92       LDB    $4092
D3EC: EE 30          LDU    -$10,Y
D3EE: 7F 00 00       CLR    >$0000
D3F1: 7F 00 F0       CLR    >$00F0
D3F4: 7F 00 F0       CLR    >$00F0
D3F7: 7F 00 00       CLR    >$0000
D3FA: 7F 00 00       CLR    >$0000
D3FD: 7F 00 00       CLR    >$0000
D400: 93 1E          SUBD   $1E
D402: FE 7F 00       LDU    $7F00
D405: 00 7F          NEG    $7F
D407: 00 F0          NEG    $F0
D409: 7F 00 F0       CLR    >$00F0
D40C: 7F 00 00       CLR    >$0000
D40F: 7F 00 00       CLR    >$0000
D412: 7F 00 00       CLR    >$0000
D415: 94 F8          ANDA   $F8
D417: 04 7F          LSR    $7F
D419: 00 00          NEG    $00
D41B: 7F 00 F0       CLR    >$00F0
D41E: 7F 00 F0       CLR    >$00F0
D421: 7F 00 00       CLR    >$0000
D424: 7F 00 00       CLR    >$0000
D427: 7F 00 00       CLR    >$0000
D42A: 7F 00 00       CLR    >$0000
D42D: 7F 00 00       CLR    >$0000
D430: 7F 00 F0       CLR    >$00F0
D433: 7F 00 F0       CLR    >$00F0
D436: 7F 00 00       CLR    >$0000
D439: 7F 00 00       CLR    >$0000
D43C: 7F 00 00       CLR    >$0000
D43F: 7F 00 00       CLR    >$0000
D442: 7F 00 00       CLR    >$0000
D445: 7F 00 F0       CLR    >$00F0
D448: 7F 00 F0       CLR    >$00F0
D44B: 01 10 30       OIM    #$10;$30
D44E: 01 0A 3D       OIM    #$0A;$3D
D451: 01 10 30       OIM    #$10;$30
D454: 01 10 30       OIM    #$10;$30
D457: 7F 00 00       CLR    >$0000
D45A: 7F 00 F0       CLR    >$00F0
D45D: 7F 00 F0       CLR    >$00F0
D460: 0B 05 2E       TIM    #$05;$2E
D463: 08 08          ASL    $08
D465: 28 0B          BVC    $D472
D467: 05 2E 0B       EIM    #$2E;$0B
D46A: 05 2E 7F       EIM    #$2E;$7F
D46D: 00 00          NEG    $00
D46F: 7F 00 F0       CLR    >$00F0
D472: 7F 00 F0       CLR    >$00F0
D475: 00 05          NEG    $05
D477: 28 01          BVC    $D47A
D479: 02 34 00       AIM    #$34;$00
D47C: 05 28 00       EIM    #$28;$00
D47F: 04 26          LSR    $26
D481: 7F 00 00       CLR    >$0000
D484: 7F 00 F0       CLR    >$00F0
D487: 7F 00 F0       CLR    >$00F0
D48A: 0B 10 2C       TIM    #$10;$2C
D48D: 05 16 32       EIM    #$16;$32
D490: 0B 10 2C       TIM    #$10;$2C
D493: 86 15          LDA    #$15
D495: 28 7F          BVC    $D516
D497: 00 00          NEG    $00
D499: 7F 00 F0       CLR    >$00F0
D49C: 7F 00 F0       CLR    >$00F0
D49F: 8B EA          ADDA   #$EA
D4A1: 27 85          BEQ    $D428
D4A3: E4 2A          ANDB   $A,Y
D4A5: 8B EA          ADDA   #$EA
D4A7: 27 06          BEQ    $D4AF
D4A9: EA 27          ORB    $7,Y
D4AB: 7F 00 00       CLR    >$0000
D4AE: 7F 00 F0       CLR    >$00F0
D4B1: 7F 00 F0       CLR    >$00F0
D4B4: 00 EE          NEG    $EE
D4B6: 30 01          LEAX   $1,X
D4B8: EC 3E          LDD    -$2,Y
D4BA: 00 EE          NEG    $EE
D4BC: 30 00          LEAX   $0,X
D4BE: EC 34          LDD    -$C,Y
D4C0: 7F 00 00       CLR    >$0000
D4C3: 7F 00 F0       CLR    >$00F0
D4C6: 7F 00 F0       CLR    >$00F0
D4C9: 7F 00 00       CLR    >$0000
D4CC: 01 E6 3C       OIM    #$E6;$3C
D4CF: 7F 00 00       CLR    >$0000
D4D2: 7F 00 00       CLR    >$0000
D4D5: 7F 00 00       CLR    >$0000
D4D8: 7F 00 F0       CLR    >$00F0
D4DB: 7F 00 F0       CLR    >$00F0
D4DE: 7F 00 00       CLR    >$0000
D4E1: 7F 00 00       CLR    >$0000
D4E4: 7F 00 00       CLR    >$0000
D4E7: 7F 00 00       CLR    >$0000
D4EA: 7F 00 00       CLR    >$0000
D4ED: 7F 00 F0       CLR    >$00F0
D4F0: 7F 00 F0       CLR    >$00F0
D4F3: 7F 00 00       CLR    >$0000
D4F6: 7F 00 00       CLR    >$0000
D4F9: 7F 00 00       CLR    >$0000
D4FC: 7F 00 00       CLR    >$0000
D4FF: 7F 00 00       CLR    >$0000
D502: 7F 00 F0       CLR    >$00F0
D505: 7F 00 F0       CLR    >$00F0
D508: 7F 00 00       CLR    >$0000
D50B: 7F 00 00       CLR    >$0000
D50E: 7F 00 00       CLR    >$0000
D511: 7F 00 00       CLR    >$0000
D514: 7F 00 00       CLR    >$0000
D517: 7F 00 F0       CLR    >$00F0
D51A: 7F 00 F0       CLR    >$00F0
D51D: 7F 00 00       CLR    >$0000
D520: 7F 00 00       CLR    >$0000
D523: 7F 00 00       CLR    >$0000
D526: 7F 00 00       CLR    >$0000
D529: 7F 00 00       CLR    >$0000
D52C: 7F 00 F0       CLR    >$00F0
D52F: 7F 00 F0       CLR    >$00F0
D532: 7F 00 00       CLR    >$0000
D535: 7F 00 00       CLR    >$0000
D538: 7F 00 00       CLR    >$0000
D53B: 7F 00 00       CLR    >$0000
D53E: 7F 00 00       CLR    >$0000
D541: 7F 00 F0       CLR    >$00F0
D544: 7F 00 F0       CLR    >$00F0
D547: 7F 00 00       CLR    >$0000
D54A: 7F 00 00       CLR    >$0000
D54D: 7F 00 00       CLR    >$0000
D550: 7F 00 00       CLR    >$0000
D553: 7F 00 00       CLR    >$0000
D556: 7F 00 F0       CLR    >$00F0
D559: 7F 00 F0       CLR    >$00F0
D55C: 7F 00 00       CLR    >$0000
D55F: 7F 00 00       CLR    >$0000
D562: 7F 00 00       CLR    >$0000
D565: 7F 00 00       CLR    >$0000
D568: 7F 00 00       CLR    >$0000
D56B: 7F 00 F0       CLR    >$00F0
D56E: 7F 00 F0       CLR    >$00F0
D571: 7F 00 00       CLR    >$0000
D574: 7F 00 00       CLR    >$0000
D577: 7F 00 00       CLR    >$0000
D57A: 7F 00 00       CLR    >$0000
D57D: 7F 00 00       CLR    >$0000
D580: 7F 00 F0       CLR    >$00F0
D583: 7F 00 F0       CLR    >$00F0
D586: 7F 00 00       CLR    >$0000
D589: 7F 00 00       CLR    >$0000
D58C: 7F 00 00       CLR    >$0000
D58F: 7F 00 00       CLR    >$0000
D592: 7F 00 00       CLR    >$0000
D595: 7F 00 F0       CLR    >$00F0
D598: 7F 00 F0       CLR    >$00F0
D59B: 7F 00 00       CLR    >$0000
D59E: 7F 00 00       CLR    >$0000
D5A1: 7F 00 00       CLR    >$0000
D5A4: 7F 00 00       CLR    >$0000
D5A7: 05 0E 00       EIM    #$0E;$00
D5AA: 04 18          LSR    $18
D5AC: FD 00 1E       STD    >$001E
D5AF: 00 7F          NEG    $7F
D5B1: 00 00          NEG    $00
D5B3: 7F 00 00       CLR    >$0000
D5B6: 7F 00 00       CLR    >$0000
D5B9: 7F 00 00       CLR    >$0000
D5BC: 00 0D          NEG    $0D
D5BE: 18             FCB    $18
D5BF: 03 10          COM    $10
D5C1: 20 05          BRA    $D5C8
D5C3: 10 18          FCB    $10,$18
D5C5: 7F             FCB    $7F
D5C6: 00             FCB    $00
D5C7: 00             FCB    $00
D5C8: 7F             FCB    $7F
...
D5D4: 04 00          LSR    $00
D5D6: 38             FCB    $38
D5D7: 01 00 38       OIM    #$00;$38
D5DA: 7F 00 00       CLR    >$0000
D5DD: 7F 00 00       CLR    >$0000
D5E0: 7F 00 00       CLR    >$0000
D5E3: 7F 00 00       CLR    >$0000
D5E6: 01 F0 3D       OIM    #$F0;$3D
D5E9: 04 00          LSR    $00
D5EB: 38             FCB    $38
D5EC: 01 00 3C       OIM    #$00;$3C
D5EF: 7F 00 00       CLR    >$0000
D5F2: 7F 00 00       CLR    >$0000
D5F5: 7F 00 00       CLR    >$0000
D5F8: 7F 00 00       CLR    >$0000
D5FB: 01 F0 3C       OIM    #$F0;$3C
D5FE: 04 00          LSR    $00
D600: 37 01          PULU   CC
D602: 00 3B          NEG    $3B
D604: 7F 00 00       CLR    >$0000
D607: 7F 00 00       CLR    >$0000
D60A: 7F 00 00       CLR    >$0000
D60D: 7F 00 00       CLR    >$0000
D610: 01 F0 3D       OIM    #$F0;$3D
D613: 04 00          LSR    $00
D615: 37 01          PULU   CC
D617: 00 3B          NEG    $3B
D619: 7F 00 00       CLR    >$0000
D61C: 7F 00 00       CLR    >$0000
D61F: 7F 00 00       CLR    >$0000
D622: 7F 00 00       CLR    >$0000
D625: 01 F0 3C       OIM    #$F0;$3C
D628: 04 00          LSR    $00
D62A: 37 01          PULU   CC
D62C: 00 3B          NEG    $3B
D62E: 7F 00 00       CLR    >$0000
D631: 7F 00 00       CLR    >$0000
D634: 7F 00 00       CLR    >$0000
D637: 7F 00 00       CLR    >$0000
D63A: 02 F0 3C       AIM    #$F0;$3C
D63D: 04 00          LSR    $00
D63F: 39             RTS
D640: 81 00          CMPA   #$00
D642: 3C 7F          CWAI   #$7F
D644: 00 00          NEG    $00
D646: 7F 00 00       CLR    >$0000
D649: 7F 00 00       CLR    >$0000
D64C: 7F 00 00       CLR    >$0000
D64F: 02 F0 3B       AIM    #$F0;$3B
D652: 04 00          LSR    $00
D654: 38             FCB    $38
D655: 81 00          CMPA   #$00
D657: 3B             RTI
D658: 7F 00 00       CLR    >$0000
D65B: 7F 00 00       CLR    >$0000
D65E: 7F 00 00       CLR    >$0000
D661: 7F 00 00       CLR    >$0000
D664: 02 F0 3C       AIM    #$F0;$3C
D667: 04 00          LSR    $00
D669: 39             RTS
D66A: 81 00          CMPA   #$00
D66C: 3C 7F          CWAI   #$7F
D66E: 00 00          NEG    $00
D670: 7F 00 00       CLR    >$0000
D673: 7F 00 00       CLR    >$0000
D676: 7F 00 00       CLR    >$0000
D679: 02 F0 3B       AIM    #$F0;$3B
D67C: 04 00          LSR    $00
D67E: 38             FCB    $38
D67F: 81 00          CMPA   #$00
D681: 3B             RTI
D682: 7F 00 00       CLR    >$0000
D685: 7F 00 00       CLR    >$0000
D688: 7F 00 00       CLR    >$0000
D68B: 7F 00 00       CLR    >$0000
D68E: 7F 00 00       CLR    >$0000
D691: 7F 00 F0       CLR    >$00F0
D694: 7F 00 F0       CLR    >$00F0
D697: 7F 00 00       CLR    >$0000
D69A: 7F 00 00       CLR    >$0000
D69D: 7F 00 00       CLR    >$0000
D6A0: 7F 00 00       CLR    >$0000
D6A3: 05 0E 02       EIM    #$0E;$02
D6A6: 04 1C          LSR    $1C
D6A8: 00 00          NEG    $00
D6AA: 1E 02          EXG    D,Y
D6AC: 00 0D          NEG    $0D
D6AE: 1C 03          ANDCC  #$03
D6B0: 0A 2A          DEC    $2A
D6B2: 05 0C 26       EIM    #$0C;$26
D6B5: 0E 04          JMP    $04
D6B7: 44             LSRA
D6B8: 04 F8          LSR    $F8
D6BA: 44             LSRA
D6BB: 01 F8 46       OIM    #$F8;$46
D6BE: 01 F0 4E       OIM    #$F0;$4E
D6C1: 04 00          LSR    $00
D6C3: 45             FCB    $45
D6C4: 01 00 4C       OIM    #$00;$4C
D6C7: 01 F0 4C       OIM    #$F0;$4C
D6CA: 04 00          LSR    $00
D6CC: 43             COMA
D6CD: 01 00 4A       OIM    #$00;$4A
D6D0: 01 F0 4C       OIM    #$F0;$4C
D6D3: 04 00          LSR    $00
D6D5: 43             COMA
D6D6: 01 00 4A       OIM    #$00;$4A
D6D9: 01 F0 4E       OIM    #$F0;$4E
D6DC: 04 00          LSR    $00
D6DE: 45             FCB    $45
D6DF: 01 00 4C       OIM    #$00;$4C
D6E2: 02 F0 4D       AIM    #$F0;$4D
D6E5: 04 00          LSR    $00
D6E7: 47             ASRA
D6E8: 81 00          CMPA   #$00
D6EA: 4C             INCA
D6EB: 02 F0 4D       AIM    #$F0;$4D
D6EE: 04 00          LSR    $00
D6F0: 47             ASRA
D6F1: 81 00          CMPA   #$00
D6F3: 4C             INCA
D6F4: 02 F0 4B       AIM    #$F0;$4B
D6F7: 04 00          LSR    $00
D6F9: 45             FCB    $45
D6FA: 81 00          CMPA   #$00
D6FC: 4A             DECA
D6FD: 02 F0 4B       AIM    #$F0;$4B
D700: 04 00          LSR    $00
D702: 45             FCB    $45
D703: 81 00          CMPA   #$00
D705: 4A             DECA
D706: 7F 00 00       CLR    >$0000
D709: 7F 00 F0       CLR    >$00F0
D70C: 7F 00 F0       CLR    >$00F0
D70F: 05 08 29       EIM    #$08;$29
D712: 02 08 3C       AIM    #$08;$3C
D715: 05 08 29       EIM    #$08;$29
D718: 06 08          ROR    $08
D71A: 2E 02          BGT    $D71E
D71C: 08 3C          ASL    $3C
D71E: 06 08          ROR    $08
...
D726: 36 06          PSHU   D
D728: 08 2E          ASL    $2E
D72A: 05 08 29       EIM    #$08;$29
D72D: 03 06          COM    $06
D72F: 36 05          PSHU   B,CC
D731: 08 29          ASL    $29
D733: 00 08          NEG    $08
D735: 28 01          BVC    $D738
D737: F8 36 00       EORB   $3600
D73A: 08 28          ASL    $28
D73C: 00 08          NEG    $08
D73E: 28 01          BVC    $D741
D740: F8 36 00       EORB   $3600
D743: 08 28          ASL    $28
D745: 01 08 28       OIM    #$08;$28
D748: 01 FE 36       OIM    #$FE;$36
D74B: 01 08 28       OIM    #$08;$28
D74E: 01 08 28       OIM    #$08;$28
D751: 01 FE 36       OIM    #$FE;$36
D754: 01 08 28       OIM    #$08;$28
D757: 05 09 31       EIM    #$09;$31
D75A: 01 FD 36       OIM    #$FD;$36
D75D: 05 09 31       EIM    #$09;$31
D760: 05 09 2C       EIM    #$09;$2C
D763: 01 00 38       OIM    #$00;$38
D766: 05 09 2C       EIM    #$09;$2C
D769: 7F 00 00       CLR    >$0000
D76C: 7F 00 00       CLR    >$0000
D76F: 7F 00 00       CLR    >$0000
D772: 7F 00 00       CLR    >$0000
D775: 7F 00 00       CLR    >$0000
D778: 7F 00 00       CLR    >$0000
D77B: 7F 00 00       CLR    >$0000
D77E: 7F 00 00       CLR    >$0000
D781: 7F 00 00       CLR    >$0000
D784: 7F 00 00       CLR    >$0000
D787: 7F 00 00       CLR    >$0000
D78A: 7F 00 00       CLR    >$0000
D78D: 7F 00 00       CLR    >$0000
D790: 7F 00 00       CLR    >$0000
D793: 7F 00 00       CLR    >$0000
D796: 86 10          LDA    #$10
D798: 15             FCB    $15
D799: 0C 0A          INC    $0A
D79B: 14             SEXW
...
D79E: 15             FCB    $15
D79F: 86 13          LDA    #$13
D7A1: F8 86 13       EORB   $8613
D7A4: FE 02 08       LDU    $0208
D7A7: 08 7F          ASL    $7F
D7A9: 00 00          NEG    $00
D7AB: 7F 00 00       CLR    >$0000
D7AE: 7F 00 00       CLR    >$0000
D7B1: 7F 00 00       CLR    >$0000
D7B4: 7F 00 00       CLR    >$0000
D7B7: 7F 00 00       CLR    >$0000
D7BA: 7F 00 00       CLR    >$0000
D7BD: 7F 00 00       CLR    >$0000
D7C0: 7F 00 00       CLR    >$0000
D7C3: 7F 00 00       CLR    >$0000
D7C6: 7F 00 00       CLR    >$0000
D7C9: 7F 00 00       CLR    >$0000
D7CC: 7F 00 00       CLR    >$0000
D7CF: 7F 00 00       CLR    >$0000
D7D2: 7F 00 00       CLR    >$0000
D7D5: 7F 00 00       CLR    >$0000
D7D8: 7F 00 00       CLR    >$0000
D7DB: 7F 00 00       CLR    >$0000
D7DE: 04 FE          LSR    $FE
D7E0: 30 7F          LEAX   -$1,S
D7E2: 00 00          NEG    $00
D7E4: 7F 00 F8       CLR    >$00F8
D7E7: 07 18          ASR    $18
D7E9: 28 05          BVC    $D7F0
D7EB: 1E 28          EXG    Y,A
D7ED: 07 18          ASR    $18
D7EF: 28 08          BVC    $D7F9
D7F1: F0 18 06       SUBB   $1806
D7F4: FE 18 08       LDU    $1808
D7F7: F0 18 89       SUBB   $1889
D7FA: F4 30 8C       ANDB   $308C
D7FD: EE 24          LDU    $4,Y
D7FF: 89 F4          ADCA   #$F4
D801: 30 09          LEAX   $9,X
D803: 1A 22          ORCC   #$22
D805: 01 FC 3C       OIM    #$FC;$3C
D808: 09 1A          ROL    $1A
D80A: 22 7F          BHI    $D88B
D80C: 00 00          NEG    $00
D80E: 7F 00 00       CLR    >$0000
D811: 7F 00 00       CLR    >$0000
D814: 7F 00 00       CLR    >$0000
D817: 7F 00 00       CLR    >$0000
D81A: 7F 00 00       CLR    >$0000
D81D: 89 F8          ADCA   #$F8
D81F: 32 8C EF       LEAS   $D811,PCR
D822: 27 89          BEQ    $D7AD
D824: F8 32 7F       EORB   $327F
D827: 00 00          NEG    $00
D829: 01 F4 40       OIM    #$F4;$40
D82C: 7F 00 00       CLR    >$0000
D82F: 0E 10          JMP    $10
D831: 38             FCB    $38
D832: 8C 0A 3A       CMPX   #$0A3A
D835: 0E 10          JMP    $10
D837: 38             FCB    $38
D838: 0D 08          TST    $08
D83A: 27 0C          BEQ    $D848
...
D840: 27 7F          BEQ    $D8C1
D842: 00 00          NEG    $00
D844: 0B FC 3C       TIM    #$FC;$3C
D847: 7F 00 00       CLR    >$0000
D84A: 09 FE          ROL    $FE
D84C: 3E             FCB    $3E
D84D: 11 FC          FCB    $11,$FC
D84F: 36 09 FE       LDBT   CC,1,1,$FE
D852: 3E             FCB    $3E
D853: 7F 00 00       CLR    >$0000
D856: 12             NOP
D857: F6 31 7F       LDB    $317F
D85A: 00 00          NEG    $00
D85C: 7F 00 00       CLR    >$0000
D85F: 13             SYNC
D860: FC 38 7F       LDD    $387F
D863: 00 00          NEG    $00
D865: 7F 00 00       CLR    >$0000
D868: 0C 10          INC    $10
D86A: 22 7F          BHI    $D8EB
D86C: 00 00          NEG    $00
D86E: 09 FE          ROL    $FE
D870: 32 8C 14       LEAS   $D887,PCR
D873: 38             FCB    $38
D874: 09 FE          ROL    $FE
D876: 32 09          LEAS   $9,X
D878: F4 30 14       ANDB   $3014
D87B: 0C 35          INC    $35
D87D: 09 F4          ROL    $F4
D87F: 30 09          LEAX   $9,X
D881: FC 32 14       LDD    $3214
D884: 0A 37          DEC    $37
D886: 09 FC          ROL    $FC
D888: 32 0D          LEAS   $D,X
D88A: F9 1A 0C       ADCB   $1A0C
D88D: FA 1B 0D       ORB    $1B0D
D890: F9 1A 0D       ADCB   $1A0D
D893: 0D 21          TST    $21
D895: 0C 0E          INC    $0E
D897: 22 0D          BHI    $D8A6
D899: 0D 21          TST    $21
...
D8A0: 21 8F          BRN    $D831
D8A2: 08 1E          ASL    $1E
D8A4: 7F 00 00       CLR    >$0000
D8A7: 7F 0E 26       CLR    $0E26
D8AA: 7F 00 00       CLR    >$0000
D8AD: 90 F6          SUBA   $F6
D8AF: 38             FCB    $38
D8B0: 01 EF 44       OIM    #$EF;$44
D8B3: 90 F6          SUBA   $F6
D8B5: 38             FCB    $38
D8B6: 00 05          NEG    $05
D8B8: 30 01          LEAX   $1,X
D8BA: 02 3F 00       AIM    #$3F;$00
D8BD: 05 30 87       EIM    #$30;$87
D8C0: E8 36          EORB   -$A,Y
D8C2: 10 00          FCB    $10,$00
D8C4: 00             FCB    $00
D8C5: 87             FCB    $87
D8C6: E8             FCB    $E8
D8C7: 36 87          EORR   A,V
D8C9: FE 3E 10       LDU    $3E10
D8CC: 00 00          NEG    $00
D8CE: 87             FCB    $87
D8CF: FE 3E 7F       LDU    $3E7F
D8D2: 00 00          NEG    $00
D8D4: 7F 00 00       CLR    >$0000
D8D7: 7F 00 00       CLR    >$0000
D8DA: 7F 00 00       CLR    >$0000
D8DD: 7F 00 00       CLR    >$0000
D8E0: 7F 00 00       CLR    >$0000
D8E3: 7F 00 00       CLR    >$0000
D8E6: 7F 00 00       CLR    >$0000
D8E9: 7F 00 00       CLR    >$0000
D8EC: 7F 00 00       CLR    >$0000
D8EF: 7F 00 00       CLR    >$0000
D8F2: 7F 00 00       CLR    >$0000
D8F5: 01 10 30       OIM    #$10;$30
D8F8: 01 0A 3D       OIM    #$0A;$3D
D8FB: 01 10 30       OIM    #$10;$30
D8FE: 0B 05 2E       TIM    #$05;$2E
D901: 08 08          ASL    $08
D903: 28 0B          BVC    $D910
D905: 05 2E 0B       EIM    #$2E;$0B
D908: F9 1E 08       ADCB   $1E08
D90B: FC 18 0B       LDD    $180B
D90E: F9 1E 06       ADCB   $1E06
D911: E5 20          BITB   $0,Y
D913: 8C E6 23       CMPX   #$E623
D916: 06 E5          ROR    $E5
D918: 20 01          BRA    $D91B
D91A: F6 2F 01       LDB    $2F01
D91D: F2 3E 01       SBCB   $3E01
D920: F6 2F 06       LDB    $2F06
D923: EE 24          LDU    $4,Y
D925: 8C F0 26       CMPX   #$F026
D928: 06 F6          ROR    $F6
D92A: 26 7F          BNE    $D9AB
D92C: 00 00          NEG    $00
D92E: 7F 00 00       CLR    >$0000
D931: 7F 00 00       CLR    >$0000
D934: 7F 00 00       CLR    >$0000
D937: 7F 00 00       CLR    >$0000
D93A: 7F 00 00       CLR    >$0000
D93D: 7F 00 00       CLR    >$0000
D940: 7F 00 00       CLR    >$0000
D943: 7F 00 00       CLR    >$0000
D946: 7F 00 00       CLR    >$0000
D949: 7F 00 00       CLR    >$0000
D94C: 7F 00 00       CLR    >$0000
D94F: 7F 00 00       CLR    >$0000
D952: 7F 00 00       CLR    >$0000
D955: 7F 00 00       CLR    >$0000
D958: 7F 00 00       CLR    >$0000
D95B: 7F 00 00       CLR    >$0000
D95E: 7F 00 00       CLR    >$0000
D961: 7F 00 00       CLR    >$0000
D964: 7F 00 00       CLR    >$0000
D967: 7F 00 00       CLR    >$0000
D96A: 7F 00 00       CLR    >$0000
D96D: 7F 00 00       CLR    >$0000
D970: 7F 00 00       CLR    >$0000
D973: 7F 00 00       CLR    >$0000
D976: 7F 00 00       CLR    >$0000
D979: 7F 00 00       CLR    >$0000
D97C: 7F 00 00       CLR    >$0000
D97F: 7F 00 00       CLR    >$0000
D982: 7F 00 00       CLR    >$0000
D985: 7F 00 00       CLR    >$0000
D988: 7F 00 00       CLR    >$0000
D98B: 7F 00 00       CLR    >$0000
D98E: 7F 00 00       CLR    >$0000
D991: 7F 00 00       CLR    >$0000
D994: 7F 00 00       CLR    >$0000
D997: 7F 00 00       CLR    >$0000
D99A: 7F 00 00       CLR    >$0000
D99D: 7F 00 00       CLR    >$0000
D9A0: 7F 00 00       CLR    >$0000
D9A3: 7F 00 00       CLR    >$0000
D9A6: 7F 00 00       CLR    >$0000
D9A9: 7F 00 00       CLR    >$0000
D9AC: 7F 00 00       CLR    >$0000
D9AF: 7F 00 00       CLR    >$0000
D9B2: 7F 00 00       CLR    >$0000
D9B5: 7F 00 00       CLR    >$0000
D9B8: 7F 00 00       CLR    >$0000
D9BB: 7F 00 00       CLR    >$0000
D9BE: 7F 00 00       CLR    >$0000
D9C1: 7F 00 00       CLR    >$0000
D9C4: 7F 00 00       CLR    >$0000
D9C7: 7F 00 00       CLR    >$0000
D9CA: 7F 00 00       CLR    >$0000
D9CD: 7F 00 00       CLR    >$0000
D9D0: 7F 00 00       CLR    >$0000
D9D3: 7F 00 00       CLR    >$0000
D9D6: 7F 00 00       CLR    >$0000
D9D9: 7F 00 00       CLR    >$0000
D9DC: 7F 00 00       CLR    >$0000
D9DF: 7F 00 00       CLR    >$0000
D9E2: 7F 00 00       CLR    >$0000
D9E5: 7F 00 00       CLR    >$0000
D9E8: 7F 00 00       CLR    >$0000
D9EB: 7F 00 00       CLR    >$0000
D9EE: 7F 00 00       CLR    >$0000
D9F1: 7F 00 00       CLR    >$0000
D9F4: 7F 00 00       CLR    >$0000
D9F7: 7F 00 00       CLR    >$0000
D9FA: 7F 00 00       CLR    >$0000
D9FD: 7F 00 F0       CLR    >$00F0
DA00: 7F 00 F0       CLR    >$00F0
DA03: 05 08 29       EIM    #$08;$29
DA06: 02 07 3A       AIM    #$07;$3A
DA09: 05 08 29       EIM    #$08;$29
DA0C: 7F 00 00       CLR    >$0000
DA0F: 7F 00 F0       CLR    >$00F0
DA12: 7F 00 F0       CLR    >$00F0
DA15: 06 08          ROR    $08
DA17: 2E 03          BGT    $DA1C
DA19: 05 3B 06       EIM    #$3B;$06
DA1C: 08 2E          ASL    $2E
DA1E: 7F 00 00       CLR    >$0000
DA21: 7F 00 F0       CLR    >$00F0
DA24: 7F 00 F0       CLR    >$00F0
DA27: 06 08          ROR    $08
DA29: 2E 03          BGT    $DA2E
DA2B: 05 3B 06       EIM    #$3B;$06
DA2E: 08 2E          ASL    $2E
DA30: 7F 00 00       CLR    >$0000
DA33: 7F 00 F0       CLR    >$00F0
DA36: 7F 00 F0       CLR    >$00F0
DA39: 05 08 29       EIM    #$08;$29
DA3C: 02 07 3A       AIM    #$07;$3A
DA3F: 05 08 29       EIM    #$08;$29
DA42: 7F 00 00       CLR    >$0000
DA45: 7F 00 F0       CLR    >$00F0
DA48: 7F 00 F0       CLR    >$00F0
DA4B: 00 08          NEG    $08
DA4D: 28 01          BVC    $DA50
DA4F: F8 36 00       EORB   $3600
DA52: 08 28          ASL    $28
DA54: 7F 00 00       CLR    >$0000
DA57: 7F 00 F0       CLR    >$00F0
DA5A: 7F 00 F0       CLR    >$00F0
DA5D: 00 08          NEG    $08
DA5F: 28 01          BVC    $DA62
DA61: F8 36 00       EORB   $3600
DA64: 08 28          ASL    $28
DA66: 7F 00 00       CLR    >$0000
DA69: 7F 00 F0       CLR    >$00F0
DA6C: 7F 00 F0       CLR    >$00F0
DA6F: 01 08 28       OIM    #$08;$28
DA72: 01 FE 36       OIM    #$FE;$36
DA75: 01 08 28       OIM    #$08;$28
DA78: 7F 00 00       CLR    >$0000
DA7B: 7F 00 F0       CLR    >$00F0
DA7E: 7F 00 F0       CLR    >$00F0
DA81: 01 08 28       OIM    #$08;$28
DA84: 01 FE 36       OIM    #$FE;$36
DA87: 01 08 28       OIM    #$08;$28
DA8A: 7F 00 00       CLR    >$0000
DA8D: 7F 00 F0       CLR    >$00F0
DA90: 7F 00 F0       CLR    >$00F0
DA93: 05 09 31       EIM    #$09;$31
DA96: 01 FD 36       OIM    #$FD;$36
DA99: 05 09 31       EIM    #$09;$31
DA9C: 7F 00 00       CLR    >$0000
DA9F: 7F 00 F0       CLR    >$00F0
DAA2: 7F 00 F0       CLR    >$00F0
DAA5: 05 09 2C       EIM    #$09;$2C
DAA8: 01 00 38       OIM    #$00;$38
DAAB: 05 09 2C       EIM    #$09;$2C
DAAE: 7F 00 00       CLR    >$0000
DAB1: 7F 00 F0       CLR    >$00F0
DAB4: 7F 00 F0       CLR    >$00F0
DAB7: 7F 00 00       CLR    >$0000
DABA: 7F 00 00       CLR    >$0000
DABD: 7F 00 00       CLR    >$0000
DAC0: 7F 00 00       CLR    >$0000
DAC3: 7F 00 F0       CLR    >$00F0
DAC6: 7F 00 F0       CLR    >$00F0
DAC9: 7F 00 00       CLR    >$0000
DACC: 7F 00 00       CLR    >$0000
DACF: 7F 00 00       CLR    >$0000
DAD2: 7F 00 00       CLR    >$0000
DAD5: 7F 00 F0       CLR    >$00F0
DAD8: 7F 00 F0       CLR    >$00F0
DADB: 7F 00 00       CLR    >$0000
DADE: 7F 00 00       CLR    >$0000
DAE1: 7F 00 00       CLR    >$0000
DAE4: 7F 00 00       CLR    >$0000
DAE7: 7F 00 F0       CLR    >$00F0
DAEA: 7F 00 F0       CLR    >$00F0
DAED: 7F 00 00       CLR    >$0000
DAF0: 7F 00 00       CLR    >$0000
DAF3: 7F 00 00       CLR    >$0000
DAF6: 7F 00 00       CLR    >$0000
DAF9: 7F 00 F0       CLR    >$00F0
DAFC: 7F 00 F0       CLR    >$00F0
DAFF: 7F 00 00       CLR    >$0000
DB02: 7F 00 00       CLR    >$0000
DB05: 7F 00 00       CLR    >$0000
DB08: 7F 00 00       CLR    >$0000
DB0B: 7F 00 F0       CLR    >$00F0
DB0E: 7F 00 F0       CLR    >$00F0
DB11: 86 10          LDA    #$10
DB13: 15             FCB    $15
DB14: 0C 0E          INC    $0E
DB16: 1A 86          ORCC   #$86
DB18: 10 15          FCB    $10,$15
DB1A: 7F             FCB    $7F
DB1B: 00             FCB    $00
DB1C: 00             FCB    $00
DB1D: 7F             FCB    $7F
...
DB24: 08             FCB    $08
DB25: 08             FCB    $08
DB26: 86 13 00       LDW    #$1300
DB29: 02 08 08       AIM    #$08;$08
DB2C: 7F 00 00       CLR    >$0000
DB2F: 7F 00 F0       CLR    >$00F0
DB32: 7F 00 F0       CLR    >$00F0
DB35: 7F 00 00       CLR    >$0000
DB38: 7F 00 00       CLR    >$0000
DB3B: 7F 00 00       CLR    >$0000
DB3E: 7F 00 00       CLR    >$0000
DB41: 7F 00 F0       CLR    >$00F0
DB44: 7F 00 F0       CLR    >$00F0
DB47: 7F 00 00       CLR    >$0000
DB4A: 7F 00 00       CLR    >$0000
DB4D: 7F 00 00       CLR    >$0000
DB50: 7F 00 00       CLR    >$0000
DB53: 7F 00 F0       CLR    >$00F0
DB56: 7F 00 F0       CLR    >$00F0
DB59: 7F 00 00       CLR    >$0000
DB5C: 7F 00 00       CLR    >$0000
DB5F: 7F 00 00       CLR    >$0000
DB62: 7F 00 00       CLR    >$0000
DB65: 7F 00 F0       CLR    >$00F0
DB68: 7F 00 F0       CLR    >$00F0
DB6B: 7F 00 00       CLR    >$0000
DB6E: 7F 00 00       CLR    >$0000
DB71: 7F 00 00       CLR    >$0000
DB74: 7F 00 00       CLR    >$0000
DB77: 7F 00 F0       CLR    >$00F0
DB7A: 7F 00 F0       CLR    >$00F0
DB7D: 7F 00 00       CLR    >$0000
DB80: 7F 00 00       CLR    >$0000
DB83: 7F 00 00       CLR    >$0000
DB86: 7F 00 00       CLR    >$0000
DB89: 7F 00 F0       CLR    >$00F0
DB8C: 7F 00 F0       CLR    >$00F0
DB8F: 7F 00 00       CLR    >$0000
DB92: 7F 00 00       CLR    >$0000
DB95: 7F 00 00       CLR    >$0000
DB98: 7F 00 00       CLR    >$0000
DB9B: 7F 00 F0       CLR    >$00F0
DB9E: 7F 00 F0       CLR    >$00F0
DBA1: 7F 00 00       CLR    >$0000
DBA4: 04 FE          LSR    $FE
DBA6: 38             FCB    $38
DBA7: 7F 00 00       CLR    >$0000
DBAA: 7F 00 00       CLR    >$0000
DBAD: 7F 00 F0       CLR    >$00F0
DBB0: 7F 00 F0       CLR    >$00F0
DBB3: 07 18          ASR    $18
DBB5: 28 05          BVC    $DBBC
DBB7: 1E 28          EXG    Y,A
DBB9: 07 18          ASR    $18
DBBB: 28 7F          BVC    $DC3C
DBBD: 00 00          NEG    $00
DBBF: 7F 00 F0       CLR    >$00F0
DBC2: 7F 00 F0       CLR    >$00F0
DBC5: 08 F0          ASL    $F0
DBC7: 18             FCB    $18
DBC8: 06 FA          ROR    $FA
DBCA: 18             FCB    $18
DBCB: 08 F0          ASL    $F0
DBCD: 18             FCB    $18
DBCE: 7F 00 00       CLR    >$0000
DBD1: 7F 00 F0       CLR    >$00F0
DBD4: 7F 00 F0       CLR    >$00F0
DBD7: 89 F4          ADCA   #$F4
DBD9: 30 8C EE       LEAX   $DBCA,PCR
DBDC: 24 89          BCC    $DB67
DBDE: F4 30 7F       ANDB   $307F
DBE1: 00 00          NEG    $00
DBE3: 7F 00 F0       CLR    >$00F0
DBE6: 7F 00 F0       CLR    >$00F0
DBE9: 09 1A          ROL    $1A
DBEB: 22 01          BHI    $DBEE
DBED: FC 3C 09       LDD    $3C09
DBF0: 1A 22          ORCC   #$22
DBF2: 7F 00 00       CLR    >$0000
DBF5: 7F 00 F0       CLR    >$00F0
DBF8: 7F 00 F0       CLR    >$00F0
DBFB: 7F 00 00       CLR    >$0000
DBFE: 7F 00 00       CLR    >$0000
DC01: 7F 00 00       CLR    >$0000
DC04: 7F 00 00       CLR    >$0000
DC07: 7F 00 F0       CLR    >$00F0
DC0A: 7F 00 F0       CLR    >$00F0
DC0D: 7F 00 00       CLR    >$0000
DC10: 7F 00 00       CLR    >$0000
DC13: 7F 00 00       CLR    >$0000
DC16: 7F 00 00       CLR    >$0000
DC19: 7F 00 F0       CLR    >$00F0
DC1C: 7F 00 F0       CLR    >$00F0
DC1F: 89 F8          ADCA   #$F8
DC21: 32 8C EF       LEAS   $DC13,PCR
DC24: 27 89          BEQ    $DBAF
DC26: F8 32 7F       EORB   $327F
DC29: 00 00          NEG    $00
DC2B: 7F 00 F0       CLR    >$00F0
DC2E: 7F 00 F0       CLR    >$00F0
DC31: 7F 00 00       CLR    >$0000
DC34: 01 F4 40       OIM    #$F4;$40
DC37: 7F 00 00       CLR    >$0000
DC3A: 7F 00 00       CLR    >$0000
DC3D: 7F 00 F0       CLR    >$00F0
DC40: 7F 00 F0       CLR    >$00F0
DC43: 0E 10          JMP    $10
DC45: 38             FCB    $38
DC46: 8C 0A 3A       CMPX   #$0A3A
DC49: 0E 10          JMP    $10
DC4B: 38             FCB    $38
DC4C: 7F 00 00       CLR    >$0000
DC4F: 7F 00 F0       CLR    >$00F0
...
DC5D: 27 7F          BEQ    $DCDE
DC5F: 00 00          NEG    $00
DC61: 7F 00 F0       CLR    >$00F0
DC64: 7F 00 F0       CLR    >$00F0
DC67: 7F 00 00       CLR    >$0000
DC6A: 0B FC 3C       TIM    #$FC;$3C
DC6D: 7F 00 00       CLR    >$0000
DC70: 7F 00 00       CLR    >$0000
DC73: 7F 00 F0       CLR    >$00F0
DC76: 7F 00 F0       CLR    >$00F0
DC79: 09 FE          ROL    $FE
DC7B: 3E             FCB    $3E
DC7C: 11 FC          FCB    $11,$FC
DC7E: 36 09 FE       LDBT   CC,1,1,$FE
DC81: 3E             FCB    $3E
DC82: 7F 00 00       CLR    >$0000
DC85: 7F 00 F0       CLR    >$00F0
DC88: 7F 00 F0       CLR    >$00F0
DC8B: 7F 00 00       CLR    >$0000
DC8E: 12             NOP
DC8F: F6 31 7F       LDB    $317F
DC92: 00 00          NEG    $00
DC94: 7F 00 00       CLR    >$0000
DC97: 7F 00 F0       CLR    >$00F0
DC9A: 7F 00 F0       CLR    >$00F0
DC9D: 7F 00 00       CLR    >$0000
DCA0: 13             SYNC
DCA1: FC 38 7F       LDD    $387F
DCA4: 00 00          NEG    $00
DCA6: 7F 00 00       CLR    >$0000
DCA9: 7F 00 F0       CLR    >$00F0
DCAC: 7F 00 F0       CLR    >$00F0
DCAF: 7F 00 00       CLR    >$0000
DCB2: 0C 10          INC    $10
DCB4: 22 7F          BHI    $DD35
DCB6: 00 00          NEG    $00
DCB8: 7F 00 00       CLR    >$0000
DCBB: 7F 00 F0       CLR    >$00F0
DCBE: 7F 00 F0       CLR    >$00F0
DCC1: 09 FE          ROL    $FE
DCC3: 32 8C 14       LEAS   $DCDA,PCR
DCC6: 38             FCB    $38
DCC7: 09 FE          ROL    $FE
DCC9: 32 7F          LEAS   -$1,S
DCCB: 00 00          NEG    $00
DCCD: 7F 00 F0       CLR    >$00F0
...
DCDB: 30 7F          LEAX   -$1,S
DCDD: 00 00          NEG    $00
DCDF: 7F 00 F0       CLR    >$00F0
DCE2: 7F 00 F0       CLR    >$00F0
DCE5: 09 FC          ROL    $FC
DCE7: 32 14          LEAS   -$C,X
DCE9: 0A 37          DEC    $37
DCEB: 09 FC          ROL    $FC
DCED: 32 7F          LEAS   -$1,S
DCEF: 00 00          NEG    $00
DCF1: 7F 00 F0       CLR    >$00F0
DCF4: 7F 00 F0       CLR    >$00F0
DCF7: 0D F9          TST    $F9
DCF9: 1A 0C          ORCC   #$0C
DCFB: FA 1B 0D       ORB    $1B0D
DCFE: F9 1A 7F       ADCB   $1A7F
DD01: 00 00          NEG    $00
DD03: 7F 00 F0       CLR    >$00F0
DD06: 7F 00 F0       CLR    >$00F0
DD09: 0D 0D          TST    $0D
DD0B: 21 0C          BRN    $DD19
DD0D: 0E 22          JMP    $22
DD0F: 0D 0D          TST    $0D
DD11: 21 7F          BRN    $DD92
DD13: 00 00          NEG    $00
DD15: 7F 00 F0       CLR    >$00F0
DD18: 7F 00 F0       CLR    >$00F0
DD1B: 8F             FCB    $8F
DD1C: 08 1E          ASL    $1E
DD1E: 0C 0A          INC    $0A
DD20: 21 8F          BRN    $DCB1
DD22: 08 1E          ASL    $1E
DD24: 7F 00 00       CLR    >$0000
DD27: 7F 00 F0       CLR    >$00F0
DD2A: 7F 00 F0       CLR    >$00F0
DD2D: 7F 00 00       CLR    >$0000
DD30: 7F 0E 26       CLR    $0E26
...
DD3F: 90 F6          SUBA   $F6
DD41: 38             FCB    $38
DD42: 01 EF 44       OIM    #$EF;$44
DD45: 90 F6          SUBA   $F6
DD47: 38             FCB    $38
DD48: 7F 00 00       CLR    >$0000
DD4B: 7F 00 F0       CLR    >$00F0
DD4E: 7F 00 F0       CLR    >$00F0
DD51: 00 05          NEG    $05
DD53: 30 01          LEAX   $1,X
DD55: 02 3F 00       AIM    #$3F;$00
DD58: 05 30 7F       EIM    #$30;$7F
DD5B: 00 00          NEG    $00
DD5D: 7F 00 F0       CLR    >$00F0
DD60: 7F 00 F0       CLR    >$00F0
DD63: 87             FCB    $87
DD64: E2 36          SBCB   -$A,Y
DD66: 10 00          FCB    $10,$00
DD68: 00             FCB    $00
DD69: 87             FCB    $87
DD6A: E2             FCB    $E2
DD6B: 36 7F          EORR   V,F
DD6D: 00 00          NEG    $00
DD6F: 7F 00 F0       CLR    >$00F0
DD72: 7F 00 F0       CLR    >$00F0
DD75: 87             FCB    $87
DD76: F6 40 10       LDB    $4010
DD79: 00 00          NEG    $00
DD7B: 87             FCB    $87
DD7C: F6 40 7F       LDB    $407F
DD7F: 00 00          NEG    $00
DD81: 7F 00 F0       CLR    >$00F0
DD84: 7F 00 F0       CLR    >$00F0
DD87: 7F 00 00       CLR    >$0000
DD8A: 7F 00 00       CLR    >$0000
DD8D: 7F 00 00       CLR    >$0000
DD90: 7F 00 00       CLR    >$0000
DD93: 7F 00 F0       CLR    >$00F0
DD96: 7F 00 F0       CLR    >$00F0
DD99: 7F 00 00       CLR    >$0000
DD9C: 7F 00 00       CLR    >$0000
DD9F: 7F 00 00       CLR    >$0000
DDA2: 7F 00 00       CLR    >$0000
DDA5: 7F 00 F0       CLR    >$00F0
DDA8: 7F 00 F0       CLR    >$00F0
...
DDC9: 7F 00 F0       CLR    >$00F0
DDCC: 7F 00 F0       CLR    >$00F0
DDCF: 01 10 30       OIM    #$10;$30
DDD2: 01 0A 3D       OIM    #$0A;$3D
DDD5: 01 10 30       OIM    #$10;$30
DDD8: 7F 00 00       CLR    >$0000
DDDB: 7F 00 F0       CLR    >$00F0
DDDE: 7F 00 F0       CLR    >$00F0
DDE1: 0B 05 2E       TIM    #$05;$2E
DDE4: 08 08          ASL    $08
DDE6: 28 0B          BVC    $DDF3
DDE8: 05 2E 7F       EIM    #$2E;$7F
DDEB: 00 00          NEG    $00
DDED: 7F 00 F0       CLR    >$00F0
DDF0: 7F 00 F0       CLR    >$00F0
DDF3: 0B F9 1E       TIM    #$F9;$1E
DDF6: 08 FC          ASL    $FC
DDF8: 18             FCB    $18
DDF9: 0B F9 1E       TIM    #$F9;$1E
DDFC: 7F 00 00       CLR    >$0000
DDFF: 7F 00 F0       CLR    >$00F0
DE02: 7F 00 F0       CLR    >$00F0
DE05: 06 E5          ROR    $E5
DE07: 20 8C          BRA    $DD95
DE09: E6 23          LDB    $3,Y
DE0B: 06 E5          ROR    $E5
DE0D: 20 7F          BRA    $DE8E
DE0F: 00 00          NEG    $00
DE11: 7F 00 F0       CLR    >$00F0
DE14: 7F 00 F0       CLR    >$00F0
DE17: 01 F6 2F       OIM    #$F6;$2F
DE1A: 01 F2 3E       OIM    #$F2;$3E
DE1D: 01 F6 2F       OIM    #$F6;$2F
DE20: 7F 00 00       CLR    >$0000
DE23: 7F 00 F0       CLR    >$00F0
DE26: 7F 00 F0       CLR    >$00F0
DE29: 06 EE          ROR    $EE
DE2B: 24 8C          BCC    $DDB9
DE2D: F0 26 06       SUBB   $2606
DE30: F6 26 7F       LDB    $267F
DE33: 00 00          NEG    $00
DE35: 7F 00 F0       CLR    >$00F0
DE38: 7F 00 F0       CLR    >$00F0
DE3B: 7F 00 00       CLR    >$0000
DE3E: 7F 00 00       CLR    >$0000
DE41: 7F 00 00       CLR    >$0000
DE44: 7F 00 00       CLR    >$0000
DE47: 7F 00 F0       CLR    >$00F0
DE4A: 7F 00 F0       CLR    >$00F0
DE4D: 7F 00 00       CLR    >$0000
DE50: 7F 00 00       CLR    >$0000
DE53: 7F 00 00       CLR    >$0000
DE56: 7F 00 00       CLR    >$0000
DE59: 7F 00 F0       CLR    >$00F0
DE5C: 7F 00 F0       CLR    >$00F0
DE5F: 7F 00 00       CLR    >$0000
DE62: 7F 00 00       CLR    >$0000
DE65: 7F 00 00       CLR    >$0000
DE68: 7F 00 00       CLR    >$0000
DE6B: 7F 00 F0       CLR    >$00F0
DE6E: 7F 00 F0       CLR    >$00F0
DE71: 7F 00 00       CLR    >$0000
DE74: 7F 00 00       CLR    >$0000
DE77: 7F 00 00       CLR    >$0000
DE7A: 7F 00 00       CLR    >$0000
DE7D: 7F 00 F0       CLR    >$00F0
DE80: 7F 00 F0       CLR    >$00F0
DE83: 7F 00 00       CLR    >$0000
DE86: 7F 00 00       CLR    >$0000
DE89: 7F 00 00       CLR    >$0000
DE8C: 7F 00 00       CLR    >$0000
DE8F: 7F 00 F0       CLR    >$00F0
DE92: 7F 00 F0       CLR    >$00F0
DE95: 7F 00 00       CLR    >$0000
DE98: 7F 00 00       CLR    >$0000
DE9B: 7F 00 00       CLR    >$0000
DE9E: 7F 00 00       CLR    >$0000
DEA1: 7F 00 F0       CLR    >$00F0
DEA4: 7F 00 F0       CLR    >$00F0
...
DEB9: 7F 00 00       CLR    >$0000
DEBC: 7F 00 00       CLR    >$0000
DEBF: 7F 00 00       CLR    >$0000
DEC2: 7F 00 00       CLR    >$0000
DEC5: 7F 00 F0       CLR    >$00F0
DEC8: 7F 00 F0       CLR    >$00F0
DECB: 7F 00 00       CLR    >$0000
DECE: 7F 00 00       CLR    >$0000
DED1: 7F 00 00       CLR    >$0000
DED4: 7F 00 00       CLR    >$0000
DED7: 7F 00 F0       CLR    >$00F0
DEDA: 7F 00 F0       CLR    >$00F0
DEDD: 7F 00 00       CLR    >$0000
DEE0: 7F 00 00       CLR    >$0000
DEE3: 7F 00 00       CLR    >$0000
DEE6: 7F 00 00       CLR    >$0000
DEE9: 7F 00 F0       CLR    >$00F0
DEEC: 7F 00 F0       CLR    >$00F0
DEEF: 7F 00 00       CLR    >$0000
DEF2: 7F 00 00       CLR    >$0000
DEF5: 7F 00 00       CLR    >$0000
DEF8: 05 0E 00       EIM    #$0E;$00
DEFB: 04 18          LSR    $18
DEFD: FD 00 1E       STD    >$001E
DF00: 00 7F          NEG    $7F
DF02: 00 00          NEG    $00
DF04: 7F 00 00       CLR    >$0000
DF07: 7F 00 00       CLR    >$0000
DF0A: 00 0D          NEG    $0D
DF0C: 18             FCB    $18
DF0D: 03 10          COM    $10
DF0F: 20 05          BRA    $DF16
DF11: 10 18          FCB    $10,$18
DF13: 7F             FCB    $7F
DF14: 00             FCB    $00
DF15: 00             FCB    $00
DF16: 7F             FCB    $7F
...
DF1F: 04 00          LSR    $00
DF21: 38             FCB    $38
DF22: 01 00 38       OIM    #$00;$38
DF25: 7F 00 00       CLR    >$0000
DF28: 7F 00 00       CLR    >$0000
DF2B: 7F 00 00       CLR    >$0000
DF2E: 01 F0 3D       OIM    #$F0;$3D
DF31: 04 00          LSR    $00
DF33: 38             FCB    $38
DF34: 01 00 3C       OIM    #$00;$3C
DF37: 7F 00 00       CLR    >$0000
DF3A: 7F 00 00       CLR    >$0000
DF3D: 7F 00 00       CLR    >$0000
DF40: 01 F0 3C       OIM    #$F0;$3C
DF43: 04 00          LSR    $00
DF45: 37 01          PULU   CC
DF47: 00 3B          NEG    $3B
DF49: 7F 00 00       CLR    >$0000
DF4C: 7F 00 00       CLR    >$0000
DF4F: 7F 00 00       CLR    >$0000
DF52: 01 F0 3D       OIM    #$F0;$3D
DF55: 04 00          LSR    $00
DF57: 37 01          PULU   CC
DF59: 00 3B          NEG    $3B
DF5B: 7F 00 00       CLR    >$0000
DF5E: 7F 00 00       CLR    >$0000
DF61: 7F 00 00       CLR    >$0000
DF64: 01 F0 3C       OIM    #$F0;$3C
DF67: 04 00          LSR    $00
DF69: 37 01          PULU   CC
DF6B: 00 3B          NEG    $3B
DF6D: 7F 00 00       CLR    >$0000
DF70: 7F 00 00       CLR    >$0000
DF73: 7F 00 00       CLR    >$0000
DF76: 02 F0 3C       AIM    #$F0;$3C
DF79: 04 00          LSR    $00
DF7B: 39             RTS
DF7C: 81 00          CMPA   #$00
DF7E: 3C 7F          CWAI   #$7F
DF80: 00 00          NEG    $00
DF82: 7F 00 00       CLR    >$0000
DF85: 7F 00 00       CLR    >$0000
DF88: 02 F0 3B       AIM    #$F0;$3B
DF8B: 04 00          LSR    $00
DF8D: 38             FCB    $38
DF8E: 81 00          CMPA   #$00
DF90: 3B             RTI
DF91: 7F 00 00       CLR    >$0000
DF94: 7F 00 00       CLR    >$0000
DF97: 7F 00 00       CLR    >$0000
DF9A: 02 F0 3C       AIM    #$F0;$3C
DF9D: 04 00          LSR    $00
DF9F: 39             RTS
DFA0: 81 00          CMPA   #$00
DFA2: 3C 7F          CWAI   #$7F
DFA4: 00 00          NEG    $00
DFA6: 7F 00 00       CLR    >$0000
DFA9: 7F 00 00       CLR    >$0000
DFAC: 02 F0 3B       AIM    #$F0;$3B
DFAF: 04 00          LSR    $00
DFB1: 38             FCB    $38
DFB2: 81 00          CMPA   #$00
DFB4: 3B             RTI
DFB5: 7F 00 00       CLR    >$0000
DFB8: 7F 00 00       CLR    >$0000
DFBB: 7F 00 00       CLR    >$0000
DFBE: 7F 00 00       CLR    >$0000
DFC1: 7F 00 F0       CLR    >$00F0
DFC4: 7F 00 F0       CLR    >$00F0
DFC7: 7F 00 00       CLR    >$0000
DFCA: 7F 00 00       CLR    >$0000
DFCD: 7F 00 00       CLR    >$0000
DFD0: 05 08 2E       EIM    #$08;$2E
DFD3: 05 08 2E       EIM    #$08;$2E
DFD6: 05 08 2A       EIM    #$08;$2A
DFD9: 05 08 2A       EIM    #$08;$2A
DFDC: 00 08          NEG    $08
DFDE: 28 00          BVC    $DFE0
DFE0: 08 28          ASL    $28
DFE2: 01 08 28       OIM    #$08;$28
DFE5: 01 08 28       OIM    #$08;$28
DFE8: 05 05 31       EIM    #$05;$31
DFEB: 05 07 2C       EIM    #$07;$2C
DFEE: 7F 00 00       CLR    >$0000
DFF1: 7F 00 00       CLR    >$0000
DFF4: 7F 00 00       CLR    >$0000
DFF7: 7F 00 00       CLR    >$0000
DFFA: 7F 00 00       CLR    >$0000
DFFD: 85 10          BITA   #$10
DFFF: 15             FCB    $15
E000: 02 08 08       AIM    #$08;$08
E003: 7F 00 00       CLR    >$0000
E006: 7F 00 00       CLR    >$0000
E009: 7F 00 00       CLR    >$0000
E00C: 7F 00 00       CLR    >$0000
E00F: 7F 00 00       CLR    >$0000
E012: 7F 00 00       CLR    >$0000
E015: 7F 00 00       CLR    >$0000
E018: 07 1A          ASR    $1A
E01A: 28 08          BVC    $E024
E01C: F0 18 89       SUBB   $1889
E01F: F4 30 09       ANDB   $3009
E022: 1A 22          ORCC   #$22
E024: 7F 00 00       CLR    >$0000
E027: 7F 00 00       CLR    >$0000
E02A: 89 F8          ADCA   #$F8
E02C: 32 7F          LEAS   -$1,S
E02E: 00 00          NEG    $00
E030: 0E 10          JMP    $10
...
E039: 09 FE          ROL    $FE
E03B: 3E             FCB    $3E
E03C: 7F 00 00       CLR    >$0000
E03F: 7F 00 00       CLR    >$0000
E042: 7F 00 00       CLR    >$0000
E045: 09 FE          ROL    $FE
E047: 32 09          LEAS   $9,X
E049: F4 30 09       ANDB   $3009
E04C: FC 32 0D       LDD    $320D
E04F: F9 1A 0D       ADCB   $1A0D
E052: 0D 21          TST    $21
E054: 8F             FCB    $8F
E055: 08 1E          ASL    $1E
E057: 7F 00 00       CLR    >$0000
E05A: 8F             FCB    $8F
E05B: F6 38 7F       LDB    $387F
E05E: 05 38 91       EIM    #$38;$91
E061: F0 14 92       SUBB   $1492
E064: F8 30 93       EORB   $3093
E067: 22 00          BHI    $E069
E069: 94 04          ANDA   $04
E06B: 04 6C          LSR    $6C
...
E07B: FF FF FF       STU    $FFFF
E07E: FF FF 8E       STU    $FF8E
E081: E0 89 D6 36    SUBB   -$29CA,X
E085: 58             ASLB
E086: AD 95          JSR    [B,X]
E088: 39             RTS
E089: E0 91          SUBB   [,X++]
E08B: E0 9D E0 9D    SUBB   [$C12C,PCR]
E08F: E0 97          SUBB   [E,X]
...
E3ED: 00 30          NEG    $30
E3EF: 00 32          NEG    $32
E3F1: E8 ED FC 0A    EORB   $DFFF,PCR
E3F5: 42             FCB    $42
...
EA14: 00 00          NEG    $00
EA16: 00 00          NEG    $00
EA18: 01 FC 01       OIM    #$FC;$01
EA1B: 01 03 FC       OIM    #$03;$FC
EA1E: 02 02 04       AIM    #$02;$04
EA21: FC 03 03       LDD    $0303
EA24: 07 9C          ASR    $9C
EA26: 04 04          LSR    $04
EA28: 07 FC          ASR    $FC
EA2A: 05 05 08       EIM    #$05;$08
EA2D: 8C 06 06       CMPX   #$0606
EA30: 08 FC          ASL    $FC
EA32: 07 07          ASR    $07
EA34: 09 F4          ROL    $F4
EA36: 08 08          ASL    $08
...
EAF0: 00 00          NEG    $00
EAF2: 00 02          NEG    $02
EAF4: 05 02 08       EIM    #$02;$08
EAF7: 01 15 01       OIM    #$15;$01
EAFA: EB 02          ADDB   $2,X
EAFC: EB 34          ADDB   -$C,Y
EAFE: EB 70          ADDB   -$10,S
EB00: EB F2          ADDB   Illegal Postbyte
EB02: 00 7F          NEG    $7F
EB04: 7F 7F 7F       CLR    $7F7F
EB07: 00 00          NEG    $00
EB09: 00 00          NEG    $00
EB0B: FF 00 10       STU    >$0010
EB0E: 00 00          NEG    $00
EB10: FF 00 00       STU    >$0000
EB13: 00 00          NEG    $00
EB15: FF 00 10       STU    >$0010
EB18: 00 00          NEG    $00
EB1A: FF 00 00       STU    >$0000
EB1D: 00 00          NEG    $00
EB1F: FF 00 10       STU    >$0010
EB22: 00 00          NEG    $00
EB24: FF 00 00       STU    >$0000
EB27: 00 00          NEG    $00
EB29: FF 00 10       STU    >$0010
EB2C: 00 00          NEG    $00
EB2E: FF 00 00       STU    >$0000
EB31: 00 00          NEG    $00
EB33: FF 00 7F       STU    >$007F
EB36: 7F 7F 7F       CLR    $7F7F
EB39: 00 34          NEG    $34
EB3B: 00 00          NEG    $00
EB3D: FF 00 FF       STU    >$00FF
EB40: 00 00          NEG    $00
EB42: FF 00 C8       STU    >$00C8
EB45: 00 00          NEG    $00
EB47: FF 00 FF       STU    >$00FF
EB4A: 00 00          NEG    $00
EB4C: FF 00 C8       STU    >$00C8
EB4F: 00 00          NEG    $00
EB51: FF 00 FF       STU    >$00FF
EB54: 00 00          NEG    $00
EB56: FF 00 FF       STU    >$00FF
EB59: 00 00          NEG    $00
EB5B: FF 00 C8       STU    >$00C8
EB5E: 00 00          NEG    $00
EB60: FF 00 FF       STU    >$00FF
EB63: 00 00          NEG    $00
EB65: FF 00 FF       STU    >$00FF
EB68: 00 00          NEG    $00
EB6A: FF 00 FF       STU    >$00FF
EB6D: 00 00          NEG    $00
EB6F: FF 00 7F       STU    >$007F
EB72: 7F 7F 7F       CLR    $7F7F
EB75: 00 FF          NEG    $FF
EB77: 80 00          SUBA   #$00
EB79: FF 00 80       STU    >$0080
EB7C: 80 00          SUBA   #$00
EB7E: FF 00 FF       STU    >$00FF
EB81: 80 00          SUBA   #$00
EB83: FF 00 80       STU    >$0080
EB86: 80 00          SUBA   #$00
EB88: FF 00 FF       STU    >$00FF
EB8B: 80 00          SUBA   #$00
EB8D: FF 00 80       STU    >$0080
EB90: 80 00          SUBA   #$00
EB92: FF 00 FF       STU    >$00FF
EB95: 80 00          SUBA   #$00
EB97: FF 00 80       STU    >$0080
EB9A: 80 00          SUBA   #$00
EB9C: FF 00 FF       STU    >$00FF
EB9F: 80 00          SUBA   #$00
EBA1: FF 00 80       STU    >$0080
EBA4: 80 00          SUBA   #$00
EBA6: FF 00 FF       STU    >$00FF
EBA9: 80 00          SUBA   #$00
EBAB: FF 00 80       STU    >$0080
EBAE: 80 00          SUBA   #$00
EBB0: FF 00 FF       STU    >$00FF
EBB3: 80 00          SUBA   #$00
EBB5: FF 00 80       STU    >$0080
EBB8: 80 00          SUBA   #$00
EBBA: FF 00 FF       STU    >$00FF
EBBD: 80 00          SUBA   #$00
EBBF: FF 00 80       STU    >$0080
EBC2: 00 00          NEG    $00
EBC4: FF 00 FF       STU    >$00FF
EBC7: 80 00          SUBA   #$00
EBC9: FF 00 FF       STU    >$00FF
EBCC: 00 00          NEG    $00
EBCE: FF 00 00       STU    >$0000
EBD1: 00 00          NEG    $00
EBD3: FF 00 FF       STU    >$00FF
EBD6: 00 00          NEG    $00
EBD8: FF 00 00       STU    >$0000
EBDB: 00 00          NEG    $00
EBDD: 88 00          EORA   #$00
EBDF: FF 00 00       STU    >$0000
EBE2: 88 00          EORA   #$00
EBE4: 00 00          NEG    $00
EBE6: 00 FF          NEG    $FF
EBE8: 00 FF          NEG    $FF
...
EBF0: 00 00          NEG    $00
EBF2: 00 7F          NEG    $7F
EBF4: 7F 7F 7F       CLR    $7F7F
EBF7: 00 00          NEG    $00
EBF9: 00 00          NEG    $00
EBFB: FF 00 00       STU    >$0000
EBFE: 00 00          NEG    $00
EC00: FF 00 00       STU    >$0000
EC03: 00 00          NEG    $00
EC05: FF 00 00       STU    >$0000
EC08: 00 00          NEG    $00
EC0A: FF 00 00       STU    >$0000
EC0D: 00 00          NEG    $00
EC0F: FF 00 57       STU    >$0057
EC12: 00 00          NEG    $00
EC14: B0 00 00       SUBA   >$0000
EC17: 00 00          NEG    $00
EC19: B0 00 FF       SUBA   >$00FF
EC1C: 00 00          NEG    $00
EC1E: 00 00          NEG    $00
EC20: 00 00          NEG    $00
EC22: 00 00          NEG    $00
...
EC2A: EC 5C          LDD    -$4,U
EC2C: 00 01          NEG    $01
EC2E: 02 03 04       AIM    #$03;$04
EC31: 05 06 07       EIM    #$06;$07
EC34: 08 09          ASL    $09
EC36: 00 0A          NEG    $0A
EC38: 0B 0C 0D       TIM    #$0C;$0D
EC3B: 0E 0F          JMP    $0F
EC3D: 10 11          FCB    $10,$11
EC3F: 12             NOP
EC40: 13             SYNC
EC41: 00 00          NEG    $00
EC43: 14             SEXW
EC44: 15             FCB    $15
EC45: 16 17 18       LBRA   $0360
EC48: 19             DAA
EC49: 1A 1B          ORCC   #$1B
EC4B: 1C 1E          ANDCC  #$1E
EC4D: 1D             SEX
...
EC60: 30 31          LEAX   -$F,Y
EC62: 32 33          LEAS   -$D,Y
EC64: 34 35          PSHS   Y,X,B,CC
EC66: 40             NEGA
EC67: 00 40          NEG    $40
EC69: 01 40 02       OIM    #$40;$02
EC6C: 40             NEGA
EC6D: 03 40          COM    $40
EC6F: 04 40          LSR    $40
EC71: 05 40 06       EIM    #$40;$06
EC74: 40             NEGA
EC75: 07 40          ASR    $40
EC77: 08 40          ASL    $40
EC79: 09 40          ROL    $40
EC7B: 0A 40          DEC    $40
EC7D: 0B 40 0C       TIM    #$40;$0C
EC80: 40             NEGA
EC81: 0D 40          TST    $40
EC83: 0E 40          JMP    $40
EC85: 0F 40          CLR    $40
EC87: 10 40          NEGD
EC89: 11 40          FCB    $11,$40
EC8B: 12             FCB    $12
EC8C: 40             FCB    $40
EC8D: 13             FCB    $13
EC8E: 40             FCB    $40
...
EDAC: 07 10          ASR    $10
EDAE: 08 90          ASL    $90
EDB0: 10 03          FCB    $10,$03
EDB2: 07             FCB    $07
EDB3: 0D             FCB    $0D
EDB4: ED CC 07       STQ    $EDBE,PCR
EDB7: 10 08          FCB    $10,$08
EDB9: 90 10          SUBW   $10
EDBB: 03 07          COM    $07
EDBD: 0E ED          JMP    $ED
EDBF: D2 07          SBCB   $07
EDC1: 10 08          FCB    $10,$08
EDC3: 90 10          SUBW   $10
EDC5: 03 07          COM    $07
EDC7: 0F ED          CLR    $ED
EDC9: D8 FF          EORB   $FF
EDCB: FF 05 06       STU    $0506
EDCE: 06 08          ROR    $08
EDD0: 07 0A          ASR    $0A
EDD2: 07 0A          ASR    $0A
EDD4: 05 06 06       EIM    #$06;$06
EDD7: 08 06          ASL    $06
EDD9: 08 07          ASL    $07
EDDB: 0A 05          DEC    $05
EDDD: 06 32          ROR    $32
EDDF: 7F FC 0B       CLR    $FC0B
EDE2: 04 10          LSR    $10
EDE4: 83 02 04       SUBD   #$0204
EDE7: 26 24          BNE    $EE0D
...
EED7: EF 55          STU    -$B,U
EED9: EF F5          STU    [B,S]
EEDB: F0 75 F1       SUBB   $75F1
EEDE: 15             FCB    $15
EEDF: 00 00          NEG    $00
EEE1: F1 35 F1       CMPB   $35F1
EEE4: 55             FCB    $55
EEE5: EF 35          STU    -$B,Y
EEE7: EF 55          STU    -$B,U
EEE9: F0 15 F0       SUBB   $15F0
EEEC: 95 F1          BITA   $F1
EEEE: 15             FCB    $15
EEEF: EF 95          STU    [B,X]
EEF1: F1 35 F1       CMPB   $35F1
EEF4: 75 EF 35 EF    EIM    #$EF,$35EF
EEF8: 55             FCB    $55
EEF9: F0 35 F0       SUBB   $35F0
EEFC: B5 F1 15       BITA   $F115
EEFF: EF D5          STU    [B,U]
EF01: F1 35 F1       CMPB   $35F1
EF04: 95 EF          BITA   $EF
EF06: 35 EF          PULS   CC,D,DP,Y,U,PC
EF08: 55             FCB    $55
EF09: F0 55 F0       SUBB   $55F0
EF0C: D5 EF          BITB   $EF
EF0E: 75 EF B5 F1    EIM    #$EF,$B5F1
EF12: 35 F1          PULS   CC,X,Y,U,PC
EF14: D5 F1          BITB   $F1
EF16: F5 F2 E5       BITB   $F2E5
EF19: F2 E5 F2       SBCB   $E5F2
EF1C: E5 F2          BITB   Illegal Postbyte
EF1E: E5 F2          BITB   Illegal Postbyte
EF20: E5 F2          BITB   Illegal Postbyte
EF22: E5 F2          BITB   Illegal Postbyte
EF24: E5 EF          BITB   ,--W
EF26: 35 EF          PULS   CC,D,DP,Y,U,PC
EF28: 55             FCB    $55
EF29: F0 15 F0       SUBB   $15F0
EF2C: F5 EF 75       BITB   $EF75
EF2F: EF 95          STU    [B,X]
EF31: F1 35 F1       CMPB   $35F1
EF34: 55             FCB    $55
EF35: 00 00          NEG    $00
EF37: 0B FA 07       TIM    #$FA;$07
EF3A: D7 04          STB    $04
EF3C: 84 02          ANDA   #$02
EF3E: 17 05 3B       LBSR   $F47C
EF41: 07 3F          ASR    $3F
EF43: 00 00          NEG    $00
EF45: 07 57          ASR    $57
EF47: 08 8A          ASL    $8A
EF49: 0F FF          CLR    $FF
EF4B: 0A F3          DEC    $F3
EF4D: 0B BA 03       TIM    #$BA;$03
EF50: 1F 0D          TFR    D,0
EF52: FA 05 C5       ORB    $05C5
EF55: 00 00          NEG    $00
EF57: 0D FA          TST    $FA
EF59: 07 D7          ASR    $D7
EF5B: 04 84          LSR    $84
EF5D: 01 63 04       OIM    #$63;$04
EF60: B6 00 F6       LDA    >$00F6
EF63: 00 00          NEG    $00
EF65: 07 57          ASR    $57
EF67: 08 8A          ASL    $8A
EF69: 0F FF          CLR    $FF
EF6B: 03 A3          COM    $A3
EF6D: 0B BA 03       TIM    #$BA;$03
EF70: 1F 06          TFR    D,W
EF72: E6 00          LDB    $0,X
EF74: 50             NEGB
EF75: 00 00          NEG    $00
...
EF89: 0F FF          CLR    $FF
EF8B: 03 44          COM    $44
EF8D: 0B FA 05       TIM    #$FA;$05
EF90: 70 07 90       NEG    $0790
EF93: 0B BC 00       TIM    #$BC;$00
EF96: 00 0B          NEG    $0B
EF98: FA 07 D7       ORB    $07D7
EF9B: 04 84          LSR    $84
EF9D: 04 14          LSR    $14
EF9F: 07 15          ASR    $15
EFA1: 0B 16 00       TIM    #$16;$00
EFA4: 00 05          NEG    $05
EFA6: 51             FCB    $51
EFA7: 0A A5          DEC    $A5
EFA9: 0F FB          CLR    $FB
...
EFC9: 0E EF          JMP    $EF
EFCB: 0A F3          DEC    $F3
EFCD: 0B BC 03       TIM    #$BC;$03
EFD0: 1F 0D          TFR    D,0
EFD2: FA 05 C5       ORB    $05C5
EFD5: 00 00          NEG    $00
EFD7: 06 C4          ROR    $C4
EFD9: 05 91 02       EIM    #$91;$02
EFDC: 50             NEGB
EFDD: 07 06          ASR    $06
EFDF: 0A 19          DEC    $19
EFE1: 0D 1C          TST    $1C
...
EFE9: 0F FF          CLR    $FF
EFEB: 0A F3          DEC    $F3
EFED: 0B BA 03       TIM    #$BA;$03
EFF0: 1F 0D          TFR    D,0
EFF2: F3 05 C5       ADDD   $05C5
EFF5: 00 00          NEG    $00
EFF7: 09 E8          ROL    $E8
EFF9: 07 D7          ASR    $D7
EFFB: 06 A6          ROR    $A6
EFFD: 02 22 03       AIM    #$22;$03
F000: 23 05          BLS    $F007
F002: 36 00          PSHU   
F004: 00 05          NEG    $05
F006: 44             LSRA
...
F009: 0F FF          CLR    $FF
F00B: 00 F0          NEG    $F0
F00D: 0B FA 04       TIM    #$FA;$04
F010: 84 0A          ANDA   #$0A
F012: BC 02 62       CMPX   $0262
F015: 00 00          NEG    $00
F017: 09 E8          ROL    $E8
F019: 07 D7          ASR    $D7
F01B: 06 A6          ROR    $A6
...
F029: 00 F8          NEG    $F8
F02B: 00 D0          NEG    $D0
F02D: 0B FA 04       TIM    #$FA;$04
F030: 84 00          ANDA   #$00
F032: B5 02 62       BITA   $0262
F035: 00 00          NEG    $00
F037: 09 E8          ROL    $E8
F039: 07 D7          ASR    $D7
F03B: 06 A6          ROR    $A6
F03D: 00 32          NEG    $32
F03F: 01 63 03       OIM    #$63;$03
F042: 96 00          LDA    $00
F044: 00 05          NEG    $05
F046: 54             LSRB
F047: 07 75          ASR    $75
F049: 0F FD          CLR    $FD
F04B: 00 F0          NEG    $F0
F04D: 0B FA 04       TIM    #$FA;$04
F050: 84 0B          ANDA   #$0B
F052: B9 02 62       ADCA   $0262
F055: 00 00          NEG    $00
F057: 09 E8          ROL    $E8
F059: 07 D7          ASR    $D7
F05B: 06 A6          ROR    $A6
F05D: 03 06          COM    $06
F05F: 05 0A 07       EIM    #$0A;$07
F062: 1E 00          EXG    D,D
F064: 00 00          NEG    $00
F066: 30 05          LEAX   $5,X
F068: A0 0B          SUBA   $B,X
F06A: F2 00 F0       SBCB   >$00F0
F06D: 0B FA 04       TIM    #$FA;$04
F070: 84 09          ANDA   #$09
F072: D1 02          CMPB   $02
F074: 62 00 00       AIM    #$00;$0,X
F077: 03 81          COM    $81
F079: 02 60 02       AIM    #$60;$02
F07C: 41             FCB    $41
F07D: 02 03 05       AIM    #$03;$05
F080: 38             FCB    $38
F081: 07 4A          ASR    $4A
F083: 00 00          NEG    $00
F085: 05 45 07       EIM    #$45;$07
F088: 67 0F          ASR    $F,X
F08A: FF 00 F0       STU    >$00F0
F08D: 05 A2 02       EIM    #$A2;$02
F090: 51             FCB    $51
F091: 09 9C          ROL    $9C
F093: 00 20          NEG    $20
F095: 00 00          NEG    $00
F097: 03 81          COM    $81
F099: 02 60 02       AIM    #$60;$02
F09C: 40             NEGA
F09D: 03 12          COM    $12
F09F: 06 14          ROR    $14
F0A1: 08 27          ASL    $27
F0A3: 00 00          NEG    $00
F0A5: 05 45 07       EIM    #$45;$07
F0A8: 67 0F          ASR    $F,X
F0AA: FF 00 F0       STU    >$00F0
F0AD: 05 A2 02       EIM    #$A2;$02
F0B0: 51             FCB    $51
F0B1: 09 9C          ROL    $9C
F0B3: 00 20          NEG    $20
F0B5: 00 00          NEG    $00
F0B7: 03 81          COM    $81
F0B9: 02 60 02       AIM    #$60;$02
F0BC: 41             FCB    $41
F0BD: 03 33          COM    $33
F0BF: 05 56 07       EIM    #$56;$07
F0C2: 79 00 00       ROL    >$0000
F0C5: 05 45 06       EIM    #$45;$06
F0C8: 57             ASRB
F0C9: 0F FF          CLR    $FF
F0CB: 00 F0          NEG    $F0
F0CD: 05 A2 02       EIM    #$A2;$02
F0D0: 51             FCB    $51
F0D1: 09 9C          ROL    $9C
F0D3: 00 20          NEG    $20
F0D5: 00 00          NEG    $00
F0D7: 03 81          COM    $81
F0D9: 02 60 02       AIM    #$60;$02
F0DC: 40             NEGA
F0DD: 01 12 03       OIM    #$12;$03
F0E0: 24 05          BCC    $F0E7
F0E2: 35 00          PULS   
F0E4: 00 05          NEG    $05
F0E6: 45             FCB    $45
...
F0E9: 0F FF          CLR    $FF
F0EB: 00 F0          NEG    $F0
F0ED: 05 A2 02       EIM    #$A2;$02
F0F0: 51             FCB    $51
F0F1: 09 9C          ROL    $9C
F0F3: 00 20          NEG    $20
F0F5: 00 00          NEG    $00
F0F7: 05 B2 04       EIM    #$B2;$04
F0FA: 81 04          CMPA   #$04
F0FC: 71 01 66 02    OIM    #$01,$6602
F100: 8A 05          ORA    #$05
F102: CF             FCB    $CF
F103: 00 00          NEG    $00
F105: 05 45 07       EIM    #$45;$07
F108: 67 0F          ASR    $F,X
F10A: FF 00 F0       STU    >$00F0
F10D: 07 F4          ASR    $F4
F10F: 03 61          COM    $61
F111: 0A BC          DEC    $BC
F113: 02 50 00       AIM    #$50;$00
F116: 00 0B          NEG    $0B
F118: FA 09 E8       ORB    $09E8
F11B: 07 D7          ASR    $D7
F11D: 04 84          LSR    $84
F11F: 00 00          NEG    $00
F121: 02 8A 03       AIM    #$8A;$03
F124: CD 01 56 05 55 LDQ    #$01560555
F129: 0B BA 00       TIM    #$BA;$00
F12C: F0 0F FF       SUBB   $0FFF
F12F: 06 A6          ROR    $A6
F131: 07 A0          ASR    $A0
F133: 0B F0 00       TIM    #$F0;$00
F136: 00 00          NEG    $00
F138: 00 00          NEG    $00
F13A: C0 00          SUBB   #$00
F13C: 60 00          NEG    $0,X
...
F140: AA 0D          ORA    $D,X
F142: DD 07          STD    $07
F144: F0 03 33       SUBB   $0333
F147: 04 44          LSR    $44
F149: 05 55 06       EIM    #$55;$06
F14C: 66 08          ROR    $8,X
F14E: 88 02          EORA   #$02
F150: 22 05          BHI    $F157
F152: F0 02 F0       SUBB   $02F0
F155: 00 00          NEG    $00
F157: 00 00          NEG    $00
F159: 08 A6          ASL    $A6
F15B: 07 A4          ASR    $A4
F15D: 04 73          LSR    $73
F15F: 05 84 03       EIM    #$84;$03
F162: 51             FCB    $51
F163: 04 73          LSR    $73
F165: 02 42 05       AIM    #$42;$05
F168: 84 03          ANDA   #$03
F16A: 82 01          SBCA   #$01
F16C: 41             FCB    $41
F16D: 03 62          COM    $62
...
F183: 0A B0          DEC    $B0
F185: 00 BA          NEG    $BA
F187: 05 53 06       EIM    #$53;$06
F18A: 65 08 86       EIM    #$08;A,X
F18D: 04 07          LSR    $07
F18F: 00 07          NEG    $07
F191: 00 77          NEG    $77
F193: 07 70          ASR    $70
...
F1A3: 03 AD          COM    $AD
F1A5: 06 64          ROR    $64
F1A7: 05 0C 0B       EIM    #$0C;$0B
F1AA: 0F 0F          CLR    $0F
F1AC: FF 0D BF       STU    $0DBF
F1AF: 00 07          NEG    $07
F1B1: 0D E8          TST    $E8
F1B3: 08 86          ASL    $86
F1B5: 00 00          NEG    $00
...
F1C7: 07 A4          ASR    $A4
F1C9: 06 94          ROR    $94
F1CB: 05 84 04       EIM    #$84;$04
F1CE: 73 03 62       COM    $0362
F1D1: 03 52          COM    $52
F1D3: 02 31 00       AIM    #$31;$00
F1D6: 00 00          NEG    $00
F1D8: 00 0C          NEG    $0C
F1DA: E8 0A          EORB   $A,X
F1DC: D6 08          LDB    $08
...
F1E2: 94 05          ANDA   $05
F1E4: 84 04          ANDA   #$04
F1E6: 73 03 62       COM    $0362
F1E9: 03 52          COM    $52
F1EB: 02 41 01       AIM    #$41;$01
F1EE: 30 0D          LEAX   $D,X
F1F0: DE 07          LDU    $07
F1F2: 78 0A A3       ASL    $0AA3
F1F5: 00 00          NEG    $00
F1F7: 00 00          NEG    $00
F1F9: 0A F4          DEC    $F4
F1FB: 08 C1          ASL    $C1
F1FD: 06 A0          ROR    $A0
F1FF: 04 71          LSR    $71
F201: 01 40 0C       OIM    #$40;$0C
F204: 90 0A          SUBA   $0A
F206: 73 08 42       COM    $0842
F209: 07 32          ASR    $32
F20B: 05 01 00       EIM    #$01;$00
F20E: 00 0F          NEG    $0F
F210: FF 0D AF       STU    $0DAF
F213: 08 3E          ASL    $3E
F215: F3 05 F3       ADDD   $05F3
F218: 25 F3          BCS    $F20D
F21A: 45             FCB    $45
F21B: F3 65 F3       ADDD   $65F3
F21E: 85 F3          BITA   #$F3
F220: E5 F3          BITB   [,--S]
F222: C5 F4          BITB   #$F4
F224: 65 F3 05       EIM    #$F3;$5,X
F227: F4 05 F4       ANDB   $05F4
F22A: 25 F4          BCS    $F220
F22C: 45             FCB    $45
F22D: F3 85 F3       ADDD   $85F3
F230: E5 F3          BITB   [,--S]
F232: C5 F3          BITB   #$F3
F234: A5 F4          BITA   [,S]
F236: 85 F4          BITA   #$F4
F238: 05 F4 25       EIM    #$F4;$25
F23B: F4 45 F3       ANDB   $45F3
F23E: 85 F5          BITA   #$F5
F240: 25 F5          BCS    $F237
F242: 45             FCB    $45
F243: F3 A5 F4       ADDD   $A5F4
F246: 85 F4          BITA   #$F4
F248: A5 F4          BITA   [,S]
F24A: C5 F4          BITB   #$F4
F24C: E5 F5          BITB   [B,S]
F24E: 05 F5 25       EIM    #$F5;$25
F251: F5 45 F5       BITB   $45F5
F254: 65 F3 85       EIM    #$F3;B,X
F257: F4 A5 F4       ANDB   $A5F4
F25A: C5 F5          BITB   #$F5
F25C: 05 F6 05       EIM    #$F6;$05
F25F: F3 85 F5       ADDD   $85F5
F262: 65 F5 65       EIM    #$F5;$5,S
F265: F3 85 F4       ADDD   $85F4
F268: A5 F4          BITA   [,S]
F26A: C5 F5          BITB   #$F5
F26C: 05 F6 05       EIM    #$F6;$05
F26F: F6 05 F3       LDB    $05F3
F272: 85 F5          BITA   #$F5
F274: 65 F3 85       EIM    #$F3;B,X
F277: F3 05 F4       ADDD   $05F4
F27A: C5 F5          BITB   #$F5
F27C: 05 F6 05       EIM    #$F6;$05
F27F: F6 05 F3       LDB    $05F3
F282: 85 F5          BITA   #$F5
F284: 65 F5 85       EIM    #$F5;B,X
F287: F3 05 F3       ADDD   $05F3
F28A: 45             FCB    $45
F28B: F5 C5 F5       BITB   $C5F5
F28E: E5 F6          BITB   [A,S]
F290: 05 F3 85       EIM    #$F3;$85
F293: F5 65 F5       BITB   $65F5
F296: 85 F5          BITA   #$F5
F298: A5 F3          BITA   [,--S]
F29A: 45             FCB    $45
F29B: F5 C5 F5       BITB   $C5F5
F29E: E5 F6          BITB   [A,S]
F2A0: 05 F7 65       EIM    #$F7;$65
F2A3: F5 65 F6       BITB   $65F6
F2A6: 25 F6          BCS    $F29E
F2A8: 45             FCB    $45
F2A9: F6 65 F6       LDB    $65F6
F2AC: 85 F6          BITA   #$F6
F2AE: A5 F6          BITA   [A,S]
F2B0: C5 F6          BITB   #$F6
F2B2: E5 F7          BITB   [E,S]
F2B4: 05 F7 45       EIM    #$F7;$45
F2B7: F2 E5 F2       SBCB   $E5F2
F2BA: E5 F2          BITB   Illegal Postbyte
F2BC: E5 F2          BITB   Illegal Postbyte
F2BE: E5 F2          BITB   Illegal Postbyte
F2C0: E5 F2          BITB   Illegal Postbyte
F2C2: E5 F2          BITB   Illegal Postbyte
F2C4: E5 F6          BITB   [A,S]
F2C6: 25 F6          BCS    $F2BE
F2C8: 45             FCB    $45
F2C9: F7 25 F6       STB    $25F6
F2CC: 85 F6          BITA   #$F6
F2CE: A5 F6          BITA   [A,S]
F2D0: C5 F6          BITB   #$F6
F2D2: E5 F7          BITB   [E,S]
F2D4: 05 F7 85       EIM    #$F7;$85
F2D7: F7 A5 F7       STB    $A5F7
F2DA: C5 F2          BITB   #$F2
F2DC: E5 F2          BITB   Illegal Postbyte
F2DE: E5 F2          BITB   Illegal Postbyte
F2E0: E5 F2          BITB   Illegal Postbyte
F2E2: E5 F2          BITB   Illegal Postbyte
F2E4: E5 00          BITB   $0,X
F2E6: 00 00          NEG    $00
F2E8: 00 00          NEG    $00
F2EA: 00 00          NEG    $00
...
F306: 00 00          NEG    $00
F308: 00 03          NEG    $03
F30A: 11 04          FCB    $11,$04
F30C: 11             FCB    $11
F30D: 06 23          ROR    $23
F30F: 08 12          ASL    $12
F311: 03 33          COM    $33
F313: 04 44          LSR    $44
F315: 05 55 05       EIM    #$55;$05
F318: 41             FCB    $41
F319: 00 30          NEG    $30
F31B: 06 66          ROR    $66
F31D: 07 77          ASR    $77
F31F: 08 88          ASL    $88
F321: 09 99          ROL    $99
F323: 02 22 00       AIM    #$22;$00
F326: 00 00          NEG    $00
F328: 00 08          NEG    $08
F32A: A7 07          STA    $7,X
F32C: 96 06          LDA    $06
F32E: 85 05          BITA   #$05
F330: 74 04 63       LSR    $0463
F333: 03 52          COM    $52
F335: 08 C5          ASL    $C5
F337: 07 B4          ASR    $B4
F339: 06 A3          ROR    $A3
F33B: 04 82          LSR    $82
F33D: 02 71 0B       AIM    #$71;$0B
F340: FA 08 C7       ORB    $08C7
F343: 0A D9          DEC    $D9
F345: 00 00          NEG    $00
F347: 02 41 03       AIM    #$41;$03
F34A: 19             DAA
F34B: 07 6D          ASR    $6D
F34D: 05 4E 00       EIM    #$4E;$00
F350: 00 01          NEG    $01
F352: 31 03          LEAY   $3,X
F354: 51             FCB    $51
F355: 03 61          COM    $61
F357: 04 72          LSR    $72
F359: 05 82 06       EIM    #$82;$06
F35C: A4 08          ANDA   $8,X
F35E: B5 09 C6       BITA   $09C6
F361: 0B D8 0D       TIM    #$D8;$0D
F364: F9 00 00       ADCB   >$0000
F367: 05 45 06       EIM    #$45;$06
F36A: 56             RORB
F36B: 08 78          ASL    $78
F36D: 0A 9A          DEC    $9A
F36F: 0E DE          JMP    $DE
...
F37F: 08 7C          ASL    $7C
F381: 07 6D          ASR    $6D
F383: 05 4E 00       EIM    #$4E;$00
F386: 00 00          NEG    $00
F388: 00 02          NEG    $02
F38A: 42             FCB    $42
F38B: 03 62          COM    $62
F38D: 05 84 04       EIM    #$84;$04
F390: 73 03 34       COM    $0334
F393: 08 A6          ASL    $A6
F395: 07 77          ASR    $77
F397: 06 66          ROR    $66
F399: 05 56 04       EIM    #$56;$04
F39C: 45             FCB    $45
F39D: 08 89          ASL    $89
F39F: 09 9A          ROL    $9A
F3A1: 06 92          ROR    $92
...
F3A5: 00 00          NEG    $00
F3A7: 00 00          NEG    $00
F3A9: 0B BB 08       TIM    #$BB;$08
F3AC: B5 0A E7       BITA   $0AE7
F3AF: 04 63          LSR    $63
F3B1: 05 84 02       EIM    #$84;$02
F3B4: 50             NEGB
F3B5: 01 40 01       OIM    #$40;$01
F3B8: 31 0D          LEAY   $D,X
F3BA: DD 04          STD    $04
F3BC: 44             LSRA
F3BD: 08 C6          ASL    $C6
...
F3C7: 00 00          NEG    $00
F3C9: 00 20          NEG    $20
F3CB: 01 30 02       OIM    #$30;$02
F3CE: 41             FCB    $41
F3CF: 02 51 03       AIM    #$51;$03
F3D2: 62 05 82       AIM    #$05;,-X
F3D5: 02 22 03       AIM    #$22;$03
F3D8: 33 04          LEAU   $4,X
F3DA: 44             LSRA
F3DB: 05 55 06       EIM    #$55;$06
F3DE: 66 07          ROR    $7,X
F3E0: 77 08 88       ASR    $0888
F3E3: 06 65          ROR    $65
F3E5: 00 00          NEG    $00
F3E7: 00 00          NEG    $00
F3E9: 0F FF          CLR    $FF
...
F3FF: 09 D3          ROL    $D3
F401: 07 0D          ASR    $0D
F403: 02 B5 00       AIM    #$B5;$00
F406: 00 0E          NEG    $0E
F408: FB 0B D8       ADDB   $0BD8
F40B: 09 B7          ROL    $B7
F40D: 08 A5          ASL    $A5
F40F: 07 95          ASR    $95
F411: 05 73 03       EIM    #$73;$03
F414: 62 01 40       AIM    #$01;$0,U
F417: 00 00          NEG    $00
F419: 03 33          COM    $33
F41B: 04 44          LSR    $44
F41D: 05 55 06       EIM    #$55;$06
F420: 66 07          ROR    $7,X
F422: 77 0A AA       ASR    $0AAA
F425: 00 00          NEG    $00
F427: 00 00          NEG    $00
F429: 05 74 02       EIM    #$74;$02
F42C: 41             FCB    $41
F42D: 03 72          COM    $72
F42F: 03 92          COM    $92
F431: 06 85          ROR    $85
F433: 04 A2          LSR    $A2
F435: 05 C3 02       EIM    #$C3;$02
F438: 22 03          BHI    $F43D
F43A: 33 04          LEAU   $4,X
F43C: 44             LSRA
F43D: 05 55 06       EIM    #$55;$06
F440: 66 07          ROR    $7,X
F442: 77 08 88       ASR    $0888
F445: 00 00          NEG    $00
F447: 00 00          NEG    $00
F449: 05 73 03       EIM    #$73;$03
F44C: 42             FCB    $42
F44D: 04 53          LSR    $53
F44F: 05 64 06       EIM    #$64;$06
F452: 83 06 75       SUBD   #$0675
F455: 07 86          ASR    $86
F457: 02 22 03       AIM    #$22;$03
F45A: 33 04          LEAU   $4,X
F45C: 44             LSRA
F45D: 05 55 06       EIM    #$55;$06
F460: 66 07          ROR    $7,X
F462: 77 07 76       ASR    $0776
F465: 00 00          NEG    $00
F467: 00 F0          NEG    $F0
F469: 00 60          NEG    $60
F46B: 00 D0          NEG    $D0
...
F479: 06 F4          ROR    $F4
F47B: 09 99          ROL    $99
F47D: 05 55 04       EIM    #$55;$04
F480: 44             LSRA
F481: 03 33          COM    $33
F483: 02 22 00       AIM    #$22;$00
F486: 00 00          NEG    $00
F488: 00 0C          NEG    $0C
F48A: C4 09          ANDB   #$09
F48C: 92 0C          SBCA   $0C
...
F4A5: 00 00          NEG    $00
F4A7: 00 00          NEG    $00
F4A9: 02 31 03       AIM    #$31;$03
F4AC: 42             FCB    $42
F4AD: 04 53          LSR    $53
F4AF: 05 64 06       EIM    #$64;$06
F4B2: 75 01 20 00    EIM    #$01,$2000
F4B6: F0 07 70       SUBB   $0770
F4B9: 07 78          ASR    $78
F4BB: 08 7B          ASL    $7B
F4BD: 0C CC          INC    $CC
F4BF: 07 77          ASR    $77
...
F4C7: 00 00          NEG    $00
F4C9: 07 85          ASR    $85
F4CB: 05 70 08       EIM    #$70;$08
F4CE: 96 09          LDA    $09
F4D0: A6 0A          LDA    $A,X
F4D2: B7 09 96       STA    $0996
F4D5: 0C C8          INC    $C8
F4D7: 06 65          ROR    $65
F4D9: 07 77          ASR    $77
F4DB: 08 87          ASL    $87
F4DD: 09 88          ROL    $88
F4DF: 07 75          ASR    $75
F4E1: 05 C6 05       EIM    #$C6;$05
F4E4: 53             COMB
F4E5: 00 00          NEG    $00
F4E7: 00 00          NEG    $00
F4E9: 02 22 06       AIM    #$22;$06
F4EC: 56             RORB
F4ED: 07 77          ASR    $77
F4EF: 09 89          ROL    $89
F4F1: 0B AB 06       TIM    #$AB;$06
F4F4: 65 0E DE       EIM    #$0E;[W,U]
F4F7: 05 54 04       EIM    #$54;$04
F4FA: 43             COMA
F4FB: 03 32          COM    $32
F4FD: 07 94          ASR    $94
F4FF: 04 34          LSR    $34
F501: 05 61 0A       EIM    #$61;$0A
F504: C4 00          ANDB   #$00
F506: 00 00          NEG    $00
F508: 00 0A          NEG    $0A
F50A: A8 09          EORA   $9,X
F50C: 97 07          STA    $07
F50E: 76 05 54       ROR    $0554
F511: 03 A2          COM    $A2
F513: 02 71 02       AIM    #$71;$02
F516: 81 04          CMPA   #$04
F518: C3 01 31       ADDD   #$0131
F51B: 02 51 0D       AIM    #$51;$0D
F51E: CD 0B AB 08 88 LDQ    #$0BAB0888
F523: 05 55 00       EIM    #$55;$00
F526: 00 0E          NEG    $0E
F528: FB 0B C8       ADDB   $0BC8
F52B: 09 B7          ROL    $B7
F52D: 08 A5          ASL    $A5
F52F: 07 95          ASR    $95
F531: 05 73 03       EIM    #$73;$03
F534: 52             FCB    $52
F535: 01 40 00       OIM    #$40;$00
F538: 00 04          NEG    $04
F53A: 62 0B 28       AIM    #$0B;$8,Y
F53D: 07 25          ASR    $25
F53F: 0C 5A          INC    $5A
F541: 05 22 08       EIM    #$22;$08
F544: 27 00          BEQ    $F546
F546: 00 00          NEG    $00
F548: 00 03          NEG    $03
F54A: 40             NEGA
...
F559: 00 60          NEG    $60
F55B: 0A A8          DEC    $A8
F55D: 0B CB 08       TIM    #$CB;$08
F560: 88 04          EORA   #$04
F562: 70 04 44       NEG    $0444
F565: 00 00          NEG    $00
F567: 00 00          NEG    $00
F569: 07 57          ASR    $57
F56B: 08 A7          ASL    $A7
F56D: 09 99          ROL    $99
F56F: 00 07          NEG    $07
F571: 05 53 02       EIM    #$53;$02
F574: 43             COMA
F575: 05 54 06       EIM    #$54;$06
F578: 65 07 77       EIM    #$07;-$9,S
F57B: 08 86          ASL    $86
F57D: 09 88          ROL    $88
F57F: 06 07          ROR    $07
F581: 06 08          ROR    $08
...
F58B: 03 43          COM    $43
F58D: 04 43          LSR    $43
F58F: 05 44 06       EIM    #$44;$06
F592: 56             RORB
F593: 07 66          ASR    $66
F595: 09 87          ROL    $87
F597: 0A 97          DEC    $97
F599: 09 96          ROL    $96
F59B: 0B A8 07       TIM    #$A8;$07
F59E: 46             RORA
F59F: 0A 78          DEC    $78
F5A1: 0B 99 05       TIM    #$99;$05
F5A4: 24 00          BCC    $F5A6
F5A6: 00 00          NEG    $00
F5A8: 00 05          NEG    $05
F5AA: 77 01 15       ASR    $0115
F5AD: 00 68          NEG    $68
F5AF: 00 57          NEG    $57
F5B1: 08 00          ASL    $00
F5B3: 0C 00          INC    $00
...
F5C7: 00 00          NEG    $00
F5C9: 03 42          COM    $42
F5CB: 05 53 06       EIM    #$53;$06
F5CE: 74 07 84       LSR    $0784
F5D1: 08 94          ASL    $94
F5D3: 0A B5          DEC    $B5
F5D5: 06 03          ROR    $03
F5D7: 0A B6          DEC    $B6
F5D9: 08 03          ASL    $03
F5DB: 06 04          ROR    $04
F5DD: 05 03 0D       EIM    #$03;$0D
F5E0: 90 0B          SUBA   $0B
F5E2: 20 04          BRA    $F5E8
F5E4: 03 00          COM    $00
F5E6: 00 06          NEG    $06
F5E8: 62 06 64       AIM    #$06;$4,S
F5EB: 07 85          ASR    $85
F5ED: 0A B6          DEC    $B6
F5EF: 04 40          LSR    $40
F5F1: 07 84          ASR    $84
F5F3: 04 53          LSR    $53
F5F5: 05 63 07       EIM    #$63;$07
F5F8: 75 09 C5 08    EIM    #$09,$C508
F5FC: 96 08          LDA    $08
F5FE: 94 09          ANDA   $09
F600: B5 00 0C       BITA   >$000C
F603: 00 00          NEG    $00
F605: 00 00          NEG    $00
F607: 06 62          ROR    $62
F609: 06 64          ROR    $64
F60B: 05 53 09       EIM    #$53;$09
F60E: B6 04 40       LDA    $0440
F611: 08 85          ASL    $85
F613: 04 53          LSR    $53
F615: 05 63 07       EIM    #$63;$07
F618: 75 07 74 08    EIM    #$07,$7408
F61C: 86 0D          LDA    #$0D
F61E: E8 08          EORB   $8,X
F620: 84 00          ANDA   #$00
F622: 00 03          NEG    $03
...
F632: 94 05          ANDA   $05
F634: 84 04          ANDA   #$04
F636: 73 03 62       COM    $0362
F639: 03 52          COM    $52
F63B: 02 41 01       AIM    #$41;$01
F63E: 30 0D          LEAX   $D,X
F640: DE 07          LDU    $07
F642: 78 0A AB       ASL    $0AAB
F645: 00 00          NEG    $00
F647: 00 00          NEG    $00
F649: 0F F9          CLR    $F9
F64B: 0C E7          INC    $E7
...
F651: 07 A4          ASR    $A4
F653: 06 94          ROR    $94
F655: 05 83 04       EIM    #$83;$04
F658: 72 03 52 02    AIM    #$03,$5202
F65C: 41             FCB    $41
F65D: 01 30 0B       OIM    #$30;$0B
F660: E7 0A          STB    $A,X
F662: C5 0C          BITB   #$0C
F664: F9 00 00       ADCB   >$0000
F667: 00 00          NEG    $00
F669: 00 F0          NEG    $F0
F66B: 00 A0          NEG    $A0
F66D: 00 50          NEG    $50
...
F673: 0F FF          CLR    $FF
F675: 0C F0          INC    $F0
F677: 02 22 04       AIM    #$22;$04
F67A: 44             LSRA
F67B: 03 33          COM    $33
F67D: 06 66          ROR    $66
F67F: 05 55 07       EIM    #$55;$07
F682: 78 09 9A       ASL    $099A
F685: 00 00          NEG    $00
F687: 00 00          NEG    $00
F689: 0C E8          INC    $E8
F68B: 0A D6          DEC    $D6
...
F693: 04 53          LSR    $53
F695: 04 73          LSR    $73
F697: 05 64 07       EIM    #$64;$07
F69A: 86 02          LDA    #$02
F69C: 41             FCB    $41
F69D: 06 75          ROR    $75
F69F: 0B CA 09       TIM    #$CA;$09
F6A2: A8 08          EORA   $8,X
F6A4: 97 00          STA    $00
F6A6: 00 00          NEG    $00
F6A8: 00 02          NEG    $02
...
F6AC: 34 04          PSHS   B
F6AE: 45             FCB    $45
F6AF: 05 56 06       EIM    #$56;$06
F6B2: 67 08          ASR    $8,X
F6B4: 89 07          ADCA   #$07
F6B6: 78 0A AB       ASL    $0AAB
F6B9: 09 9A          ROL    $9A
F6BB: 0B BC 0C       TIM    #$BC;$0C
F6BE: CD 00 00 00 00 LDQ    #$00000000
F6C3: 00 00          NEG    $00
F6C5: 00 00          NEG    $00
F6C7: 00 80          NEG    $80
F6C9: 00 90          NEG    $90
...
F6D7: 07 A4          ASR    $A4
F6D9: 06 94          ROR    $94
F6DB: 05 84 04       EIM    #$84;$04
F6DE: 73 03 62       COM    $0362
F6E1: 03 52          COM    $52
F6E3: 02 31 00       AIM    #$31;$00
F6E6: 00 00          NEG    $00
F6E8: 00 0F          NEG    $0F
F6EA: FD 0F F3       STD    $0FF3
F6ED: 0B E2 08       TIM    #$E2;$08
F6F0: D4 09          ANDB   $09
F6F2: B5 08 B5       BITA   $08B5
F6F5: 07 95          ASR    $95
F6F7: 06 84          ROR    $84
F6F9: 05 73 04       EIM    #$73;$04
F6FC: 63 03          COM    $3,X
F6FE: 52             FCB    $52
F6FF: 01 31 0F       OIM    #$31;$0F
F702: F9 01 F2       ADCB   $01F2
F705: 00 00          NEG    $00
F707: 00 00          NEG    $00
F709: 0F FD          CLR    $FD
F70B: 0F F3          CLR    $F3
F70D: 0B E2 08       TIM    #$E2;$08
F710: D4 09          ANDB   $09
F712: B5 0F 8E       BITA   $0F8E
F715: 07 95          ASR    $95
F717: 06 84          ROR    $84
F719: 05 73 04       EIM    #$73;$04
F71C: 63 03          COM    $3,X
F71E: 52             FCB    $52
F71F: 01 31 0F       OIM    #$31;$0F
F722: F9 0A 2E       ADCB   $0A2E
F725: 00 00          NEG    $00
F727: 00 00          NEG    $00
F729: 03 32          COM    $32
F72B: 04 43          LSR    $43
F72D: 05 54 06       EIM    #$54;$06
F730: 65 07 76       EIM    #$07;-$A,S
F733: 08 87          ASL    $87
F735: 09 98          ROL    $98
F737: 0A A9          DEC    $A9
F739: 0D DC          TST    $DC
F73B: 0B BA 0D       TIM    #$BA;$0D
F73E: DF 0F          STU    $0F
F740: DF 00          STU    $00
F742: B4 06 F8       ANDA   $06F8
F745: 00 00          NEG    $00
F747: 00 00          NEG    $00
F749: 0A F4          DEC    $F4
F74B: 08 C1          ASL    $C1
F74D: 06 A0          ROR    $A0
F74F: 04 71          LSR    $71
F751: 01 40 0C       OIM    #$40;$0C
F754: 90 0A          SUBA   $0A
F756: 73 08 42       COM    $0842
F759: 07 32          ASR    $32
F75B: 05 01 00       EIM    #$01;$00
F75E: 00 0F          NEG    $0F
F760: FF 0D AF       STU    $0DAF
F763: 08 3E          ASL    $3E
F765: 00 00          NEG    $00
F767: 00 00          NEG    $00
F769: 03 34          COM    $34
F76B: 07 78          ASR    $78
F76D: 04 45          LSR    $45
F76F: 05 55 06       EIM    #$55;$06
F772: 67 06          ASR    $6,X
F774: 67 03          ASR    $3,X
F776: 33 06          LEAU   $6,X
F778: 66 05          ROR    $5,X
F77A: 67 0F          ASR    $F,X
F77C: FF 0D BF       STU    $0DBF
F77F: 03 34          COM    $34
F781: 0D E8          TST    $E8
F783: 08 86          ASL    $86
F785: 00 00          NEG    $00
F787: 0F FF          CLR    $FF
F789: 0B BB 06       TIM    #$BB;$06
F78C: 66 00          ROR    $0,X
F78E: 00 09          NEG    $09
F790: 99 04          ADCA   $04
F792: 44             LSRA
...
F7E1: 00 00          NEG    $00
F7E3: 00 00          NEG    $00
F7E5: F7 F5 F8       STB    $F5F8
F7E8: 35 F8          PULS   DP,X,Y,U,PC
F7EA: 95 F8          BITA   $F8
F7EC: B5 F8 55       BITA   $F855
F7EF: F8 75 F8       EORB   $75F8
F7F2: 15             FCB    $15
F7F3: F8 D5 00       EORB   $D500
F7F6: 00 00          NEG    $00
F7F8: 00 0F          NEG    $0F
F7FA: FF 0F FB       STU    $0FFB
F7FD: 07 56          ASR    $56
F7FF: 0F AF          CLR    $AF
F801: 07 09          ASR    $09
F803: 0D 3D          TST    $3D
...
F83B: 0F FF          CLR    $FF
F83D: 00 20          NEG    $20
F83F: 02 31 02       AIM    #$31;$02
F842: 41             FCB    $41
F843: 02 51 03       AIM    #$51;$03
F846: 72 04 83 05    AIM    #$04,$8305
F84A: 94 06          ANDA   $06
F84C: 93 07          SUBD   $07
F84E: B4 0A D6       ANDA   $0AD6
F851: 0D F7          TST    $F7
F853: 00 00          NEG    $00
F855: 00 00          NEG    $00
F857: 00 00          NEG    $00
...
F893: 0F DF          CLR    $DF
F895: 00 00          NEG    $00
F897: 0B FA 07       TIM    #$FA;$07
F89A: D7 04          STB    $04
F89C: 84 02          ANDA   #$02
F89E: 17 04 19       LBSR   $FCBA
F8A1: 03 1F          COM    $1F
F8A3: 00 00          NEG    $00
F8A5: 09 32          ROL    $32
F8A7: 00 50          NEG    $50
...
F8AF: 03 1F          COM    $1F
F8B1: 0D FA          TST    $FA
F8B3: 05 C5 00       EIM    #$C5;$00
F8B6: 00 0F          NEG    $0F
F8B8: 77 0C 44       ASR    $0C44
F8BB: 09 22          ROL    $22
F8BD: 0F D7          CLR    $D7
F8BF: 0D B5          TST    $B5
F8C1: 00 00          NEG    $00
...
F8DB: 0F FF          CLR    $FF
F8DD: 00 20          NEG    $20
F8DF: 02 31 02       AIM    #$31;$02
F8E2: 41             FCB    $41
F8E3: 02 51 03       AIM    #$51;$03
F8E6: 72 04 83 05    AIM    #$04,$8305
F8EA: 94 06          ANDA   $06
F8EC: 93 07          SUBD   $07
F8EE: B4 0A D6       ANDA   $0AD6
F8F1: 0D F7          TST    $F7
F8F3: 00 00          NEG    $00
F8F5: F5 FF FF       BITB   $FFFF
F8F8: FF FF FF       STU    $FFFF
F8FB: FF FF FF       STU    $FFFF
F8FE: FF FF BD       STU    $FFBD
...
F953: BD 40 7E       JSR    $407E
F956: BD FC 3A       JSR    $FC3A
F959: 39             RTS
F95A: 5A             DECB
F95B: FF FF FF       STU    $FFFF
F95E: FF FF BD       STU    $FFBD
F961: FC 82 BD       LDD    $82BD
F964: 40             NEGA
F965: 69 BD FC 8F    ROL    [$F5F8,PCR]
F969: 39             RTS
F96A: BD FC 82       JSR    $FC82
F96D: BD 40 6F       JSR    $406F
F970: BD FC 8F       JSR    $FC8F
F973: 39             RTS
F974: BD FC 82       JSR    $FC82
F977: BD 40 8A       JSR    $408A
F97A: BD FC 8F       JSR    $FC8F
F97D: 39             RTS
F97E: BD FC 82       JSR    $FC82
F981: BD 40 8D       JSR    $408D
F984: BD FC 8F       JSR    $FC8F
F987: 39             RTS
F988: BD BB 40       JSR    $BB40
F98B: BD 40 12       JSR    $4012
F98E: BD BB 4D       JSR    $BB4D
F991: 39             RTS
F992: BD FC 82       JSR    $FC82
F995: BD 40 63       JSR    $4063
F998: BD FC 8F       JSR    $FC8F
F99B: 39             RTS
F99C: BD BB 40       JSR    $BB40
F99F: BD 40 15       JSR    $4015
F9A2: BD BB 4D       JSR    $BB4D
F9A5: 39             RTS
F9A6: BD FC 82       JSR    $FC82
F9A9: BD 40 9F       JSR    $409F
F9AC: BD FC 8F       JSR    $FC8F
F9AF: 39             RTS
F9B0: BD BB 40       JSR    $BB40
F9B3: BD 40 18       JSR    $4018
F9B6: BD BB 4D       JSR    $BB4D
F9B9: 39             RTS
F9BA: BD BB 40       JSR    $BB40
F9BD: BD 40 1B       JSR    $401B
F9C0: BD BB 4D       JSR    $BB4D
F9C3: 39             RTS
F9C4: BD BB 40       JSR    $BB40
F9C7: BD 40 1E       JSR    $401E
F9CA: BD BB 4D       JSR    $BB4D
F9CD: 39             RTS
F9CE: BD BB 40       JSR    $BB40
F9D1: BD 40 21       JSR    $4021
F9D4: BD BB 4D       JSR    $BB4D
F9D7: 39             RTS
F9D8: BD BB 40       JSR    $BB40
F9DB: BD 40 24       JSR    $4024
F9DE: BD BB 4D       JSR    $BB4D
F9E1: 39             RTS
F9E2: BD BB 40       JSR    $BB40
F9E5: BD 40 27       JSR    $4027
F9E8: BD BB 4D       JSR    $BB4D
F9EB: 39             RTS
F9EC: EC FF FF FF    LDD    [$FFFF]
F9F0: FF FF FF       STU    $FFFF
F9F3: FF FF FF       STU    $FFFF
F9F6: FF FF FF       STU    $FFFF
F9F9: FF FF FF       STU    $FFFF
F9FC: FF FF FF       STU    $FFFF
F9FF: FF BD FC       STU    $BDFC
FA02: 28 BD          BVC    $F9C1
FA04: 40             NEGA
FA05: 57             ASRB
...
FBBE: FF FF BD       STU    $FFBD
FBC1: BB 40 BD       ADDA   $40BD
FBC4: 40             NEGA
FBC5: 06 BD          ROR    $BD
FBC7: BB 4D 39       ADDA   $4D39
FBCA: BD BB 40       JSR    $BB40
FBCD: BD 40 09       JSR    $4009
FBD0: BD BB 4D       JSR    $BB4D
FBD3: 39             RTS
FBD4: BD BB 40       JSR    $BB40
FBD7: BD 40 0C       JSR    $400C
FBDA: BD BB 4D       JSR    $BB4D
FBDD: 39             RTS
FBDE: BD BB 40       JSR    $BB40
FBE1: BD 40 0F       JSR    $400F
FBE4: BD BB 4D       JSR    $BB4D
FBE7: 39             RTS
FBE8: BD BB 40       JSR    $BB40
FBEB: BD 40 6F       JSR    $406F
FBEE: BD BB 4D       JSR    $BB4D
FBF1: 39             RTS
FBF2: BD FC 82       JSR    $FC82
FBF5: BD 40 C0       JSR    $40C0
FBF8: BD FC 8F       JSR    $FC8F
FBFB: 39             RTS
FBFC: FC FF FF       LDD    $FFFF
FBFF: FF BD FD       STU    $BDFD
FC02: A0 BD 40 39    SUBA   [$13C3F,PCR]
...
FCFF: FF 7E FB       STU    $7EFB
FD02: C0 7E          SUBB   #$7E
FD04: FB CA 7E       ADDB   $CA7E
FD07: FB D4 7E       ADDB   $D47E
FD0A: FB DE 7E       ADDB   $DE7E
FD0D: B9 B0 7E       ADCA   $B07E
FD10: F9 C4 7E       ADCB   $C47E
FD13: F9 88 7E       ADCB   $887E
FD16: BB 82 96       ADDA   $8296
FD19: 36 81          PSHU   PC,CC
FD1B: 03 26          COM    $26
FD1D: 09 BD          ROL    $BD
FD1F: FC 82 BD       LDD    $82BD
FD22: 40             NEGA
FD23: AB BD FC 8F    ADDA   [$F9B6,PCR]
FD27: 39             RTS
FD28: FF FF FF       STU    $FFFF
FD2B: FF FF FF       STU    $FFFF
FD2E: FF FF BD       STU    $FFBD
FD31: FC 82 BD       LDD    $82BD
FD34: 40             NEGA
FD35: 7E BD FC       JMP    $BDFC
FD38: 8F             FCB    $8F
FD39: 39             RTS
FD3A: BD FC 82       JSR    $FC82
FD3D: BD 40 B7       JSR    $40B7
FD40: BD FC 8F       JSR    $FC8F
FD43: 39             RTS
FD44: BD FC 82       JSR    $FC82
FD47: BD 40 BD       JSR    $40BD
FD4A: BD FC 8F       JSR    $FC8F
FD4D: 39             RTS
FD4E: BD BB 40       JSR    $BB40
FD51: BD 40 63       JSR    $4063
FD54: BD BB 4D       JSR    $BB4D
FD57: 39             RTS
FD58: BD BB 40       JSR    $BB40
FD5B: BD 40 66       JSR    $4066
FD5E: BD BB 4D       JSR    $BB4D
FD61: 39             RTS
FD62: BD BB 40       JSR    $BB40
FD65: BD 40 69       JSR    $4069
FD68: BD BB 4D       JSR    $BB4D
FD6B: 39             RTS
FD6C: 6C FF FF FF    INC    [$FFFF]
...
FDCC: 8A 60          ORA    #$60
FDCE: 97 3A          STA    $3A
FDD0: B7 38 08       STA    $3808
FDD3: BD 6C 12       JSR    $6C12
FDD6: 96 3A          LDA    $3A
FDD8: 84 1F          ANDA   #$1F
FDDA: 8A A0          ORA    #$A0
FDDC: B7 38 08       STA    $3808
FDDF: 97 3A          STA    $3A
FDE1: 39             RTS
...
FE86: 7E 45 B1       JMP    $45B1
FE89: 7E 44 DC       JMP    $44DC
...
FEC2: 7E 47 DB       JMP    $47DB
FEC5: 7E 68 1B       JMP    $681B
FEC8: 7E 6D 64       JMP    $6D64
FECB: 7E 47 E3       JMP    $47E3
FECE: 7E 47 E9       JMP    $47E9
FED1: 7E 48 04       JMP    $4804
FED4: 7E 67 5D       JMP    $675D
FED7: 7E 5F 85       JMP    $5F85
FEDA: 7E 5B 1F       JMP    $5B1F
FEDD: 7E 58 8F       JMP    $588F
FEE0: 7E 5C 93       JMP    $5C93
FEE3: 7E 4A 6B       JMP    $4A6B
FEE6: 7E 51 E5       JMP    $51E5
FEE9: 7E 4D 9D       JMP    $4D9D
FEEC: 7E 4E 4B       JMP    $4E4B
...
FF04: 7E 48 8C       JMP    $488C

FF10: BD FD A0       JSR    $FDA0
FF13: BD 40 00       JSR    $4000
