...
for i,v in sprite_names.items():
    if v=="elevator_door":
        ...
        object_type_table[i] = 2
    elif v=="fence" or v=="wall":
        object_type_table[i] = 3
    elif i in [0xe5e,0xe60]:
        object_type_table[i] = 3   # part of stone statue
...
with open(src_dir / "object_type_table.68k","w") as f:
    ...
    for i,x in enumerate(["NORMAL_TILE","ELEVATOR_DOOR_TILE","LIFT_TILE","STATIC_TILE"]):
        f.write(f"{x} = {i}\n")
