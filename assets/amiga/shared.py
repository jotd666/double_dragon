...
force_multi_size_list_harder = {0x92C,0x2c2,0x884,0x93E,0x942,0x948,0xA3A,0xA39,0xA3C,0xE20,0x1A6,0x746,0x6A6, 0x6AA}
# force size 1 if only size 2 logged
force_multi_size_list = [0x5EE,0x5F0,0x8A4,0x8A6,0x8A8,0x86E,0x9EC,0x9F0,0x70C,0xE20,0x1bc,0x1B4,0x1b6,
    0xEEA,0xEE6,0xEF0,0xEF6,0xEE2,0xFEE,0xFF2,0xFF0,0xFEC,0xe28,0xE02,0xE0A,0x870,0x871,
    0x2ec,0xf4e,0x5eb,0x5FB,0x5F9,0x5FA,0x5FD]+list(force_multi_size_list_harder)

giant_frames = {0x862,0x864,0x866,0x868,0x86a,0x86c,0x86e,0x86f,0x872,0x874,0x876,0x877,0x878,0x879,0x87a,0x87c,0x87e,0x880,0x881,
0x882,0x884,0x886,0x887,0x888,0x88a,0x88c,0x890,0x892,0x894,0x898,0x89a,0x89c,0x89e,0x8a5,0x8a6,0x8a8,0x8aa,0x8ac,0x8b0,0x8b1,0x8b2,
0x8b4,0x8b6,0x8bb,0x8c2,0x8c4,0x8c8,0x8c9,0x8ca,0x8cc,0x8ce,0x8d3,0x8d4,0x8d5,0x8d6,0x8d8,0x8da,0x8dc,0x8de,0x8e2,0x8e4,0x900,0x902,
0x904,0x906,0x908,0x90a,0x90c,0x90e,0x910,0x912,0x914,0x918,0x91a,0x920,0x922,0x924,0x929,0x92c,0x92e,0x930,0x931,0x932,0x936,0x938,
0x93a,0x93c,0x93e,0x940,0x942,0x948,0x94a,0x94c,0x952,0x958,0x95a,0x95e,0x960,0x962,0x968,0x96a,0x96c,0x972,0x978,0x97a,0xc24,0xc26,
0xc28,0xc2a,0xc30,0xc32,0xc34,0xc38,0xc40,0xc42,0xc44,0xc46,0xc4a,0xc4c,0xc50,0xc54,0xe00,
0xe02,0xe04,0xe06,0xe08,0xe0a,0xe0c,0xe0e,0xe12,0xe16,0xe1a,0xe1c,0xe1e,0xe20,0xe22,0xe24,0xe26,0xe28,0xe2c,0xe30,0xe32}

boss_frames = {0xb50,0xbc2,0xbe4,0xc2e,0xc2f,0xc3a,
0xc48,0xc49,0xc52,0xc8e,0xc9d,0x360,0x364,0x368,0x370,0x374,0x376,
0x378,0x380,0x382,0x386,0x388,0x390,0x392,0xc82,0xc84,0xc88,0xc90,
0xc94,0xc96,0xc98,0xc9a,0xc9e,0xca0,0xca2,0xca4,0xca8,0xcba,0xccc,
0xcd0,0xcd2,0xcd4,0xcd6
}
...
def get_sprite_names():
    ...
    rval |= {k:"girl" for k in range(0xC18,0xC1D)}
    rval |= {k:"hooker" for k in range(0xC00,0xC24)}
    ...
    rval |= {k:"spike_statue" for k in [0xE71,0xE76,0xE77,0xE62,0xE63,0xE70,
    0xe5e,0xe60,0xe64,0xe66,0xe6a,0xe6c,0xe72,0xe78,0xe7a]}
    rval[0xe4a] = rval[0xe46] = "lift"
    rval[0x100] = "player"
    rval[0xAAE] = rval[0xAAF] = "whip"
    rval[0x692] = "curly_hair_thug"
    rval[0x694] = "thug_legs"
